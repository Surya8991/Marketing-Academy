...
- **Total: 18 lessons, ~36 projects, ~36 concept scenarios.** Tier pairs for all 18 are already computed in `src/lib/projects-assignment.ts`, no re-derivation needed — `get-track-batch-info.mjs` reads them for you.
