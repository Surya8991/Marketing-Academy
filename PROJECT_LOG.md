...
9. Practice projects layer (Stage 8, Session 73-74): `/projects` hub live, 36 projects across 20 lessons (Phase 0+1 pilot + 1 Phase-2 lesson). 225 of 226 remaining Phase-2 lessons NOT yet authored. Centrality/tier data for all 642 lessons in src/lib/projects-assignment.ts (generated).
