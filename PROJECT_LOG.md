...
└── src/
    ...
    │
    ├── auth.ts                     ✅ Session 87 — NextAuth v5 config (Google), requireUser/requireAdmin/isAdminUser
    ├── server/
    │   └── db/                     ✅ Session 87 — schema.ts (users/accounts/sessions/verificationTokens), client.ts, migrations/
    │
