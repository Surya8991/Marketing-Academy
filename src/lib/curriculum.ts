...
export const CATEGORIES: Category[] = [
  ...
  },
  {
    ...
    lessons: [
      ...
      { slug: "mobile-first-indexing", title: "Mobile-First Indexing", level: "Beginner", summary: "Google only sees your mobile site now, and content missing there is content that does not exist." },
      ...
      { slug: "https-security-seo", title: "HTTPS & Security Headers for SEO", level: "Intermediate", summary: "A confirmed ranking signal since 2014, and the browser trust layer that decides whether visitors stay long enough to convert." },
      ...
      { slug: "duplicate-thin-content", title: "Duplicate & Thin Content Cleanup", level: "Intermediate", summary: "Every low-value page you let Google index quietly drags down how it judges the rest of your site." },
      { slug: "log-file-analysis", title: "Log File Analysis for SEO", level: "Advanced", summary: "Search Console shows what Google says happened, your server logs show what actually happened, including every AI crawler in 2026." },
      ...
      { slug: "ai-search-visibility-metrics", title: "Measuring AI Search Visibility", level: "Intermediate", summary: "Rank tracking measures a position in a list of 10 links, AI answers have no fixed position, so the KPIs have to change too." },
  ...
  },
  {
    ...
    lessons: [
      ...
      { slug: "instagram-algorithm-2026", title: "Instagram Algorithm & Content Strategy in 2026", level: "Intermediate", summary: "Instagram optimizes for sends and watch time, not comments, and designing for the wrong signal is the most common cross-platform mistake." },
      ...
      { slug: "linkedin-algorithm-2026", title: "LinkedIn Algorithm & Content Strategy in 2026", level: "Intermediate", summary: "The platform got wordier, hashtags stopped mattering, and semantic ranking changed what actually earns reach." },
      { slug: "linkedin-post-anatomy", title: "The LinkedIn Post Anatomy Framework", level: "Intermediate", summary: "Hook, proof of pain, credibility line, framework, analogy, reframe, then a question worth answering." },
  ...
  },
  {
    ...
    lessons: [
      ...
      { slug: "content-demand-research", title: "Content Demand Research: Finding What to Actually Write About", level: "Intermediate", summary: "A structured, repeatable routine for finding real demand signals instead of guessing what to publish next." },
  ...
  },
  {
    ...
    lessons: [
      ...
      { slug: "ai-image-generation-social-content", title: "AI Image Generation for Social Content", level: "Intermediate", summary: "Text in an AI image is generated, not typeset, so the prompt engineering that prevents typos matters more than the prompt that picks a style." },
  ...
  },
  {
    ...
    { slug: "availability-heuristic-marketing", title: "The Availability Heuristic in Marketing", level: "Beginner", summary: "The most recent or vivid data point, a viral competitor post, a single angry customer, distorts marketing prioritization far more than it should." },
    { slug: "compounding-marketing", title: "Compounding: Why Boring, Consistent Marketing Wins", level: "Intermediate", summary: "Why small, consistent marketing efforts like SEO, brand, and an email list beat sporadic big swings over a long enough time horizon, with the actual math behind why." },
    { slug: "incentive-design-marketing", title: "Incentive Design in Marketing", level: "Intermediate", summary: "Charlie Munger's 'show me the incentive, I'll show you the outcome' explains why sales comp plans, agency fees, and affiliate payouts quietly produce behavior nobody wanted." },
    { slug: "loss-aversion-marketing", title: "Loss Aversion: Why Losing Beats Winning in Copy", level: "Intermediate", summary: "Why 'don't lose your spot' outperforms 'get a bonus' in marketing copy, the prospect theory research behind it, and the ethical line between using this bias and exploiting it." },
    { slug: "margin-of-safety-marketing", title: "Margin of Safety in Marketing", level: "Intermediate", summary: "Borrow Benjamin Graham's investing discipline to build slack into budgets, timelines, and forecasts so one wrong assumption does not sink the plan." },
  ...
  },
  {
    ...
    lessons: [
      ...
      { slug: "analyst-relations", title: "Analyst Relations: Briefing Gartner, Forrester, and IDC", level: "Intermediate", summary: "Learn how to prepare, request, and run briefings with industry analysts like Gartner, Forrester, and IDC so they represent your product accurately in the reports buyers actually read." },
      { slug: "online-reputation-management", title: "Online Reputation Management: Owning Your Search Results", level: "Intermediate", summary: "Learn how brands use SEO, content, and PR together to control what people see when they Google your name." },
      { slug: "internal-communications", title: "Internal Communications: PR's Job Inside the Company", level: "Beginner", summary: "Learn why internal communications is a core PR discipline, not an HR afterthought, and how to keep employees informed, aligned, and trusting leadership." },
      { slug: "executive-media-tours", title: "Executive Media Tours: Getting Leaders on Podcasts and Panels", level: "Intermediate", summary: "Learn how to plan and run an executive media tour that lands your leaders on the right podcasts and panels, not just the loudest ones." },
      { slug: "newsjacking", title: "Newsjacking: Riding the News Cycle Without Getting Burned", level: "Intermediate", summary: "How to jump on trending news for real PR wins, and the tone-deaf mistakes that turn newsjacking into a crisis of your own making." },
      { slug: "pr-agency-vs-in-house", title: "PR Agency vs In-House: How to Choose and When to Switch", level: "Beginner", summary: "A practical framework for deciding whether to hire a PR agency, build an in-house team, or blend both, based on real 2025-2026 cost and speed data." },
      { slug: "data-driven-pr", title: "Data-Driven PR: Turning Surveys and Proprietary Data Into Coverage", level: "Intermediate", summary: "Learn how to turn original surveys and proprietary data into stories journalists actually want to run, from framing the finding to packaging the dataset." },
      { slug: "product-launch-pr", title: "Product Launch PR: Embargoes, Exclusives, and Coordinated Drops", level: "Intermediate", summary: "Learn how embargoes, exclusives, and tiered media lists work together to make a product launch land as one big wave instead of a scattered trickle." },
      { slug: "b2b-pr-strategy", title: "B2B PR: Why Trade Press Beats Consumer Press", level: "Intermediate", summary: "Why niche trade publications drive more B2B pipeline than a hit in a national newspaper, and how to build a PR strategy around them." },
      { slug: "award-submissions", title: "Award Submissions: Turning Industry Recognition Into Credibility", level: "Beginner", summary: "Learn how to pick the right awards, write submissions judges actually reward, and turn a win into months of PR mileage." },
      { slug: "digital-pr-link-building", title: "Digital PR: Earning Links Through Coverage, Not Outreach Spam", level: "Advanced", summary: "How to build a newsworthy hook, pitch it like a journalist, and earn dozens of high-authority links as a byproduct of real coverage." },
    { slug: "community-relations-pr", title: "Community and Local Relations", level: "Intermediate", summary: "PR work aimed at local government, neighborhood groups, and regional press, distinct from national trade press and especially critical for retail, real estate, and physical-presence brands." },
    { slug: "global-pr-localization", title: "Global PR: Localizing Pitches Beyond Translation", level: "Intermediate", summary: "How to localize pitches, press releases, and media lists across countries instead of translating one US press release and sending it everywhere." },
    { slug: "influencer-relations-vs-pr", title: "Influencer Relations vs Traditional PR: Dividing the Work", level: "Intermediate", summary: "Where creator partnerships and earned media now overlap, and how PR and influencer or social teams should split responsibility without duplicating effort." },
    { slug: "investor-relations-pr", title: "Investor Relations PR", level: "Advanced", summary: "How communicating to public and private market investors and analysts differs from consumer or trade press PR, and where the two disciplines overlap as a company nears an IPO or fundraise." },
    { slug: "podcast-pr-strategy", title: "Podcast PR Strategy", level: "Intermediate", summary: "How to book executives as guests on relevant podcasts, and how to decide when launching a branded company podcast is actually worth it." },
    { slug: "pr-crisis-simulation-drills", title: "Crisis Simulation Drills", level: "Advanced", summary: "How PR teams run tabletop exercises and simulated media scenarios before a real crisis hits, and what separates a useful drill from expensive theater." },
    { slug: "pr-measurement-attribution-mmm", title: "PR Measurement: Media Mix Modeling and Attribution", level: "Advanced", summary: "How media mix modeling and multi-touch attribution are starting to tie earned coverage to pipeline, going beyond share-of-voice and sentiment scores." },
    { slug: "rebranding-pr-strategy", title: "Rebranding PR: Managing the Narrative Around a Name Change", level: "Intermediate", summary: "How to run PR for a rebrand or name change so the media tells a growth story instead of asking what you are hiding." },
    ],
  },
  {
    ...
    lessons: [
      ...
      { slug: "event-marketing-tech-stack", title: "The Event Marketing Tech Stack: Where Leads Actually Get Lost", level: "Intermediate", summary: "How registration platforms, badge scanners, and CRM sync are supposed to work together, and the exact integration failures that quietly drop leads between the booth and the sales team." },
      { slug: "pop-up-retail-experiences", title: "Pop-Up Retail: Running Physical Stores as Marketing, Not Sales", level: "Intermediate", summary: "Why brands open short-term stores that are not built to hit revenue targets, how site selection actually works, and how to measure brand lift instead of just counting the register." },
      { slug: "conference-speaking-thought-leadership", title: "Getting Your Executives on Stage: CFPs and Thought Leadership", level: "Intermediate", summary: "How call-for-papers review actually works, why a sales pitch gets rejected every time, and how to stretch one 30-minute talk into a quarter of content." },
      { slug: "event-pr-media-relations", title: "Event PR: Getting Press to Show Up and Stay in the Story", level: "Intermediate", summary: "How to get journalists and analysts to actually attend your event, what belongs in a press kit, how embargoes work, and how to turn one day of coverage into a lasting media narrative." },
      { slug: "user-conference-strategy", title: "User Conference Strategy: Build Your Own or Sponsor Others", level: "Advanced", summary: "How to decide whether a proprietary user conference is worth building, what the multi-year investment curve actually looks like, and what justifies the cost once you commit." },
      { slug: "roadshow-multi-city-events", title: "Roadshows and Multi-City Event Tours", level: "Intermediate", summary: "How to plan a B2B roadshow across multiple cities, scale one format without losing quality, and measure incremental pipeline stop by stop." },
      { slug: "community-meetup-programs", title: "Community Meetups and Local Chapter Programs", level: "Intermediate", summary: "How to build an ambassador network for developer meetups and local user groups, budget per chapter, and understand why community marketing is not lead gen." },
      { slug: "event-swag-branded-merch", title: "Event Swag and Branded Merch That People Actually Keep", level: "Beginner", summary: "How to think about cost per impression when choosing event swag, which sustainable trends are worth the premium, and real examples of merch that generated organic buzz." },
      { slug: "crisis-planning-live-events", title: "Crisis Planning for Live Events", level: "Intermediate", summary: "How to build a contingency plan for severe weather, speaker no-shows, AV failures, and security incidents before your event, not during it." },
      { slug: "account-based-events-abm", title: "Account-Based Events for ABM", level: "Intermediate", summary: "How to design small, high-touch events like executive dinners and VIP roundtables for a named target-account list, and how to prove their ABM contribution." },
      { slug: "post-event-content-repurposing", title: "Post-Event Content Repurposing", level: "Beginner", summary: "How to turn one live event into a quarter's worth of content by systematically repurposing recordings, panels, and booth conversations." },
      { slug: "event-budgeting-hidden-costs", title: "Event Budgeting: The Hidden Costs That Blow Up Your Plan", level: "Intermediate", summary: "A practical breakdown of the drayage, AV markups, shipping, and staff-travel costs that quietly double event budgets, and a checklist to catch them before the vendor invoice does." },
    { slug: "event-registration-pricing", title: "Event Registration and Ticket Pricing Strategy", level: "Intermediate", summary: "How to structure early-bird tiers, group discounts, and final pricing for a paid conference or workshop without pricing yourself out of turnout." },
    { slug: "event-staffing-training", title: "Staffing and Training Booth Teams", level: "Beginner", summary: "How to select, brief, and coach booth staff so they qualify and engage attendees instead of just handing out swag and chatting with each other." },
    { slug: "event-sustainability-carbon", title: "Sustainable Events: Cutting Carbon Without Cutting the Experience", level: "Intermediate", summary: "How to shrink a trade show or conference's waste, catering emissions, and travel footprint while keeping attendees happy." },
    { slug: "hybrid-event-production-tech", title: "Hybrid Event Production Technology", level: "Advanced", summary: "The streaming, camera, and audio setup that actually works for a hybrid audience, and the common technical failures that quietly ruin the remote experience." },
    { slug: "post-event-nps-feedback", title: "Post-Event Feedback and NPS", level: "Intermediate", summary: "How to design a survey that gets a real response rate, which questions actually predict next year's attendance, and how to close the loop with attendees." },
    { slug: "trade-show-booth-design-psychology", title: "Booth Design Psychology: Layout Rules That Pull Foot Traffic", level: "Intermediate", summary: "The layout, sightline, and traffic-flow principles trade show research shows actually pull attendees onto your booth, not past it." },
    { slug: "vip-experience-design", title: "VIP and Executive Experience Design", level: "Intermediate", summary: "How to design a differentiated top-tier experience for your highest-value attendees, lounges, concierge, and curated meetings, without making everyone else feel second-class." },
    { slug: "webinar-strategy-conversion", title: "Webinar Strategy: Filling Seats and Turning Them Into Pipeline", level: "Intermediate", summary: "How to pick the right webinar format, promote it so people actually show up, and convert attendees into real pipeline instead of vanity registration numbers." },
    ],
  },
  {
    ...
    lessons: [
      ...
      { slug: "affiliate-content-sites-seo", title: "Affiliate Content Sites and SEO: How Review Pages Actually Earn", level: "Intermediate", summary: "How Wirecutter-style review and comparison sites make money, why Google's Site Reputation Abuse policy reshaped affiliate SEO, and what makes a review page rank and convert in 2025." },
      { slug: "coupon-deal-site-affiliates", title: "Coupon and Deal-Site Affiliates: RetailMeNot, Honey, and Cashback", level: "Intermediate", summary: "How coupon and cashback affiliates actually work, why brands complain about 'last-click coupon theft', and how to structure these deals fairly." },
      { slug: "saas-affiliate-programs", title: "SaaS Affiliate Programs: Recurring Commissions and Clawbacks", level: "Intermediate", summary: "Why SaaS affiliate economics run on recurring, churn-adjusted commissions instead of one-time payouts, and how clawbacks keep the math honest." },
      { slug: "affiliate-attribution-multi-touch", title: "Affiliate Attribution: Last-Click vs Multi-Touch Models", level: "Advanced", summary: "Why last-click attribution undervalues most affiliates, how multi-touch models split credit fairly, and how networks are adapting tracking as cross-device and cookie challenges grow." },
      { slug: "affiliate-onboarding-enablement", title: "Affiliate Onboarding and Enablement", level: "Intermediate", summary: "How to turn a newly approved affiliate into a producing partner fast, before poor onboarding kills the relationship in the first 30 days." },
      { slug: "sub-affiliate-networks", title: "Sub-Affiliate Networks and Tiered Partner Structures", level: "Advanced", summary: "How master affiliates recruit and manage their own sub-affiliates, why this structure invites fraud, and how to set a policy that keeps it accountable." },
      { slug: "affiliate-vs-paid-media-mix", title: "Affiliate vs Paid Media: Where It Fits in the Mix", level: "Advanced", summary: "How to figure out whether affiliate spend is actually driving new demand or just capturing sales you would have gotten anyway, and where it belongs in your budget." },
      { slug: "b2b-partner-referral-programs", title: "B2B Partner and Referral Programs vs Consumer Affiliate Marketing", level: "Intermediate", summary: "Why B2B referral and partner programs need a different structure than consumer affiliate marketing, and how to build one around relationships instead of clicks." },
      { slug: "affiliate-cookie-tracking-technical", title: "Affiliate Tracking Tech: Cookies, Pixels, and Server-to-Server Postbacks", level: "Intermediate", summary: "How affiliate tracking actually works under the hood, and why the industry is racing from cookies to server-to-server postbacks." },
      { slug: "international-affiliate-programs", title: "Running an Affiliate Program Internationally", level: "Intermediate", summary: "What changes when your affiliate program crosses borders: currency, network choice, and localized compliance." },
      { slug: "affiliate-program-negotiation", title: "Negotiating Affiliate Deals: Fees, Guarantees, and Exclusivity", level: "Intermediate", summary: "How to negotiate flat fees vs performance-only deals, minimum guarantees, and exclusivity clauses, and how leverage shifts with brand size." },
      { slug: "de-influencing-affiliate-trust", title: "De-influencing and Affiliate Trust: Why Honest Reviews Convert Better", level: "Intermediate", summary: "The 2023-2025 de-influencing backlash against over-promotional content, and how it's reshaping affiliate creative and brand guidelines." },
    { slug: "affiliate-churn-reactivation", title: "Affiliate Churn and Reactivation: Winning Back Dormant Partners", level: "Intermediate", summary: "Why affiliates go dormant, how to spot it early, and the win-back campaigns that actually re-engage lapsed partners." },
    { slug: "affiliate-content-briefs", title: "Writing Affiliate Content Briefs Without Sounding Like a Script", level: "Intermediate", summary: "How to give affiliates enough guidance to produce accurate, on-brand coverage without dictating their voice or creating an FTC-disclosure problem." },
    { slug: "affiliate-creative-testing", title: "Testing Affiliate Creative: Banners, Landing Pages, and Offer Copy", level: "Intermediate", summary: "How to A/B test affiliate banners, landing pages, and offer copy across a partner network, and why it works differently than testing your own paid ads." },
    { slug: "affiliate-platform-comparison", title: "Affiliate Platform Comparison: PartnerStack vs Impact vs Tapfiliate vs Rewardful", level: "Intermediate", summary: "How four popular affiliate platforms actually differ by company size, pricing model, and SaaS vs e-commerce focus, and a simple way to pick the right one." },
    { slug: "affiliate-program-launch-checklist", title: "Launching an Affiliate Program From Zero: The Full Checklist", level: "Beginner", summary: "A step-by-step checklist for launching an affiliate program from scratch, covering tracking setup, terms of service, commission structure, and first-affiliate recruitment." },
    { slug: "affiliate-seasonal-promotions", title: "Seasonal Affiliate Promotions: Black Friday, Prime Day, and Holiday Campaigns", level: "Intermediate", summary: "How to plan Black Friday/Cyber Monday, Prime Day, and holiday affiliate campaigns with commission boosts and creative refresh timing." },
    { slug: "affiliate-tax-1099-compliance", title: "Affiliate Payouts and Tax Compliance: 1099s and W-8BEN Forms", level: "Intermediate", summary: "What a US company must collect and file when paying domestic and international affiliates, including 1099-NEC thresholds and W-8BEN forms." },
    { slug: "micro-influencer-affiliate-hybrid", title: "Micro-Influencer Affiliate Programs: Hybrid Gifting and Commission Models", level: "Beginner", summary: "How to recruit small creators (1k-50k followers) into a hybrid affiliate/gifting structure, and why their conversion rates often beat mega-influencers." },
    ],
  },
  {
    ...
    lessons: [
      ...
      { slug: "marketing-budget-planning", title: "Marketing Budget Planning: Building and Defending Your Annual Budget", level: "Advanced", summary: "How to build a marketing budget the CFO will not gut in Q3, and what CMOs are actually spending on in 2025." },
      { slug: "marketing-org-design", title: "Marketing Org Design: Centralized, Decentralized, or Hybrid", level: "Advanced", summary: "How to choose a marketing team structure that fits your company's stage, and the coordination costs each model quietly creates." },
      { slug: "agency-vs-inhouse-decision", title: "Agency vs In-House: A Decision Framework for What to Build vs Outsource", level: "Intermediate", summary: "A practical framework for deciding what marketing work to keep in-house vs hand to an agency, and how the true cost compares beyond the retainer or salary line." },
      { slug: "marketing-ops-function", title: "Building a Marketing Operations (MOps) Function", level: "Advanced", summary: "What marketing operations actually owns, when a company needs its first MOps hire, and how the role differs from marketing analytics." },
      { slug: "cross-functional-alignment-sales", title: "Cross-Functional Alignment: Fixing the Marketing-Sales Rift", level: "Intermediate", summary: "How to build SLAs, shared metrics, and a common language that ends the 'bad leads vs no follow-up' blame cycle between marketing and sales." },
      { slug: "hiring-marketing-generalists-specialists", title: "Generalists vs Specialists: How to Hire as Your Marketing Team Scales", level: "Intermediate", summary: "When to hire broad marketing generalists versus deep channel specialists, and how the right mix shifts as your team grows from 1 to 20 people." },
      { slug: "marketing-team-remote-distributed", title: "Leading a Remote or Distributed Marketing Team", level: "Intermediate", summary: "How to run async collaboration, timezone-spanning campaign handoffs, and what recent data says about remote marketing team performance." },
      { slug: "personal-brand-marketing-leader", title: "Building a Personal Brand as a Marketing Leader", level: "Intermediate", summary: "Why a public presence is now expected of CMOs and VPs of marketing, how it helps recruiting and deal-closing, and how to build one without it eating your calendar." },
      { slug: "marketing-leadership-layoffs-restructuring", title: "Leading Your Team Through Marketing Layoffs and Restructuring", level: "Advanced", summary: "How to decide what gets cut first, tell the people who stay the truth, and rebuild a team's output after the org chart shrinks." },
      { slug: "marketing-mentorship-coaching", title: "Mentorship and Coaching for Marketing Leaders", level: "Intermediate", summary: "How to grow junior marketers through structured 1:1s and stretch assignments, and why coaching people is a different skill from managing their tasks." },
      { slug: "board-reporting-marketing", title: "Reporting Marketing Performance to the Board", level: "Advanced", summary: "What board members actually want from a marketing update, how to build a one-page dashboard for the deck, and how to handle hard ROI questions in the room." },
      { slug: "first-90-days-cmo", title: "The First 90 Days as a New CMO or VP Marketing", level: "Advanced", summary: "How to balance listening with quick wins, audit the team and stack before changing anything, and avoid the mistakes that burn trust fast in a new marketing leadership role." },
    { slug: "marketing-crisis-leadership", title: "Leading Marketing Through a Company Crisis", level: "Advanced", summary: "How a marketing leader's job changes during a company-wide crisis, layoffs elsewhere, a failed launch, or a leadership scandal, and what to say to your own team when the ground shifts under them." },
    { slug: "marketing-diversity-inclusive-teams", title: "Building Diverse and Inclusive Marketing Teams", level: "Intermediate", summary: "Practical hiring-pipeline and team-culture practices for building diverse marketing teams, and the data behind why they produce measurably better campaigns." },
    { slug: "marketing-kpi-north-star", title: "Choosing Your Marketing North Star Metric", level: "Intermediate", summary: "How to pick the single metric that best represents the value marketing delivers, the vanity-metric traps to avoid, and how real companies chose theirs." },
    { slug: "marketing-team-culture", title: "Building Marketing Team Culture That Survives Hypergrowth", level: "Intermediate", summary: "Why the norms and rituals that worked when your marketing team was 5 people quietly break at 50, and how to rebuild culture on purpose instead of letting it erode." },
    { slug: "marketing-vendor-management", title: "Managing Marketing Vendors and Contracts at Scale", level: "Advanced", summary: "How to run a vendor review cadence, negotiate renewals with real leverage, and stop paying for 20 disconnected tools nobody remembers signing up for." },
    { slug: "marketing-leader-negotiating-offer", title: "Negotiating Your Offer as a Marketing Leader", level: "Advanced", summary: "How base, bonus, and equity actually break down for VP and CMO offers, what's realistically negotiable, and real 2024/2025 compensation benchmarks." },
    { slug: "marketing-leadership-ai-transformation", title: "Leading Your Marketing Team Through AI Transformation", level: "Advanced", summary: "How to introduce AI tools into a marketing team's workflow without triggering fear, and an honest look at where AI actually changes headcount needs versus where it does not." },
    { slug: "marketing-succession-planning", title: "Succession Planning for Marketing Leaders", level: "Advanced", summary: "Why building a team and documented processes that don't depend entirely on you is the single biggest lever on your own next promotion, not a threat to your job security." },
    ],
  },
  {
    ...
    lessons: [
      ...
      { slug: "can-spam-email-compliance", title: "CAN-SPAM Compliance: The Rules Every Email Marketer Must Follow", level: "Beginner", summary: "Learn the eight CAN-SPAM rules the FTC enforces, why 'unsubscribe' is not optional, and how a single bad send can cost over $53,000." },
      { slug: "cookie-consent-tracking-law", title: "Cookie Consent and Tracking Law: GDPR, ePrivacy, and the Cookie Banner", level: "Intermediate", summary: "How cookie banners, consent management platforms, and first vs third-party tracking actually satisfy GDPR and ePrivacy, and what happens when they do not." },
      { slug: "dark-patterns-ftc-enforcement", title: "Dark Patterns: The FTC's Crackdown on Deceptive UX", level: "Intermediate", summary: "How the FTC treats manipulative checkout, cancellation, and consent flows as illegal deception, and what marketers need to change before the next $2.5 billion settlement." },
      { slug: "sms-tcpa-compliance", title: "TCPA and SMS Marketing: Consent Rules That Carry Real Fines", level: "Beginner", summary: "How the Telephone Consumer Protection Act governs marketing texts, why 'just add a checkbox' is not enough, and what the 2025 opt-out changes mean for your SMS program." },
      { slug: "sweepstakes-contest-law", title: "Sweepstakes and Contest Law: The Rules for Running a Legal Giveaway", level: "Beginner", summary: "Learn the difference between a sweepstakes, a contest, and an illegal lottery, and what your official rules and entry mechanics must include to stay compliant." },
      { slug: "coppa-marketing-to-children", title: "COPPA: Marketing to Kids Under 13 Without Getting Sued", level: "Intermediate", summary: "What triggers the Children's Online Privacy Protection Act, how verifiable parental consent actually works, and what Amazon, Epic Games, and TikTok learned the hard way." },
      { slug: "native-advertising-disclosure", title: "Native Advertising Disclosure: When 'Sponsored Content' Needs a Label", level: "Intermediate", summary: "How the FTC's '.com Disclosures' guidance treats brand-published native ads and advertorials, and why 'Sponsored' has to look and read like an ad, not editorial content." },
      { slug: "drip-pricing-junk-fees", title: "Drip Pricing and Junk Fees: What the FTC's All-In Pricing Rule Requires", level: "Intermediate", summary: "The FTC's 2024/2025 rule forcing hotels, ticketing platforms, and subscriptions to show total price upfront, and why the related click-to-cancel rule got vacated in court." },
      { slug: "ai-generated-content-ftc", title: "AI-Generated Marketing Content and the FTC: Reviews, Deepfakes, and Disclosure", level: "Intermediate", summary: "How the FTC's fake reviews rule, impersonation enforcement, and shifting 2025/2026 AI policy affect AI-generated testimonials, ad creative, and marketing copy." },
      { slug: "email-list-purchasing-legality", title: "Why Buying Email Lists Will Wreck Your Marketing Program", level: "Beginner", summary: "Purchased, rented, and co-registered email lists are technically legal in narrow cases but practically a fast track to fines, blocklists, and a dead sending domain." },
      { slug: "loyalty-referral-program-law", title: "The Legal Rules Behind Loyalty Points and Referral Rewards", level: "Intermediate", summary: "Loyalty points and 'give $10, get $10' referral rewards both carry real legal obligations, from unclaimed-property law to FTC endorsement disclosure rules." },
      { slug: "health-wellness-marketing-claims", title: "Health and Supplement Marketing Claims: What You Can Legally Say", level: "Intermediate", summary: "Health, wellness, and supplement marketing sits under a dual FTC/FDA jurisdiction, and unsubstantiated claims made by influencers can still land the brand in trouble." },
      { slug: "biometric-location-privacy-marketing", title: "Biometric Data and Location Targeting: Where Marketing Crosses a Legal Line", level: "Advanced", summary: "Facial recognition and location-based ad targeting sit under some of the toughest privacy laws in the country, from Illinois' BIPA statutory damages to post-Roe geofencing enforcement." },
    { slug: "marketing-data-breach-response", title: "Marketing's Role in Data Breach Response", level: "Intermediate", summary: "What marketing and comms specifically own when a data breach happens, and why the notification letter can matter as much as the patch." },
    { slug: "state-privacy-law-patchwork-2026", title: "The 2026 US State Privacy Law Patchwork", level: "Intermediate", summary: "Twenty US states now have comprehensive privacy laws in effect, and no two are identical, here's how to build one compliance program that satisfies all of them." },
    { slug: "trademark-clearance-marketing", title: "Trademark Clearance: Vetting a Campaign Name Before You Launch", level: "Beginner", summary: "How to run a basic trademark clearance search before locking in a campaign name, tagline, or product name, and when the search results mean you need a lawyer." },
    { slug: "user-generated-content-legal", title: "The Legal Risk Hiding in Your UGC Campaign", level: "Intermediate", summary: "Why reposting customer photos and running contests requires real rights clearance, not just a hashtag, and what happens when brands skip it." },
    { slug: "comparative-advertising-law", title: "Naming a Competitor in Your Ads: What's Actually Legal", level: "Intermediate", summary: "The Lanham Act standard for comparative advertising, what makes a 'better than' claim defensible, and real lawsuits over competitor comparisons." },
    { slug: "email-unsubscribe-mechanics-law", title: "Unsubscribe Mechanics: What the Law Actually Requires", level: "Intermediate", summary: "The real technical requirements CAN-SPAM, GDPR, and CASL impose on the unsubscribe process, and the common violations companies commit without realizing it." },
    { slug: "international-marketing-compliance", title: "International Marketing Compliance Beyond Privacy Law", level: "Intermediate", summary: "Running campaigns in the EU, UK, and Canada means more than GDPR, advertising standards bodies, language rules, and consumer protection law all change what you can say." },
    { slug: "ai-training-data-copyright-marketing", title: "AI Training Data, Copyright, and What Marketers Should Watch", level: "Intermediate", summary: "AI-generated marketing assets carry real, unresolved copyright risk, here's what the current litigation means for marketers and how to think about indemnification and provenance." },
    ],
  },
];
