...
export const CATEGORIES: Category[] = [
  ...
  },
  {
    ...
    lessons: [
      ...
      { slug: "hootsuite-buffer", title: "Hootsuite vs Buffer: Social Media Scheduling Tools", level: "Beginner", summary: "Learn how to use Hootsuite and Buffer to schedule, publish, and measure social media posts across every platform - and which tool fits your situation." },
      { slug: "hotjar-clarity", title: "Hotjar & Microsoft Clarity", level: "Beginner", summary: "Use heatmaps and session recordings to see exactly where visitors click, scroll, and give up - then fix those problems to get more conversions." },
      { slug: "notion-airtable", title: "Notion vs Airtable for Marketers", level: "Beginner", summary: "How to choose between Notion and Airtable for your marketing team, when to use each one, and how to combine them into a system that actually gets things done." },
    ],
  },
  {
    slug: "psychology",
