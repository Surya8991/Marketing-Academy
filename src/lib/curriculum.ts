...
export const CATEGORIES: Category[] = [
  ...
  },
  {
    ...
    lessons: [
      ...
      { slug: "optimizely-vwo", title: "Optimizely and VWO", level: "Intermediate", summary: "Enterprise A/B testing platforms compared - features, pricing, and when each is worth the cost." },
