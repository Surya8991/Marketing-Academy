      ...
      <body className="min-h-full flex flex-col bg-[var(--background)] text-[var(--foreground)]">
        <SessionProvider>
          <SyncProvider>
            <PostHogProvider>
              ...
              <Nav authConfigured={emailAuthConfigured()} />
        ...
        {process.env.NEXT_PUBLIC_POSTHOG_KEY && (
          <script dangerouslySetInnerHTML={{ __html: `
            ...
            posthog.init('${process.env.NEXT_PUBLIC_POSTHOG_KEY}',{api_host:'${process.env.NEXT_PUBLIC_POSTHOG_HOST ?? "https://us.i.posthog.com"}',capture_pageview:false,capture_pageleave:true,persistence:'localStorage',autocapture:false,disable_session_recording:true,respect_dnt:true});
          ` }} />
        )}
      </body>
    </html>
