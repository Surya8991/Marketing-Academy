...
<InAction
  concept="Default framing as an anchor"
  companyName="New York City yellow taxis"
  where="In-cab credit-card payment touchscreens across NYC yellow taxis"
  why="Two touchscreen vendors independently set different default tip percentages, one suggested 15/20/25%, the other 20/25/30%, on otherwise identical hardware and rides."
  what="Economists Kareem Haggag and Giovanni Paci analyzed roughly 13 million NYC taxi rides and found the higher-default screens produced average tips about 10% higher than the lower-default screens, though the higher defaults also raised the rate of riders leaving no tip at all."
  benefit="10% higher average tip revenue for drivers on the higher-default screens"
  timeframe="Rides from 2007-2011, published 2014"
  date="2014"
  source="http://www.kareemhaggag.com/f/Default_Tips.pdf"
/>
...
<InAction
  concept="Dark-pattern cancellation and fee defaults"
  companyName="Grubhub"
  where="Grubhub's diner app, subscription billing, and fee disclosure flows"
  why="The FTC and the Illinois Attorney General alleged Grubhub hid mandatory delivery fees, blocked diners from their own accounts and funds, and made cancellation harder than signup, violating ROSCA."
  what="The FTC and Illinois AG announced a $140 million settlement (Grubhub to pay $25 million, the rest suspended on inability to pay), the first joint federal-state action combining junk-fee and click-to-cancel violations, requiring Grubhub to disclose all mandatory fees and make cancellation as easy as signup."
  benefit="$140M settlement and a court-ordered redesign of the cancellation and fee-disclosure flow"
  timeframe="Announced December 17, 2024"
  date="2024-12-17"
