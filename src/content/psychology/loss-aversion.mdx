...
<InAction
  concept="Loss Aversion via Streak Protection"
  companyName="Duolingo"
  companyId="duolingo"
  where="Streak Freeze feature and streak-loss push notifications"
  why="a streak becomes something users feel they already own, so an insurance mechanic against losing it taps loss aversion directly instead of promoting a new gain"
  what="Duolingo lets users spend in-app gems on a 'Streak Freeze' that protects an existing streak from breaking after a missed day"
  benefit="Streak Freeze usage lifts long-term retention by 10%, and users who reach a 7+ day streak retain at 2.4x the rate of users with no streak"
  timeframe="reported on Duolingo's own product blog"
  date="2024"
...
<InAction
  concept="Manufactured Loss Framing in Cancellation Flows"
  companyName="Amazon"
  where="Prime subscription cancellation flow"
  why="repeated reminders of benefits and discounts about to be lost turned a routine cancellation into a guilt-trip loss frame, the exact dark pattern this lesson's ethical-limits warning describes"
  what="The FTC alleged the cancellation process required a four-page, six-click, fifteen-option sequence full of diversions reminding users what they would lose by leaving"
  benefit="Amazon agreed to a $2.5 billion FTC settlement in September 2025 ($1 billion in fines plus $1.5 billion in consumer refunds), among the largest in FTC history"
  timeframe="FTC complaint filed 2023, settled September 2025"
  date="2025"
  source="https://www.mediapost.com/publications/article/409399/amazon-settles-dark-patterns-charges-for-25-bi.html"
/>
