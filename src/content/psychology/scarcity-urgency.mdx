...
<InAction
  concept="Sudden scarcity accelerates the loss-aversion trigger"
  companyName="Spotify"
  companyId="spotify"
  where="Spotify Wrapped, the annual personalized listening-recap feature, released every December since 2016"
  why="Wrapped only exists in a short annual window; the underlying listening data doesn't change, only the chance to see it packaged does, engineering the exact sudden-availability-drop the Worchel cookie study measured."
  what="Spotify released Wrapped 2024 in early December, positioning it as a limited-time annual event rather than an always-available feature."
  benefit="Wrapped reached roughly 200 million engaged users within 24 hours of launch, a 19% year-over-year increase, driven almost entirely by the 'it disappears after this window' framing."
  timeframe="24 hours post-launch"
  date="December 2024"
  source="https://sensortower.com/blog/spotify-wrapped-is-on-a-roll"
/>
...
<InAction
  concept="Fake scarcity destroys trust and draws regulatory fines"
  companyName="Booking.com"
  companyId="booking-com"
  where="Booking.com's hotel listing pages, which displayed messages like 'Only 1 room left at this price!' and countdown timers on prices"
  why="Spain's competition authority found the scarcity claims were fabricated rather than tied to real, checkable room-inventory data, crossing from persuasion into a dark pattern."
  what="Spain's CNMC (competition authority) investigated and fined Booking.com over its use of manufactured urgency and scarcity claims on its booking pages."
  benefit="Booking.com was fined EUR 413 million in July 2024, the largest dark-patterns fine issued in travel tech, with Hungary's GVH adding a separate ~EUR 7 million fine for the same tactics the same year."
  timeframe="Fine issued July 2024, following a multi-year investigation"
  date="2024"
  source="https://cybernews.com/cybercrime/booking-com-sued-misleading-consumers-dark-patterns/"
/>
