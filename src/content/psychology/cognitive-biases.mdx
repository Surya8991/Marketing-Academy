...
<InAction
  ...
  companyName="Amazon"
  where="Prime Day 2024, every deal page on Amazon.com and the Amazon app"
  why="Loss-framed cues (crossed-out list price, countdown timer, low-stock badge) make skipping a deal feel like losing money rather than simply not buying"
  what="Stacked a struck-through list price, a countdown timer, and stock-scarcity badges across the entire Prime Day catalog"
  benefit="$14.2 billion in US online sales over the two-day event, an 11% year-over-year increase"
  timeframe="July 16-17, 2024"
  date="2024"
  source="https://blog.adobe.com/en/publish/2024/07/18/adobe-analytics-prime-day-drove-billion-online-us-retailers-growing-yoy"
/>
...
<InAction
  ...
  where="Hotel listing pages on Booking.com, tested against a control group"
  why="Stacking real-time scarcity cues (limited rooms, high recent-booking counts) alongside social proof gives uncertain buyers a reason to act now instead of comparison-shopping further"
  what="Added live scarcity messages like 'Only 1 room left at this price!' next to recent-booking counts on hotel listing pages"
  benefit="Measurably increased both click-through rate and conversion on listings carrying the stacked cues, confirmed in a controlled field study"
  timeframe="2017 field study"
  date="2017"
  source="https://ris.utwente.nl/ws/portalfiles/portal/13753628/ICORIA_2017_paper_40.pdf"
/>
