...
<InAction
  concept="Instacart Ads for a CPG brand's incrementality"
  companyName="Chomps"
  where="Chomps, a meat-stick CPG brand, ran keyword-targeted Sponsored Product campaigns through Instacart Ads Manager, then added Thrive Market-specific placements to reach high-intent grocery shoppers"
  why="Grocery shoppers on Instacart are already in a buying session, so a keyword-targeted ad reaching them mid-search converts differently than a cold social impression"
  what="They kept granular keyword-level bid control and layered retailer-specific placements on top of their base campaign instead of running one blanket campaign"
  benefit="A 60% higher click-through rate than comparable search ads and a 5% increase in new-to-brand category purchase rate year-over-year, while lowering cost per click"
  timeframe="January 2025 vs. January 2024"
  date="2025"
  source="https://company.instacart.com/instacart-ads/chomps-drives-new-customer-growth-and-engagement-on-thrive-market-using-instacart-ads"
/>
...
<InAction
  concept="Walmart Connect to reach non-Amazon shoppers"
  companyName="Dreame Tech"
  where="Dreame Tech, a vacuum and home-appliance manufacturer, ran Sponsored Brands and Sponsored Videos on Walmart Connect targeting top category keywords, then increased bids in Search In-grid placements once early data showed which creative worked"
  why="A large share of vacuum shoppers browse Walmart, not Amazon, and Dreame Tech's online listing had no existing brand recognition there to lean on"
  what="They led with awareness-building video creative and high-intent keyword targeting rather than starting with a narrow, price-led campaign"
  benefit="91% new-to-brand buyers and 47% ad-attributed sales across 5.9 million impressions, results strong enough that Dreame Tech used the online traction to justify expanding into physical Walmart stores"
  timeframe="November 14, 2024 to January 31, 2025"
  date="2025"
  source="https://www.walmartconnect.com/resources/case-studies/2025/brand-visibility-and-conversion-spark-omnichannel-growth"
/>
...
<ResourceList resources={[
  ...
  { title: "Amazon Ads Blog (official)", url: "https://advertising.amazon.com/blog", type: "docs", free: true },
  { title: "Walmart Connect Advertiser Help Center", url: "https://advertising.walmart.com/", type: "docs", free: true },
  { title: "Instacart Ads Platform", url: "https://www.instacart.com/company/ads", type: "tool", free: true },
