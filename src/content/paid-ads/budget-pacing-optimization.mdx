...
<InAction
  concept="Letting Smart Bidding settle after a budget change instead of reversing course mid-adjustment"
  companyName="Columbus, a Merkle company"
  where="Google Search Ads 360 Smart Bidding, managing search campaigns for an Australian entertainment and telco client"
  why="The client's search campaigns needed more efficient acquisition, but budget had to move up and down with the client's own spend cycles, exactly the kind of mid-flight change that risks throwing away Smart Bidding's accumulated signal."
  what="Columbus adopted Search Ads 360 Smart Bidding with a time-decay, cross-device attribution model and let the algorithm re-stabilize after each budget change instead of reversing a move the moment results dipped."
  benefit="40% lower cost per acquisition in the first month, a 36% increase in conversion rate by month two, and a 28% quarter-over-quarter CPA decrease that held even after budget was reduced and then increased again."
  timeframe="Results tracked across the first month, first two months, and continuing into quarterly and year-over-year comparisons"
  date="2025"
  source="https://marketingplatform.google.com/about/resources/columbus-boosts-conversions-smart-bidding/"
/>
...
<InAction
  concept="Committing budget and time to a campaign structure instead of pulling back at the first sign of a slow start"
  companyName="The Ascott Limited"
  where="Performance Max for Travel Goals campaigns across The Ascott Limited's Malaysia portfolio, run with agency eMarketingEye"
  why="With brand-attributed bookings and acquisition efficiency as priorities across a large, multi-brand hospitality portfolio, the team needed the AI bidding system to have enough budget and runway to actually learn intent signals rather than being second-guessed early."
  what="The team committed to a structured Performance Max for Travel Goals test with intent-based search themes and let it run its course instead of intervening early the way a panicked mid-flight budget cut would."
  benefit="A 41% increase in brand-led revenue, a 51% uplift in brand ROAS, and a 63% increase in Ascott Star Rewards member sign-ups."
  timeframe="Reported as a featured 2026 case study"
  date="2026"
  source="https://www.emarketingeye.com/blog/2026/07/24/performance-max-strategy-google-featured-the-ascott-limited-case-study/"
/>
