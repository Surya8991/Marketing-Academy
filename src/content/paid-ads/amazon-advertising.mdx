...
<InAction
  concept="Sponsored Brands Video"
  companyName="HP"
  where="HP's EMEA retail media team added Sponsored Brands video to its existing Sponsored Products and Sponsored Brands mix across its Amazon storefronts."
  why="Static Sponsored Brands banners were driving clicks but not showing shoppers the product in use, a gap video could close at the moment of comparison shopping."
  what="HP built Sponsored Brands video creative for its printer and laptop categories and scaled investment behind the format year over year."
  benefit="80% year-over-year increase in revenue and a 60% increase in units sold, with purchase paths that included video showing a 954% higher purchase rate for printers and a 709% higher purchase rate for laptops"
  timeframe="Year-over-year 2023 results"
  date="2023"
  source="https://advertising.amazon.com/library/case-studies/hp-finds-success-using-sponsored-brands-video"
/>
...
<InAction
  concept="Lowering ACoS With a Structured Sponsored Brands Strategy"
  companyName="Mine Stamp"
  where="Mine Stamp, working with agency Roicos, was running Sponsored Products with an ACoS high enough to erase most of its margin."
  why="An unstructured campaign was spending broadly across keywords of wildly different quality, so profitable and unprofitable search terms shared the same bids."
  what="Roicos rebuilt Mine Stamp's account around a dedicated Sponsored Brands strategy layered on top of restructured Sponsored Products campaigns, separating proven converting terms from discovery spend."
  benefit="ACoS dropped from 73.5% to 29.7% while total sales grew 560% and advertising sales grew 630%, with ROAS improving 25%"
  timeframe="May to October 2022"
  date="2022"
  source="https://advertising.amazon.com/library/case-studies/roicos-mine-stamp"
/>
