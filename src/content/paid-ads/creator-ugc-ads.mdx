...
<InAction
  concept="UGC in Dynamic Product Ads outperforming studio product photography"
  companyName="G-Star RAW"
  where="Meta dynamic product ads, UK and France markets"
  why="Standard white-background product photography wasn't converting well in markets where G-Star wasn't already a well-known brand"
  what="Replaced standard product photography in Dynamic Product Ads with real-customer UGC and on-brand image templates, sourced via Flowbox and served through Smartly.io"
  benefit="14% increase in CTR, 18% increase in conversion rate, and 16% increase in ROAS over a two-month test"
  timeframe="Two-month campaign test"
  date="2021"
...
<InAction
  concept="Whitelisting a creator's account to cut acquisition cost"
  companyName="Fabletics"
  where="Meta Partnership Ads, whitelisted creator handles"
  why="Standard brand-handle ad creative was fatiguing quickly, driving up cost per acquisition as the same audience saw the same brand-voice ads repeatedly"
  what="Shifted to running ads from whitelisted creator handles instead of the brand's own account, using Meta Partnership Ads to extend creator-account social proof to paid placements"
  benefit="30% reduction in customer acquisition cost and 40% longer ad lifespan before creative fatigue set in"
  timeframe="Ongoing always-on whitelisting program"
  date="2026"
  source="https://billo.app/blog/creator-partnership-ads/"
/>
