...
<InAction
  concept="SKAdNetwork (SKAN) Optimization"
  companyName="Getir"
  where="Across high-volume iOS on-demand grocery acquisition campaigns in Europe."
  why="Following Apple's ATT rollout, iOS install attribution collapsed, making paid campaign ROI invisible."
  what="They implemented an automated SKAN measurement workflow with AppsFlyer and Google Integrated Conversion Measurement (ICM) to aggregate postbacks and map early conversion values."
  benefit="Achieved a 4.1x increase in attributed iOS installs and a 69% reduction in Cost Per Install (CPI)"
  timeframe="6 months"
  date="2023"
  source="https://www.appsflyer.com/customers/getir/"
  counterExample="Relying on unconfigured SKAN postbacks left over 60% of conversion values null, obscuring paid channel incrementality."
/>
...
<InAction
  concept="Meta Conversions API (CAPI)"
  companyName="Samsung UK"
  where="In their cross-channel digital marketing and retail performance campaigns across the UK."
  why="Browser pixel restrictions post-iOS 14.5 obscured customer touchpoints across web and mobile storefronts."
  what="Implemented server-side Conversions API alongside pixel event deduplication to transmit verified first-party purchase events directly to Meta."
  benefit="Captured and measured 2.3x more customer purchases while improving algorithmic targeting accuracy"
  timeframe="3 months"
  date="2022"
  source="https://www.facebook.com/business/success/samsung-uk"
  counterExample="Running client-side browser pixels alone dropped match quality below 40% and inflated reported CPAs by over 35%."
/>
...
<InAction
  concept="Full measurement stack: pixel + CAPI + deduplication"
  companyName="TUI"
  where="Meta paid social campaigns for travel bookings"
  why="TUI needed to future-proof social ad measurement as iOS signal loss and cookie deprecation degraded standalone pixel tracking"
  what="TUI implemented server-side tracking via a Tealium-to-Meta Conversions API integration running alongside its existing pixel"
  benefit="Cost per booking dropped 6%, conversion rate for social traffic rose 29%, and return on ad spend increased 18%"
  timeframe="Following rollout of the Tealium-Meta CAPI integration"
  date="2023"
