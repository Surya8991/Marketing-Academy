...
<InAction
  concept="Spark Ads, Turning Organic Posts into Paid Placements"
  companyName="Treecard"
  where="TikTok Spark Ads, boosting existing creator UGC instead of producing new ads from scratch"
  why="Treecard needed to drive app installs for its eco-friendly debit card without the budget for a traditional paid-media production pipeline"
  what="Working with agency Kurve, Treecard sourced and analyzed 100 creator videos over two months, then ran TikTok's Creator Marketplace and Spark Ads to boost the best-performing organic posts, generating 280 creator videos and over 230 million unique views"
  benefit="A 1,027% increase in app installs and a 63% reduction in cost per install, despite a 327% increase in total ad spend"
  timeframe="Two-month creator sourcing and testing period"
  date="2024-01-12"
  source="https://ads.tiktok.com/business/en-US/inspiration/treecard-tiktok"
/>
