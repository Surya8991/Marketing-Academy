...
<InAction
  concept="Lo-Fi Native Short-Form Video"
  companyName="Duolingo"
  companyId="duolingo"
  where="TikTok For You Page organic and paid video feed"
  why="Polished corporate advertisements and direct translation of Meta ad creative suffered instant drop-off within the first second on TikTok."
  what="Shifted to an unhinged, entertainment-first content engine featuring mascot Duo in chaotic 5-to-15 second lo-fi skits, prioritizing abrupt opening hooks over corporate branding."
  benefit="Grew from 50k to over 16M followers with sustained 11-19% engagement rates (against the 2-3% platform average), driving 80% of new user app growth organically."
  timeframe="2021–2024"
  date="2024"
  source="https://www.thedrum.com/news/2022/02/09/how-duolingo-sparked-viral-tiktok-fame-with-chaotic-unhinged-mascot-duo"
/>
...
<InAction
  concept="Spark Ads and Dynamic Showcase Integration"
  companyName="e.l.f. Cosmetics"
  where="TikTok In-Feed and Spark Ads across US Gen Z audience feeds"
  why="Standard beauty video ads suffered rapid creative fatigue and high customer acquisition costs when scaled."
  what="Seeded organic creator tutorials, then amplified validated high-engagement creator posts into paid Spark Ads coupled with lower-funnel Dynamic Showcase Ads."
  benefit="Achieved a 56% reduction in CPA for add-to-cart conversions while scaling monthly spend, generating 31M views and 548,000 new site visitors in 90 days."
  timeframe="90 days"
  date="2024"
  source="https://www.tiktok.com/business/en-us/inspiration/elf-cosmetics"
/>
...
<InAction
  concept="Broad Audience Targeting Over Narrow Interest Stacks"
  companyName="BARDI Smart Home"
  where="TikTok Ads Manager's Broad Targeting feature, running Lowest Cost bidding to a wide, unrestricted audience"
  why="BARDI wanted to drive traffic and sales for its smart-home products without the manual-optimization overhead of layering interest, lookalike, and behavior filters"
  what="BARDI tested Broad Targeting instead of a stacked audience, letting TikTok's delivery system find buyers across a 4.9 million-person reach"
  benefit="A 94% higher conversion rate than the account's own average, with 450 direct TikTok Shop purchases and 42,000 profile views"
  timeframe="Single test campaign"
  date="2024-03-14"
  source="https://ads.tiktok.com/business/en-US/inspiration/bardi-smart-home"
/>
...
<ResourceList resources={[
  ...
  {
    title: "WordStream: How to Advertise on TikTok, The Complete Guide",
    url: "https://www.wordstream.com/blog/ws/tiktok-ads",
    type: "article",
