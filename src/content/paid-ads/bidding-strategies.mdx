...
<InAction
  concept="Target CPA (tCPA)"
  companyName="Apex Car Rentals"
  where="Google Search and Dynamic Search Ads campaigns across 40+ global markets"
  why="Manual bidding was too slow to adjust bids across fluctuating regional search auctions, resulting in high customer acquisition costs"
  what="Transitioned from manual bidding to automated Target CPA (tCPA) Smart Bidding, allowing machine learning to optimize bids per auction based on context and device signals"
  benefit="Achieved a 50% increase in conversion rate, a 49% decrease in CPA, and a 25% decrease in CPC"
  timeframe="Within 3 months of switching to tCPA"
  date="2023"
  source="https://www.thinkwithgoogle.com/intl/en-apac/marketing-strategies/automation/apex-car-rentals-smart-bidding/"
/>
...
<InAction
  concept="Target ROAS (tROAS)"
  companyName="Zurich Switzerland"
  where="Google Ads Search campaigns, insurance shopping keywords"
  why="Wanted to increase reach and capture insurance shoppers who research online but purchase offline, a pattern common in insurance"
  what="Trialled Target ROAS automated bidding fed by first-party website data, layered on Broad Match keyword targeting"
  benefit="Sales increased 9x and ROAS rose 52% within four weeks of switching to Target ROAS bidding"
  timeframe="4 weeks"
  date="2026"
  source="https://business.google.com/uk/think/ai-excellence/bidding-for-value-automation/"
/>

<InAction
  concept="Maximize Conversion Value outperforming Maximize Conversions"
  companyName="KEH Camera"
  where="Google Ads Performance Max shopping campaigns"
  why="Ad revenue growth had stalled on manual Smart Shopping campaigns using Maximize Conversions"
  what="Switched Performance Max bidding to Maximize Conversion Value, tested both with and without a Target ROAS setting layered on top"
  benefit="Ad revenue grew 76.3% and transactions grew 44.1% (Q1 2022 vs. Q1 2023), sustaining a 9.93x average monthly ROAS"
  timeframe="~12 months (transition began August 2022, compared Q1 2022 vs. Q1 2023)"
  date="2023"
  source="https://www.goinflow.com/blog/performance-max-case-study/"
/>
