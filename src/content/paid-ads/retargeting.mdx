...
<InAction
  concept="The Three Core Audience Segments"
  companyName="Wayfair"
  where="Google Display Network and Google Ads In-Market audience targeting across US and Canadian home goods shoppers"
  why="Generic broad display campaigns generated low response rates because top-of-funnel visitors were treated identically to shoppers actively comparing furniture specifications and pricing."
  what="Segmented display remarketing audiences by purchase intent using Google In-Market audience signals, isolating consumers on the cusp of purchasing from early-stage browsers and delivering tailored ad creatives."
  benefit="Increased ad response rates by up to 20% and lifted short-term conversion behavior by 10% to 30%."
  timeframe="Multi-week campaign deployment and measurement period"
  date="2017"
  source="https://www.thinkwithgoogle.com/marketing-strategies/search/wayfair-consumer-intent/"
/>
...
<InAction
  concept="Dynamic Retargeting (Dynamic Product Ads)"
  companyName="Leroy Merlin Poland"
  where="Leroy Merlin Poland, the home-improvement retailer, worked with an agency to replace static catalog ads with Dynamic Product Ads on Meta, refreshing the product feed every two hours so retargeting creative always matched real-time pricing and stock."
  why="Static catalog ads were showing outdated prices and discounts, weakening the retargeting message for shoppers who had already viewed specific products."
  what="They rebuilt the retargeting setup around Enriched Catalog Ads and Dynamic Product Ads powered directly by the store's product feed, with creative that auto-displayed current pricing, discounts, and campaign themes per shopper."
  benefit="ROAS climbed 79% year-over-year in the first full month and reached 514% year-over-year by month four, with conversion rate up 353% in month one and peaking at 910% year-over-year in month four"
  timeframe="March-July 2025"
  date="2025"
  source="https://cropink.com/meta-ads-examples"
/>
...
<InAction
  concept="Frequency management and creative rotation"
  companyName="Foodbag"
  where="Foodbag, a direct-to-consumer meal kit delivery service in Belgium, ran a dynamic retargeting campaign across French- and Flemish-speaking regions with weekly creative rotation instead of one static ad shown on repeat."
  why="A single ad shown too often to the same small retargeting pool risks the 'ad stalking' effect this lesson warns about, so the team rotated creative and personalized offers weekly to keep ads feeling fresh."
  what="They combined dynamic retargeting with contextually placed, weekly-refreshed creative and real-time discount messaging aimed specifically at past visitors."
  benefit="the campaign drove 5,976 unique conversions at a cost per acquisition of €4.90, with visitors spending an average of nearly 6 minutes on site after clicking through"
  timeframe="campaign period reported in the case study"
  date="2024"
  source="https://www.stackadapt.com/case-studies/dynamic-retargeting-boost-conversions"
/>
