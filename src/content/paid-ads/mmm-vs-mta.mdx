...
<InAction
  concept="Reallocating budget based on MMM findings improves ROI without a bigger budget"
  companyName="Delhaize"
  where="Belgian supermarket chain's marketing team, working with measurement consultancy Gain Theory"
  why="Delhaize's leadership wanted proof, based on facts rather than instinct, that marketing spend across categories and channels was actually driving sales before committing next year's budget"
  what="Gain Theory built marketing mix models covering product categories, online and in-store visits, and new customer acquisition, then used scenario planning to show what would happen to sales under different spend allocations"
  benefit="60% increase in marketing ROI, which justified an increased media budget the following year"
  timeframe="2022 analysis informing the 2023 budget cycle"
  date="2022"
  source="https://getrecast.com/mmm-examples/"
/>
...
<InAction
  concept="Open-source MMM tools letting smaller teams build in-house measurement"
  companyName="BARK"
  where="In-house data science team, using Meta's open-source Robyn package"
  why="BARK wanted to compare acquisition costs across Meta, Google, email, linear TV, and Amazon, and see how non-spend factors like press coverage affected subscriptions, without paying for a six-figure MMM vendor engagement"
  what="BARK's data scientists built their first in-house MMM using Robyn's open-source codebase, layering in both media spend and non-spend variables"
  benefit="30% increase in overall subscriptions, with the full model built in about three months"
  timeframe="Q3 2021 build, results reported afterward"
  date="2021"
  source="https://bark.london/blog/meta-project-robyn-open-source-measurement-event/"
/>
...
<ResourceList resources={[
  ...
  {
    title: "inBeat: MMM vs MTA, Which Works Best?",
    url: "https://www.inbeat.co/articles/mmm-vs-mta/",
    type: "article",
    note: "Comparison covering adoption survey data, iOS 14 impact analysis, and a practical decision framework.",
    free: true,
  },
  {
    title: "Google: Meridian Marketing Mix Model, Now Available to Everyone",
    url: "https://blog.google/products/ads-commerce/meridian-marketing-mix-model-open-to-everyone/",
    type: "article",
    note: "Google's official announcement and explainer for Meridian, its open-source MMM tool, and how it fits with modern measurement approaches.",
    free: true,
  },
  {
