...
<InAction
  concept="Demand Gen's Mid-Funnel Positioning"
  companyName="LG Electronics"
  where="LG Electronics ran Google Demand Gen campaigns to reach appliance and electronics shoppers earlier in their research journey than Search ads could reach them, comparing results directly against its paid social prospecting campaigns."
  why="LG wanted a channel that could warm consideration-stage shoppers who weren't searching yet, without paying paid-social CPMs for the same audience quality."
  what="LG shifted mid-funnel prospecting budget from paid social into Demand Gen, using Google's cross-surface YouTube, Discover, and Gmail inventory to reach the same behavioral-intent audience."
  benefit="91% lower cost per acquisition and 48% higher click-through rate than its paid social campaigns"
  timeframe="2025 Google Ads case study"
  date="2025"
  source="https://services.google.com/fh/files/misc/lg_demand_gen_case_study.pdf"
/>
...
<InAction
  concept="Creator Partnerships Boost"
  companyName="Away"
  where="Away, the DTC luggage brand, ran a Demand Gen campaign during its 2025 holiday push and used Demand Gen's Creator partnerships boost feature to run YouTube creator Emma Topp's travel content as ad creative."
  why="78% of U.S. viewers say YouTube has the most trusted creators for product recommendations, and Away wanted creative that read as trustworthy content, not a traditional ad, inside a mid-funnel campaign."
  what="Away supplied Emma Topp's organic travel content as Demand Gen creative alongside its own video and image assets, targeting travel-savvy audiences already engaging with creator content."
  benefit="A Google Conversion Lift study showed a 78% jump in incremental sales and a 16% lift in brand searches, with engaged site visits up 230% and add-to-carts up 140%"
  timeframe="Holiday 2025 campaign"
  date="2025"
  source="https://business.google.com/ca-en/think/search-and-video/demand-generation-performance-marketing-drive-consumer-intent/"
/>
