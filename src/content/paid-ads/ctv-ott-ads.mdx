...
<InAction
  concept="Interactive CTV ads driving direct action, not just awareness"
  companyName="Peloton"
  where="Connected TV, as part of the 'Home Fitness, Live' campaign"
  why="Peloton wanted CTV to do more than build awareness, since a leaned-back living-room viewer has no mouse to click and no app open"
  what="Ran an interactive CTV ad format combining live class previews with remote-enabled instant trial sign-up, letting a viewer act without picking up a phone"
  benefit="The campaign drove a 19% increase in trial starts alongside a 45% ad completion rate"
  timeframe="CTV campaign flight"
  date="2024"
  source="https://revsparkmedia.com/ctv-ads-example/"
/>
...
<InAction
  concept="Netflix's ad tier as a mass-reach CTV buy"
  companyName="Netflix"
  where="Netflix's ad-supported subscription tier, global"
  why="Netflix wanted to show advertisers its ad tier had grown from a premium niche experiment into genuine mass-reach inventory, not just a discount plan"
  what="Switched its reporting metric from ad-tier subscriber count to monthly active viewers, a figure that accounts for household co-viewing rather than just logged-in accounts"
  benefit="Reported 190 million monthly active viewers globally on the ad-supported tier by November 2025, more than double the 94 million figure reported in May 2024, and confirmed the ad tier now drives 55% of new Netflix sign-ups in markets where it's offered"
  timeframe="Three years after the ad tier's 2022 launch, reported November 2025"
  date="2025-11-01"
  source="https://www.hollywoodreporter.com/business/business-news/netflix-190-million-ad-tier-viewers-worldwide-1236418988/"
/>
...
<ResourceList resources={[
  ...
  { title: "MNTN Blog - CTV Advertising Research and Insights", url: "https://mountain.com/blog/", type: "article", free: true },
  ...
  { title: "MNTN - How Verified Visits Measures CTV Performance Without Clicks", url: "https://mountain.com/tech/how-mntn-measures-performance-without-clicks-a-deep-dive-into-the-verified-visits-model/", type: "article", free: true },
