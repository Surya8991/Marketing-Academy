...
<InAction
  ...
  companyName="Qeepsake"
  where="Qeepsake, a digital baby-memory app, ran creative tests inside Meta Ads Manager."
  why="They needed to know whether purchase-optimized ad sets or cheap-registration-optimized ad sets actually drove more paying subscribers."
  what="They isolated campaign optimization goal as the one variable, holding creative and audience constant, then combined the winning interest audiences into a single 'superset' ad set."
  benefit="Return on ad spend climbed from 70% in December to over 110% in January, the account's best ROAS on record at the time."
  timeframe="one month, December to January"
  date="2018-2019"
  source="https://embertribe.com/case-studies/creative-testing-for-a-more-successful-campaign"
/>
...
<InAction
  concept="Core message angle"
  companyName="Grammarly"
  where="Grammarly's marketing team, working with the creative agency Ghost Note, built a Gen Z-focused back-to-school YouTube campaign."
  why="Their usual straightforward product-benefit messaging wasn't landing with Gen Z students the way it did with older, paying professionals."
  what="They tested an authentic, meme-literate, self-aware comedic angle, the 'Future You Thanks You' concept, breaking the fourth wall and mixing humor with product explanation, against their standard tone."
  benefit="The campaign drove over 150 million views, with viewers actively searching for the full ad despite it airing as a paid placement."
  timeframe="reported June 2023"
  date="2023"
  source="https://business.google.com/in/think/ai-excellence/grammarly-case-study/"
/>
...
<InAction
  concept="The creative testing flywheel"
  companyName="Obvi"
  where="Meta & TikTok creative testing dashboard in Motion"
  why="Media buyers and video editors lacked granular performance data by hook, creator, and format, slowing down weekly iteration cycles"
  what="Implemented an element-level testing flywheel in Motion: tagged assets by opening hook style and visual angle, killing fatigued losers weekly and feeding winning hooks into new production briefs"
  benefit="Shipped 4x more winning creative concepts and profitably scaled monthly ad spend"
  timeframe="90-day testing cycle"
  date="2024"
  source="https://motionapp.com/case-studies"
/>
