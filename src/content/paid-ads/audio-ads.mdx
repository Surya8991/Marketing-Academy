...
<InAction
  concept="Spotify's cookie-less precision targeting through Ad Studio"
  companyName="ESPA Skincare"
  where="UK market, promoting the launch of ESPA's Active Nutrients skincare collection"
  why="ESPA needed to reach a specific buyer, women aged 18-50 interested in health, fitness, and lifestyle content, without relying on cookies, which Spotify's logged-in listener data made possible through interest and demographic targeting alone"
  what="Ran a professionally produced audio ad through Spotify Ad Studio (April 18-May 8, 2021), targeting Health & Lifestyle, Fitness, Travel, and Love & Dating interest segments, with a 20%-off promo code as the call to action"
  benefit="Achieved a 0.38% click-through rate, roughly 6.3x above Spotify's UK audio benchmark of 0.06%"
  timeframe="3-week campaign, April-May 2021"
  date="2021"
  source="https://ads.spotify.com/en-US/inspiration/espa-skincare-ad-studio-case-study/"
/>
...
<InAction
  concept="Hypersegmented targeting paired with promo-code measurement"
  companyName="Cabify Envíos"
  where="Madrid, launching Cabify's new same-day delivery service"
  why="Cabify needed to prove a brand-new local service to a defined geographic audience and measure whether the campaign actually drove app conversions, not just impressions"
  what="Ran a Spotify Ad Studio campaign (February 25-March 3, 2021) segmented by age group and interest (fitness, education, gaming, travel, business), targeted to specific Madrid postal codes where the service operated"
  benefit="Reached 95% of its hypersegmented audience across 643,000 impressions and drove a 20% lift in in-app conversions"
  timeframe="1-week campaign, February-March 2021"
  date="2021"
  source="https://ads.spotify.com/en-US/inspiration/cabify-ad-studio-case-study/"
/>
...
<ResourceList resources={[
  { title: "IAB U.S. Podcast Advertising Revenue Study", url: "https://www.iab.com/insights/us-podcast-advertising-revenue-study-2024/", type: "article", free: true, note: "Official industry benchmark for podcast ad revenue and growth rates" },
  { title: "Spotify Advertising - Ads Manager Guide", url: "https://ads.spotify.com/en-US/", type: "tool", free: false, note: "Spotify's self-serve programmatic audio ad platform (Ad Studio is now Spotify Ads Manager)" },
  ...
  { title: "Acast - Podcast Advertising Network", url: "https://www.acast.com/en/advertise/home", type: "article", free: true, note: "Practical guidance on host-read ad creative and placement from a 140,000+ show ad network" },
  { title: "Podcast Marketing: How to Effectively Market a Podcast - Neil Patel", url: "https://neilpatel.com/blog/podcast-marketing/", type: "article", free: true, note: "Step-by-step breakdown of podcast ad buying and measurement" },
