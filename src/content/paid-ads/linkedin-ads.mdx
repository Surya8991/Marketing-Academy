...
<InAction
  concept="Lead Gen Forms"
  companyName="Bynder"
  where="Bynder's LinkedIn demand-generation campaign promoting a DAM (Digital Asset Management) comparison guide"
  why="Wanted to remove the friction of sending paid clicks to an external landing page while competing against bigger-budget brands"
  what="Added mobile-optimized Lead Gen Forms directly onto existing Sponsored Content instead of linking out to a landing page"
  benefit="Click-to-lead conversion rate hit 20% and lead volume increased up to 500%"
  timeframe="Within months of adding Lead Gen Forms"
  date="2017"
  source="https://www.linkedin.com/business/marketing/blog/content-marketing/how-lead-gen-forms-helped-bynder-take-control-of-the-buyer-journey"
/>
...
<InAction
  concept="Matched Audiences"
  companyName="Refinitiv"
  where="Refinitiv's (financial market data and infrastructure company) account-based marketing campaigns on LinkedIn across APAC"
  why="Wanted to move beyond broad Sponsored Content and engage a specific list of target accounts with customized messaging"
  what="Used Matched Audiences to remarket to a defined target-account list in the middle of the funnel with highly customized messaging"
  benefit="34% higher click-through rate than their regular campaigns"
  timeframe="Sustained campaigns across APAC"
  date="2020"
  source="https://business.linkedin.com/marketing-solutions/case-studies/refinitiv"
/>
