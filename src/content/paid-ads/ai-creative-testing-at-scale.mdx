...
<InAction
  concept="Using AI to generate structurally different creative variations, not just more copies of the same shot"
  companyName="FULLBEAUTY Brands"
  where="Meta Advantage+ Shopping ads for FULLBEAUTY's catalog"
  why="Their catalog ads ran on plain, static white product backgrounds, giving Meta's delivery algorithm very little real creative variety to test against, even though the ad count looked healthy."
  what="Swapped the plain white catalog backgrounds for multiple AI-generated background variations built from the same product shots, giving the algorithm genuinely different creative combinations to test instead of near-identical copies."
  benefit="45% higher ROAS, a 22% higher conversion rate, and 36% higher CTR compared to their standard catalog ad setup."
  timeframe="Reported 2025"
  date="2025"
  source="https://www.facebook.com/business/success/fullbeauty-brands"
/>
...
<InAction
  concept="Pairing structurally distinct creative formats instead of running more volume of one homogenous format"
  companyName="Sephora"
  where="Meta ads across Instagram Feed, Stories, and Reels, combining creator-partnership content with Advantage+ Catalog Ads"
  why="A standard omnichannel campaign built from one ad format, however many variants, risks exactly the sameness fatigue this lesson warns about: more executions of one underlying idea instead of genuinely distinct angles."
  what="Paired authentic creator photos and videos, a genuinely different angle from a product shot, alongside catalog-style product ads so Meta's delivery system had two structurally distinct formats to test rather than many versions of one."
  benefit="1.56x higher incremental omnichannel ROAS and 3% higher incremental reach versus Sephora's standard omnichannel campaigns."
  timeframe="August 19 to September 15, 2025"
  date="2025"
  source="https://www.facebook.com/business/success/sephora"
/>
