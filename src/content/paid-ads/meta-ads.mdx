...
<InAction
  concept="Lookalike Audiences seeded from purchasers"
  companyName="Seltzer Goods"
  where="Seltzer Goods' Meta Ads account (Facebook & Instagram)"
  why="Wholesale orders collapsed at the start of the COVID-19 pandemic, so Seltzer Goods needed to find new direct-to-consumer customers online, fast, with no existing paid-social playbook to lean on."
  what="It built Lookalike Audiences seeded from three tiers of its own customer data, page visitors, AddToCart users, and Purchasers, scaling ad spend gradually as each lookalike tier proved itself."
  benefit="9.68x ROAS, a 785% increase in monthly revenue, and a $4.87 cost per acquisition, all by Facebook attribution"
  timeframe="within the first months of the campaign"
  date="2020"
  source="https://www.goinflow.com/blog/facebook-ads-case-study-seltzer-goods/"
/>
...
<InAction
  concept="Key Targeting Options Explained"
  companyName="Airbnb"
  where="Global guest acquisition campaigns on Facebook and Instagram feeds"
  why="Static broad ads failed to capture personalized travel intent across millions of individual destinations and rental listings"
  what="Integrated product catalogs with Meta Pixel data to serve Dynamic Ads for Travel (DAT) alongside Lookalike Audiences built from high-LTV past bookers"
  benefit="Generated a 3x increase in Return on Ad Spend (ROAS) and a 47% reduction in Cost Per Acquisition (CPA)"
  timeframe="Global campaign deployment"
  date="2023"
  source="https://growthmanifesto.com/airbnb-case-study/"
  counterExample="Targeting generic travel interest buckets with a single static image ad forces all travelers into one generic creative, driving up CPAs and depressing booking rates."
/>
...
<InAction
  concept="Creative: The Biggest Lever You Control"
  companyName="Lenskart"
  where="Instagram Reels and Facebook Feed campaigns promoting 3D Virtual Try-On and AR eyewear features across India"
  why="Polished studio product photography failed to overcome the high friction and hesitation of buying prescription glasses online"
  what="Produced 20+ mobile-first user-generated video variants (9:16) demonstrating customers scanning their faces and testing frames via 3D Try-On in real time"
  benefit="Captured over 41% market share in India's online eyewear sector with a 6.5% blended e-commerce and store-visit conversion rate"
  timeframe="FY 2024"
  date="2024"
  source="https://shyamfuture.com/case-study/lenskart-digital-marketing-strategy/"
  counterExample="Relying solely on static studio product renders on Reels gets skipped in under a second because it lacks native social proof and human interaction."
/>
