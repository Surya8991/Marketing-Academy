...
<InAction
  concept="Testing multiple creative formats instead of one static ad"
  companyName="GoodShort"
  where="GoodShort's Meta app-install campaigns"
  why="GoodShort's existing photo-and-video ads could only promote one show at a time, so its real bottleneck was creative variety, not budget or audience size."
  what="It A/B tested Advantage+ Catalog Ads, video assets pulling personalized show recommendations from its content library, against its old single-show static photo ads."
  benefit="4X increase in app downloads and a 67% lower cost per download"
  timeframe="October 7-28, 2025"
  date="2025"
  source="https://facebook.com/business/success/goodshort"
/>
