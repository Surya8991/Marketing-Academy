...
<InAction
  ...
  companyName="Zoobgear"
  where="Zoobgear, an online martial-arts and MMA gear retailer, noticed their top revenue-driving products were getting far fewer Google Shopping clicks than their catalog size should have produced."
  why="Their product titles were short and generic, missing the specific search terms real shoppers were typing into Google."
  what="They rewrote titles using shopping search-term reports and keyword research, adding recommended-user, activity-type, and material details so titles matched actual search queries instead of internal catalog naming."
  benefit="clicks from Google Shopping increased 250% overall, and some previously zero-traffic products began getting 50+ clicks per day after their titles were rewritten"
  timeframe="over a 6-month optimization period"
  date="2024"
  source="https://www.datafeedwatch.com/blog/tips-optimize-shopping-campaigns-and-get-incredible-results-case-study"
/>
...
<InAction
  concept="Performance Max Asset Groups"
  companyName="Joybird"
  where="Google Performance Max campaign rollout across US search, shopping, and display networks"
  why="Legacy Smart Shopping campaigns hit efficiency ceilings and lacked cross-channel discovery reach for custom, high-ticket mid-century modern furniture."
  what="Migrated from Smart Shopping to Performance Max, pairing rich product catalog feeds with custom lifestyle video and image asset groups tailored to interior design intent."
  benefit="Delivered a 95% increase in revenue and a 40% improvement in ROAS compared to previous Smart Shopping baselines."
  timeframe="Quarterly migration and post-launch evaluation period"
  date="2022"
  source="https://www.thinkwithgoogle.com/marketing-strategies/automation/joybird-performance-max/"
/>
...
<InAction
  concept="Custom Labels for feed segmentation"
  companyName="Studio Cappello"
  where="Studio Cappello, a WMR Group retailer, wanted its Performance Max budget to favor the products actually driving margin, not just the products getting the most impressions."
  why="Without segmentation, PMax spends across the whole catalog roughly evenly, even though a small share of SKUs usually drives most of the revenue."
  what="They uploaded CRM and business-intelligence data into their feed as Custom Labels, tagging every product into four performance tiers (Top, High, Middle, Low) so budget could shift toward the highest-value tier."
  benefit="revenue increased 80% on just a 7% increase in ad spend after the custom-label segmentation went live"
  timeframe="reported in the case study"
  date="2024"
  source="https://www.datafeedwatch.com/blog/pmax-optimization-business-intelligence-data"
/>
...
<InAction
  concept="Smart Bidding and First-Party Signals"
  companyName="Lindex"
  where="Google Ads Performance Max rollout across European e-commerce markets"
  why="Manual channel management across search and shopping fragmented budget allocation and slowed down bid adjustments across diverse apparel categories."
  what="Adopted Performance Max with Target ROAS Smart Bidding anchored by first-party customer loyalty club data as audience signals, piloting in Norway before full European rollout."
  benefit="Achieved a 27% increase in ROAS while scaling total conversion value across all international storefronts."
  timeframe="Pilot phase followed by international expansion"
  date="2023"
  source="https://www.thinkwithgoogle.com/intl/en-gb/marketing-strategies/automation/lindex-performance-max/"
/>
...
<ResourceList resources={[
  ...
  },
  {
    ...
    type: "docs",
    note: "Google's official documentation covering PMax setup, asset groups, audience signals, and measurement. For the certification exam, see Google Skillshop's Google Ads training hub.",
    free: true,
  },
  {
