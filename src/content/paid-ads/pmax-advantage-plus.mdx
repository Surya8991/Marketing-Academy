...
<InAction
  concept="Performance Max as an intent-capture engine"
  companyName="Joybird"
  where="US furniture ecommerce, testing Performance Max against existing Search and Shopping campaigns"
  why="Joybird wanted to know whether letting Google's algorithm handle targeting and placement decisions across Search, Shopping, Display, and YouTube would outperform manually managed campaigns"
  what="Ran a 10-week controlled Performance Max test, layering diverse creative assets (headlines, descriptions, images, video) on top of existing Search campaign data"
  benefit="Delivered a 95% revenue lift, a 40% higher ROAS, and a 52% increase in clicks versus the prior campaign structure"
  timeframe="10-week test, published April 2022"
  date="2022"
  source="https://gofishdigital.com/case-study/joybird-paid-advertising-success-from-performance-max-testing/"
/>
...
<InAction
  concept="Server-to-server signal quality via Conversions API"
  companyName="Club Med"
  where="Global, rolled out simultaneously across 35 international markets"
  why="With third-party cookies deprecating and browser-based Pixel tracking losing reliability, Club Med needed to keep its conversion signal accurate enough for Meta's bidding algorithm to keep finding real buyers, not just clicks"
  what="Implemented Meta's Conversions API for server-to-server event tracking, with data encryption and anonymization, replacing sole reliance on browser-based Pixel tracking"
  benefit="Registered 10% more trackable events and cut cost per acquisition by 26%"
  timeframe="Global rollout, presented at HUBDAY Data & AI for Business, May 2022"
  date="2022"
