...
<ResourceList resources={[
  ...
  { title: "Baymard Institute: Form Field Usability", url: "https://baymard.com/blog/form-field-usability-label-position", type: "article", free: true, note: "Research-backed guidance on label placement and validation" },
  { title: "NN/g: Microcopy: Tiny Words With Huge UX Impact", url: "https://www.nngroup.com/articles/microcopy/", type: "article", free: true, note: "Nielsen Norman Group overview with examples" },
  { title: "ConversionXL: Button Copy Tests", url: "https://cxl.com/blog/call-to-action-buttons/", type: "article", free: true, note: "Aggregated CTA button research including Aagaard's findings" },
  ...
  { title: "MailChimp Content Style Guide", url: "https://styleguide.mailchimp.com/writing-for-ux/", type: "docs", free: true, note: "Practical guidance from a company known for strong product copy" },
