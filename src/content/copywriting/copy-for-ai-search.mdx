...
<InAction
  concept="Answer-First Writing"
  companyName="Semrush"
  where="Semrush's own product and blog content, tracked against a 39-prompt AI visibility set"
  why="Despite launching a new Enterprise AIO product, large language models were barely mentioning Semrush when users asked AI tools about AI-visibility platforms."
  what="Rewrote dense articles into cleaner structures that answer the question completely in the first sentence, with clear headings and comparison tables replacing paragraph-buried explanations."
  benefit="AI share of voice nearly tripled from 13% to 32% in one month on the original prompt set"
  timeframe="one month, summer 2025"
  date="2025"
  source="https://www.semrush.com/blog/how-we-are-using-semrush-to-drive-llm-visibility/"
/>
...
<InAction
  concept="Structured Data and Schema Markup"
  companyName="Otterly.AI"
  where="Three pages on Otterly.AI's own SaaS site, tracked across 319 prompts in the US market"
  why="The team wanted a controlled before/after test of whether adding schema actually changes AI citation rates, rather than assuming it does."
  what="Deployed five schema types, FAQ, Organization, SoftwareApplication, Review Snippets, and Article/BlogPosting, on the three pages and tracked citations across 7 AI platforms for three months."
  benefit="Citations in Google AI Overviews increased 611% and AI Mode citations increased 42% for the schema-marked pages"
  timeframe="December 7, 2025 to March 7, 2026"
  date="2026"
  source="https://otterly.ai/blog/schema-markup-real-impact-ai-search/"
/>
