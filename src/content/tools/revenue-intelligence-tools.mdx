...
<InAction
  concept="Deal-risk signals from call data reshaping sales enablement priorities"
  companyName="Mintel"
  where="Sales, Client Success, and Sales Enablement teams"
  why="Needed visibility into which behaviors actually correlated with wins across a large global client base instead of relying on rep instinct."
  what="Used Gong to discover that deals with 4+ contacts closed more often, mandated multi-threading, and used Deal Boards to flag deals lagging 15+ days for coaching."
  benefit="34% increase in win rate"
  timeframe="within the sales cycles measured after rollout"
  date="2026"
  source="https://www.gong.io/customers/case-studies/research-recommendations-and-reality-how-gong-helped-mintel-increase-win-rates-by-34"
/>
...
<InAction
  concept="Forecast accuracy from pipeline-health signals, the same 'predict what will close' logic marketers use for campaign timing"
  companyName="Drata"
  where="Account Management and Customer Success, ramping a newly built 19-person team"
  why="A brand-new account management team needed a shared, data-grounded way to assess deal and renewal health instead of everyone forecasting from gut feel."
  what="Used Clari to inspect pipeline health, assess churn risk, and ground every forecast call in the same dashboard data across the whole team."
  benefit="Reached 100% forecast accuracy by week 7 of their first fully ramped quarter, with worst-case variance of just 7%"
  timeframe="first fully ramped quarter after the team was built"
  date="2025"
  source="https://www.clari.com/resources/customer-stories/drata/"
/>
