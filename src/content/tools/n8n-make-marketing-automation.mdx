...
<InAction
  concept="n8n workflow automation for marketing and content operations"
  companyName="Huel"
  where="Huel's digital marketing and content team, via n8n Enterprise"
  why="Manual data pipelines and reporting across content and digital marketing were consuming days of an SEO manager's week"
  what="An SEO manager and Huel's automation team built and ran nearly 200 live n8n workflows across digital marketing and content operations, with the SEO manager eventually spending 3-4 days a week on automation work"
  benefit="Saved 1,000+ hours of manual work in nine months and let Huel cancel roughly £100,000 in annual software licenses"
  timeframe="9 months"
  date="2026"
  source="https://n8n.io/case-studies/huel/"
/>
...
<InAction
  concept="Make replacing a legacy integration system without custom code"
  companyName="FranklinCovey"
  where="FranklinCovey's operations team, replacing a 15-year-old service bus"
  why="The legacy middleware was costly to maintain, and one annual HR process took 30 days to run every time"
  what="FranklinCovey used Make as both an integration platform and an automation layer, connecting existing tools without buying new applications or writing custom code"
  benefit="Cut a $60,000 annual software expense and reduced a 30-day HR workflow to 2 hours"
  timeframe="Ongoing since rollout"
  date="2026"
  source="https://www.make.com/en/success-stories/franklin-covey-make-success-story"
/>
...
| | Zapier | Make | n8n |
|---|---|---|---|
| Pricing model | Per task | Per operation/credit | Per execution |
| Free tier | 100 tasks/month | 1,000 credits/month | Free (self-hosted only, Cloud requires a paid plan) |
...
<ResourceList resources={[
  ...
  { title: "n8n Cloud Pricing", url: "https://n8n.io/pricing/", type: "tool", free: false, note: "Paid plans start ~$24/month; self-hosted Community Edition is free" },
  { title: "Make.com Pricing", url: "https://www.make.com/en/pricing", type: "tool", free: true, note: "Free tier: 1,000 credits/month" },
