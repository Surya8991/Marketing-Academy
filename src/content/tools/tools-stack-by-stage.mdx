...
<InAction
  concept="Stage-Appropriate Stack Rebuild"
  companyName="D-Tools"
  where="D-Tools, AV and low-voltage system integration software company, marketing team"
  why="Their existing Marketo instance and legacy web infrastructure had become fragmented and couldn't support their next stage of growth"
  what="Migrated marketing automation, CMS, and CRM operations onto a single HubSpot Marketing and CMS Enterprise platform over a 12-month rebuild"
  benefit="258% increase in new organic visitors and 162% increase in organic sessions, with traffic gains visible in under three months"
  timeframe="12-month migration, first results within 3 months"
  date="2025"
  source="https://www.molestreet.com/case-studies/global-award-winning-b2b-saas-migrates-to-hubspot-marketing-and-cms-enterprise-for-huge-results"
/>
...
<InAction
  concept="Recognizing You've Outgrown Your Stack"
  companyName="Citron Hygiene"
  where="Citron Hygiene's global marketing operations team"
  why="Three separate regional Salesforce orgs plus Pardot and DotDigital caused constant data-sync complications and left teams unable to see a single customer view"
  what="Consolidated the fragmented, multi-platform setup onto a single HubSpot Marketing Enterprise instance"
  benefit="120% increase in lead generation after a 6-week consolidation implementation"
  timeframe="6 weeks"
  date="2025"
  source="https://www.innovationvisual.com/case-studies/citron-hygiene-hubspot-integration"
/>
