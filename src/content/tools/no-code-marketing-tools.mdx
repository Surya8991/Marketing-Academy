...
<InAction
  concept="Automation as the glue layer between systems"
  companyName="Autotorino"
  where="Autotorino's CRM and digital team"
  why="Lead intake from dozens of sources was hitting Salesforce through inconsistent, manual, copy-paste workflows, creating data errors and wasted rep time."
  what="Riccardo Berta on the CRM team rebuilt lead intake as 109 production Zaps, each triggered by a specific lead source or process, all writing directly into Salesforce as the single system of record."
  benefit="Returned 2,394 hours to the CRM team in 2025 and eliminated a whole class of copy-and-paste data errors."
  timeframe="Calculated across 2025"
  date="2025"
...
<InAction
  concept="No-code experimentation replacing dev-ticket A/B tests"
  companyName="Lattice"
  where="Lattice's growth marketing team, on their Webflow-built marketing site"
  why="Every landing-page test used to need an engineering ticket, so the team ran only a handful of experiments a quarter and iteration was slow."
  what="The team moved testing onto Webflow's visual site builder and ran six to eight A/B tests every six weeks without filing a single dev ticket."
  benefit="Site-wide conversion rate increased 20% and organic traffic increased 20% from the faster experimentation cadence."
  timeframe="Ongoing testing program, results as of 2025"
  date="2025"
  source="https://webflow.com/customers/lattice"
/>
...
<ResourceList resources={[
  ...
  { title: "WsCube Tech - No-Code Marketing Tools (Hindi)", url: "https://www.youtube.com/@WsCubeTech", type: "video", lang: "hi", free: true, note: "Top Hindi digital marketing channel" },
  { title: "Mr Digital Marketing Tamil - No-Code Marketing Tools", url: "https://www.youtube.com/channel/UCQpgJad_YaHAW_CVFTBNyiw", type: "video", lang: "ta", free: true, note: "Tamil digital marketing tutorials" },
  { title: "ODMT Telugu - No-Code Marketing Tools", url: "https://www.youtube.com/@ODMTtelugu", type: "video", lang: "te", free: true, note: "Telugu digital marketing training" },
]} />