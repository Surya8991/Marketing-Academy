...
Google Analytics 4 (GA4) is the free tool from Google that tells you everything about your website visitors: where they came from, what pages they looked at, how long they stayed, and whether they bought something (or signed up, or called you). Every serious marketer uses it. It costs nothing to set up and runs on over 15 million websites worldwide.
...
A mid-size ecommerce retailer used GA4's device breakdown report (Reports > User > Tech > Overview) and found desktop users converted at 8% while mobile users converted at only 2%. Mobile was 60% of their traffic. That gap meant they were losing thousands of dollars per week. After a complete mobile checkout redesign informed by GA4's funnel reports, they achieved a 40% revenue increase from mobile traffic.
...
"Direct" in GA4 means GA4 could not figure out the source. This is often email links without UTM parameters (tracking codes), bookmarks, or links in apps. Add UTM parameters to all your email and ad links.
