...
<InAction
  concept="Duplicate tracking code silently inflating GA4 numbers"
  companyName="MyCardirect.com"
  where="An online car dealership with both a gtag.js snippet and a separate Google Tag Manager container firing on every page"
  why="Reported conversions and event counts looked implausibly high, and login/signup numbers didn't match what the business actually saw"
  what="Removed the duplicate gtag.js and GTM installations and consolidated all conversion tracking into a single Google Tag Manager setup"
  benefit="Eliminated 3x conversion overcounting and fixed the login/signup miscount, restoring accurate attribution"
  timeframe="as part of a full tracking audit"
  date="2026"
  source="https://ga4experts.com/case-studies/"
/>
...
<InAction
  concept="Building custom funnels instead of relying on default reports"
  companyName="Printique"
  where="Adorama's photo-printing e-commerce brand, which had gaps in its GA4 dataLayer and no purpose-built conversion funnels"
  why="Default GA4 reports couldn't show step-by-step drop-off across their specific multi-step ordering flow, including mid-editor product switches"
  what="Built 17 custom ecommerce conversion funnels in GA4 Explorations with step-level dataLayer specification, verified event-by-event with the dev team"
  benefit="17 custom funnels live in GA4 Explorations with item-level dataLayer accuracy on every step, giving the team real step-by-step visibility into checkout behavior"
  timeframe="as part of a full GA4 ecommerce tracking rebuild"
  date="2026"
  source="https://ga4experts.com/case-studies/"
/>
...
<ResourceList resources={[
  ...
  { title: "Google Analytics Academy - Free GA4 Course", url: "https://support.google.com/analytics/answer/15068052", type: "course", free: true, note: "Free official Google certification course" },
