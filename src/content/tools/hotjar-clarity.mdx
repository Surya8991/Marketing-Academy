...
<InAction
  concept="Using heatmap move-maps and CTA visibility fixes to find hidden friction"
  companyName="Intertop"
  where="the product and checkout pages of a Ukrainian online shoe store, redesigned by UX agency Turum-burum"
  why="conversion rate was underperforming and the team couldn't tell which step in the funnel was losing customers"
  what="an exit-intent survey found 48.6% of 444 respondents couldn't complete checkout, and heatmap move maps showed the main 'Buy now' button sat below the average fold; the team redesigned checkout to reduce fields and add autofill, then moved the CTA into view"
  benefit="a 55% overall conversion increase, with a 31% lift in product-to-cart conversion and an 11.5% rise in average revenue per user"
  timeframe="Year-long CRO engagement"
  date="2024"
  source="https://contentsquare.com/partner-stories/turum-burum/"
/>
...
<InAction
  concept="Session recordings revealing a hidden UI blocker killing conversions"
  companyName="TurkNet"
  where="TurkNet's mobile landing page for internet package subscriptions"
  why="Google Analytics data showed service-availability check actions dropping on specific mobile screen resolutions, but the team didn't know why"
  what="Microsoft Clarity session recordings showed users weren't dismissing the cookie-consent popup, which hid the signup form and button below it; the UX and legal teams redesigned the consent screen together"
  benefit="a 107% increase in internet package subscriptions and a 72% increase in service-availability check actions"
  timeframe="Analysis-to-redesign cycle"
  date="2024"
  source="https://clarity.microsoft.com/case-studies/turknet/"
/>
