...
<InAction
  concept="Structured Data Validation via Search Console"
  companyName="Monster India"
  where="Job details pages across Monster.com's India job listings"
  why="Monster India wanted its listings to appear directly in Google's Jobs search experience, which requires clean, error-free JobPosting structured data, the same kind of markup error Search Console's URL Inspection tool flags."
  what="Monster India's SEO team piloted JobPosting structured data in April 2018, used Search Console's structured data reports to catch and fix markup errors, then scaled it across all India job listings once the pilot showed results."
  benefit="94% increase in organic traffic to job details pages and a 10% increase in job applications, on top of what prior SEO and paid campaigns had achieved."
  timeframe="Piloted April 2018, results published by Google in June 2019"
  date="2019-06-18"
  source="https://developers.google.com/search/case-studies/monster-india-case-study"
/>
...
<InAction
  ...
  where="Cloudflare's Crawler Hints service, Cache tab in the dashboard"
  why="Roughly half of crawler traffic hits pages that have not changed since the last crawl, wasting both the site's and the search engine's resources."
  what="Cloudflare built IndexNow directly into its Crawler Hints feature so any site on its CDN can notify Bing and Yandex the moment a page changes, activated with a single dashboard toggle and no code."
  benefit="Addressed the roughly 53% of crawler traffic Cloudflare found was spent re-crawling unchanged pages, improving crawl efficiency for the ~45% of internet traffic that comes from bots and crawlers."
  timeframe="Shipped as a one-click dashboard feature"
  date="2021-10-18"
  source="https://blog.cloudflare.com/cloudflare-now-supports-indexnow/"
/>
