...
<InAction
  concept="Composable CDP architecture (collection, warehouse, reverse ETL)"
  companyName="XP Inc."
  where="XP Inc., Brazil's largest independent investment platform, rebuilt its customer-acquisition data stack around Hightouch reverse ETL syncing predictive models out of its warehouse"
  why="Ad platforms were bidding on raw lead volume instead of predicted account-funding likelihood, wasting spend on low-quality traffic"
  what="XP's data science team scored leads for funding likelihood inside the warehouse, then used Hightouch to sync those scores directly into ad-platform bidding signals, no manual export"
  benefit="62.5% improvement in lead qualification and $66M in incremental revenue, including $38M from performance media optimization"
  timeframe="Not stated in source"
  date="2025"
  source="https://hightouch.com/customers/xpinc"
/>
...
<InAction
  concept="Reverse ETL syncing warehouse audiences to marketing and product tools"
  companyName="IntelyCare"
  where="IntelyCare, a nurse-staffing platform, built a warehouse stack pairing Snowflake and Hightouch to activate its customer data"
  why="Manually building and re-uploading applicant audiences for retargeting was expensive and slow to react to changing supply and demand"
  what="IntelyCare synced warehouse-scored applicant and facility segments directly into its lifecycle and ad-targeting tools via Hightouch, replacing manual list-building"
  benefit="300% year-over-year growth during COVID-era demand while saving over $1 million in marketing spend"
  timeframe="Documented during 2020-2022 COVID-era scaling"
  date="2022"
...
<ResourceList resources={[
  ...
  { title: "Hightouch Reverse ETL Playbook", url: "https://hightouch.com/playbooks", type: "article", free: true },
