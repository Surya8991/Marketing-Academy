...
<InAction
  concept="Drift playbooks qualifying visitors and booking meetings automatically"
  companyName="Telenet"
  where="Telenet, Belgium's largest telecom and media company, deployed a Drift playbook (built with partner LeadFabric) to convert small-office/home-office website visitors"
  why="SOHO leads researching outside business hours had no way to get answers or book a callback until the next business day"
  what="A Drift chatbot engaged visitors after hours, asked qualifying questions, and routed hot leads straight into the sales pipeline instead of a contact form"
  benefit="25% increase in overnight and weekend conversions and a 40% improvement in close-won rate"
  timeframe="About one month after launch"
  date="2020-10-16"
  source="https://resources.leadfabric.com/leadfabric-blog/how-leadfabric-drift-generated-1m-in-pipeline-in-only-6-weeks"
/>
...
<InAction
  concept="Intercom's Fin AI agent resolving support volume automatically"
  companyName="RB2B"
  where="RB2B, a website-visitor identification platform, rebuilt its support model around Intercom's Fin AI Agent as its user base scaled fast"
  why="Support volume was growing in lockstep with sign-ups, and hiring a human support team fast enough wasn't realistic for a small team"
  what="Fin AI Agent handled the majority of inbound support conversations automatically, escalating only complex cases to humans"
  benefit="User base doubled within two months while support inquiries dropped 45% and the team saved 120+ hours of manual work in the first month"
  timeframe="First two months after rollout"
  date="2025"
  source="https://www.intercom.com/blog/videos/creating-a-lean-scalable-support-system/"
/>
