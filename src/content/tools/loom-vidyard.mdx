...
<InAction
  concept="Video prospecting for outbound sales"
  companyName="1Huddle"
  where="1Huddle's sales and marketing team, sending Vidyard video emails to prospects over one year"
  why="Standard cold outreach was blending into inboxes; the team needed a way to signal a real human had looked at each prospect before pitching a mobile-game training platform."
  what="Switched their outbound email sequence to lead with a short personalized Vidyard video instead of plain text, sending 45,455 videos over the year."
  benefit="68% email open rate and a 12% reply rate across all 45,455 videos sent"
  timeframe="one year of using Vidyard"
  date="2025"
  source="https://www.vidyard.com/case-studies/1huddle-video-email-prospecting-case-study/"
/>
...
<InAction
  concept="Personalized video sales prospecting cadence"
  companyName="Terminus"
  where="Terminus's sales development team, integrating Vidyard into their SalesLoft prospecting sequences"
  why="Standard text-only outreach in an account-based marketing motion was getting lost among dozens of similar emails hitting the same target accounts."
  what="Added a short personalized Vidyard video to the first touch of their prospecting cadence, following the same record-with-research approach this lesson teaches."
  benefit="40% higher open rate, 37% higher click rate, and 216% higher reply rate (more than triple the standard reply rate) on prospecting emails"
  timeframe="within a few months of adopting video"
  date="2017"
  source="https://www.vidyard.com/case-studies/terminus-abm-platform-video-for-sales-advice/"
/>
