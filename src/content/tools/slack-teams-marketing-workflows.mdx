...
<InAction
  concept="No-code approval workflow via Slack Workflow Builder"
  companyName="Salesforce"
  where="Salesforce's corporate marketing team"
  why="Campaign insight-routing and approval requests were stalling inside email threads, slowing down launches."
  what="Salesforce's marketing organization routed campaign insights and approval requests through Slack instead of email, a shift Slack later publicized as a customer story."
  benefit="36% faster responses to teammates and partners, and 37% faster team decision-making, per Salesforce's own Customer and Market Success Metrics."
  timeframe="Measured after adopting Slack for marketing workflows"
  date="2023"
  source="https://slack.com/blog/collaboration/salesforce-marketing-teams-use-automation-to-simplify-processes-and-fuel-productivity"
/>
...
<InAction
  concept="Redesigning notification defaults to cut alert overload"
  companyName="Slack"
  where="Slack's own product engineering team, rebuilding notification preferences platform-wide"
  why="Four conflicting legacy preference systems left users buried in inconsistent, unfiltered alerts across desktop and mobile."
  what="Slack replaced four legacy notification paradigms with one unified model (all messages, mentions and DMs, or mute) and separated notification intent from delivery."
  benefit="5x increase in user engagement with notification settings, sustained for weeks rather than a one-time curiosity spike, plus a measurable drop in support tickets about notification confusion."
  timeframe="Rebuilt and shipped platform-wide"
  date="2026-04-16"
  source="https://slack.engineering/how-slack-rebuilt-notifications/"
/>
