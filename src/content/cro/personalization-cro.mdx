export const lessonMeta = {
  ...
  level: "Advanced",
  summary: "Segment-specific pages, dynamic copy, and the proven playbook for lifting conversions with personalization in 2026.",
};
...
<InAction
  concept="Identify your segments"
  companyName="HubSpot"
  where="A high-traffic product page that was showing the same 'Sign up free' CTA to every visitor"
  why="The team noticed the page was showing free-signup CTAs to visitors who were already existing free users, a segment with a completely different next action"
  what="Built a smart content rule that swapped the CTA to a demo request for the 'existing free user' segment, while new visitors kept seeing the free-signup CTA"
  benefit="Demo requests rose 560%, from 38 to 258 per month, measured as a before/after lookback rather than a traditional A/B split"
  timeframe="Lookback comparison, before vs. after the rule went live"
  date="2026-01"
  source="https://marketingagainstthegrain.com/articles/the-simple-website-personalization-that-increased-conversions-by-560"
/>
...
<InAction
  ...
  where="A landing page headline that always used the same fixed verb regardless of what the visitor searched for"
  why="Search visitors arrived having typed a specific verb, 'design,' 'create,' or 'build,' into Google, and the static headline matched only some of them"
  what="Used the exact verb from the visitor's search query as the signal to dynamically swap the headline's verb to match what they had typed"
  benefit="31.4% lift in conversions for the dynamic-verb variant over the static control"
  timeframe="77-day A/B test, October 31, 2017 to January 16, 2018"
  date="2018-01"
  source="https://blog.conversionlab.no/see-how-dynamic-text-on-a-landing-page-increased-conversions-by-31-4/"
/>
...
<ResourceList resources={[
  ...
  { title: "NN/g: 6 Tips for Successful Personalization", url: "https://www.nngroup.com/articles/personalization/", type: "article", free: true, note: "Statistical guidance, segment sizing rules, and real case studies from Nielsen Norman Group" },
  ...
  { title: "Unbounce: Dynamic Text Replacement", url: "https://unbounce.com/landing-page-articles/dynamic-text-replacement/", type: "docs", free: true, note: "Step-by-step guide to swapping landing page copy based on UTM parameters - the fastest personalization tactic" },
