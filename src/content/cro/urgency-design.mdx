...
<InAction
  concept="Access-based scarcity"
  companyName="Robinhood"
  companyId="robinhood"
  where="Pre-launch referral waitlist, 2013-2015"
  why="With no product live yet, Robinhood needed a way to convert curiosity into commitment without any ad spend, so it made early access itself the scarce resource"
  what="Everyone who signed up joined a public queue that moved up in real time as they referred friends; only the first 5,000 people to reach 10 referrals qualified for a founder-tier reward, turning the waitlist into a live, honest scarcity mechanic rather than a fabricated countdown"
  benefit="Nearly 1 million people joined the waitlist before public launch, growing to over 6 million users within 2 years, almost entirely through referrals with minimal ad spend"
  timeframe="2013-2015"
  date="2015"
  source="https://viral-loops.com/blog/how-robinhoods-referral-built-a-1m-user/"
/>
...
<InAction
  ...
  companyName="Amazon"
  where="Prime membership sign-up and cancellation flow (the 'Iliad flow')"
  why="The FTC's 2023 complaint alleged Amazon used deceptive interface designs, including confusing cancellation steps and misleading urgency cues, to enroll and retain Prime subscribers without clear consent"
  what="Rather than continue litigating, Amazon agreed to a settlement covering the enrollment and cancellation practices named in the complaint"
  benefit="$2.5 billion settlement: a $1 billion civil penalty plus a $1.5 billion consumer fund paying roughly 35 million eligible Prime customers about $51 each, the largest civil penalty ever in an FTC rule-violation case"
  timeframe="Complaint filed 2023, settled September 2025"
  date="2025-09-25"
...
<ResourceList resources={[
  { title: "The impact of dark patterns on user trust and long-term engagement: An ethical analysis (WJARR 2025)", url: "https://wjarr.com/sites/default/files/fulltext_pdf/WJARR-2025-0691.pdf", type: "article", free: true, note: "Peer-reviewed; source of the 76% statistic" },
  ...
  { title: "FTC Report - Bringing Dark Patterns to Light", url: "https://www.ftc.gov/reports/bringing-dark-patterns-light", type: "docs", free: true, note: "Covers the Amazon complaint context" },
  ...
  { title: "Shopify Blog - Scarcity Marketing Tactics", url: "https://www.shopify.com/blog/scarcity-marketing", type: "article", free: true },
  { title: "VWO Glossary - Scarcity Marketing", url: "https://vwo.com/glossary/scarcity/", type: "article", free: true, note: "Covers Booking.com and Amazon scarcity signal examples" },
