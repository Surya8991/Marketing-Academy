...
<InAction
  concept="Heatmaps and Scroll Maps"
  companyName="Original Grain"
  where="Original Grain's ecommerce product pages"
  why="The team needed to know which specific page elements were actually driving revenue before deciding what to test next, instead of guessing from aggregate conversion data alone"
  what="They used element-level heatmap revenue data to identify the highest-impact areas of the page and prioritized tests around those elements"
  benefit="17% lift in revenue per session while scaling site traffic by 43%"
  timeframe="Reported 2025"
  date="2025"
  source="https://www.heatmap.com/blog/increase-revenue"
/>
...
<InAction
  concept="Session Recordings"
  companyName="Wyldsson"
  where="Wyldsson's ecommerce checkout and account login flow"
  why="Customers were leaving without completing purchases and the team could not tell why from funnel analytics alone"
  what="They watched session recordings and discovered customers were being forced to log into their accounts before reaching checkout, then getting stuck in what the team called 'the loop of death,' unable to return to the store to finish buying. They fixed the login procedure based on that finding"
  benefit="30% increase in online sales"
  timeframe="Case study published 2024"
  date="2024"
  source="https://www.hotjar.com/customers/wyldsson/"
/>
...
<ResourceList resources={[
  ...
  { title: "CXL: Use Voice-of-Customer Research to Boost Conversions", url: "https://cxl.com/blog/voice-of-customer/", type: "article", free: true, note: "Deep-dive into the full qualitative research stack for conversion optimization" },
