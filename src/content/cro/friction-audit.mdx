...
<InAction
  ...
  companyName="CCV Shop"
  where="CCV Shop's own ecommerce software marketing site, plus the storefronts it hosts for customers"
  why="Analytics showed where visitors dropped off but not why, so the team needed to watch real sessions to find the cause"
  what="Combined Hotjar heatmaps to see aggregate click and scroll behavior with individual session recordings to watch how people actually interacted with each landing page across different browsers and screen resolutions, which surfaced small software bugs they had never noticed"
  benefit="Conversion rate rose 38%, from 1.3% to 1.8%, bringing them close to their 2% target"
  timeframe="Not disclosed in the published case study"
  date="2023"
  source="https://www.hotjar.com/customers/ccv/"
/>
...
<InAction
  ...
  companyName="PayU"
  where="PayU's checkout page, an Indian fintech company processing online payments"
  why="The team wanted to reduce checkout drop-offs but had only quantitative data, no insight into why users were leaving"
  what="Combined heatmaps and session recordings on the checkout page, found that requiring both an email and a phone number was causing friction since many customers lacked an email address, then ran an A/B test removing the email field, a high-impact, low-effort fix"
  benefit="Checkout rate increased 6%"
  timeframe="Not disclosed in the published case study"
  date="2024"
  source="https://vwo.com/success-stories/payu/"
/>
...
<ResourceList resources={[
  ...
  { title: "Nielsen Norman Group - How to Conduct a Heuristic Evaluation", url: "https://www.nngroup.com/articles/how-to-conduct-a-heuristic-evaluation/", type: "article", free: true, note: "Step-by-step audit methodology for systematically finding usability and friction issues" },
  ...
  { title: "Contentsquare - Identifying Frustrated Users Guide", url: "https://contentsquare.com/guides/frustrated-users/", type: "article", free: true, note: "Practical guide to using frustration signals, heatmaps, and session replay to surface friction points" },
