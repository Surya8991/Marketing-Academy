...
<InAction
  concept="AI-powered competitive intelligence"
  companyName="StrongDM"
  where="StrongDM's competitive enablement program, running on Klue's Compete Agent"
  why="Reps were losing head-to-head deals against StrongDM's top competitor because competitive intel lived in scattered docs nobody opened before a call"
  what="Rolled out Klue's AI-driven battlecards and live deal-alert monitoring to the entire sales floor, with new hires trained on it during onboarding"
  benefit="50%+ increase in win rate against their top competitor and a 2.5x increase in average contract value, with 90%+ seller adoption"
...
<InAction
  concept="Win-loss pattern detection"
  companyName="Autodesk"
  where="Autodesk's competitive and win-loss program after moving to Klue"
  why="Win-rate trends against specific competitors were invisible until deal outcomes were tagged and analyzed systematically instead of anecdotally"
  what="Combined Klue's AI-driven competitive intelligence with structured win-loss analysis to see which battlecards and objection responses actually correlated with wins"
  benefit="Double-digit increase in win rate in the segments where Klue was used, sustained since the program's launch"
  timeframe="Since program launch in June 2023"
  date="2023-06"
  source="https://klue.com/case-study/driving-double-digit-increases-to-win-rates"
/>
