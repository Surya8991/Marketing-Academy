...
<InAction
  concept="Signal-based outbound triggered by intent data"
  companyName="Oyster"
  where="Oyster's GTM team, automating account-based outbound in Clay"
  why="Manual list-building meant reps kept prioritizing the same easy-to-find accounts and ignoring less obvious but genuinely in-market ones"
  what="Built automated Clay workflows that pull in accounts showing live intent signals and route them into personalized outbound sequences"
  benefit="4x increase in accounts reached through intent-based outbound, generating $34K in new pipeline from previously untapped accounts"
  timeframe="within the first campaign cycle after rollout"
  date="2025"
  source="https://www.clay.com/use-cases/outbound"
/>
...
<InAction
  concept="Signal-triggered scoring feeding automated outbound routing"
  companyName="Sendoso"
  where="Sendoso's outbound team, layering Clay-automated enrichment and personalization onto its SDR motion"
  why="Reps were spending most of their time on manual list-building and personalization instead of selling"
  what="Automated the enrichment-to-personalization pipeline in Clay so scored, ready-to-send sequences reached reps' queues without manual research"
  benefit="20% higher positive reply rates, 10x outbound productivity, and over $1M in new pipeline generated"
  timeframe="after the Clay-automated workflow replaced manual prospecting"
  date="2025"
  source="https://www.clay.com/use-cases/outbound"
/>
