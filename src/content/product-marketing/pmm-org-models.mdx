export const lessonMeta = {
  ...
  level: "Intermediate",
  summary: "How to structure your product marketing team across three proven org models, with real 2026 data, company examples from Atlassian and Google, and a decision framework for choosing the right fit.",
};
...
- **47.2% of companies are now product-first** (up from 38.5% two years earlier), according to the [Product Marketing Alliance State of Product Marketing 2026](https://www.productmarketingalliance.com/state-of-product-marketing-report-2026/), creating pressure on PMM teams to be closer to the product roadmap.
...
<InAction
  concept="A small centralized team owning brand voice across every channel"
  companyName="Duolingo"
  where="Global social media and brand marketing team"
  why="Needed one consistent, recognizable brand voice across TikTok, Instagram, X, and YouTube as the app scaled internationally, not five different regional voices"
  what="Kept brand and social under one small, centralized team of roughly 51 people with internal approval authority on two-day content cycles, instead of splitting ownership by product line or region"
  benefit="Grew its TikTok following from 50,000 to over 10 million and helped drive monthly active users from 37 million to 116.7 million, alongside a 39% increase in click-through rate"
  timeframe="2020-2024"
  date="2024"
  source="https://www.digitalnative.tech/p/how-duolingo-grew-its-tiktok-to-66m"
/>
...
<InAction
  concept="Mirroring the PMM team's structure to the product team's structure"
  companyName="Intercom"
  where="Product marketing team, embedded by product area"
  why="Wanted PMMs with deep, roadmap-level product context instead of generalist marketers disconnected from what was actually shipping"
  what="Structured each PMM to own a specific part of the product and partner directly with two to three Product Managers in that area, involved from early development through launch and beyond"
  benefit="Positioned as a direct answer to an industry-wide gap the Product Marketing Alliance also documented: only 4% of PMMs believe other teams understand their role"
  timeframe="Ongoing structure, described in 2024"
  date="2024"
  source="https://www.intercom.com/blog/product-marketing-at-intercom/"
/>
