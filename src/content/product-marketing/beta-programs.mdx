...
<InAction
  concept="Referral-gamified waitlist recruitment"
  companyName="Robinhood"
  where="Pre-launch landing page with a gamified referral waitlist"
  why="Wanted a large, primed user base ready to go before its zero-commission investing app cleared full regulatory approval to launch"
  what="Built a referral-based waitlist where sharing a unique link moved a person up the queue for earlier beta access, turning applicants into recruiters"
  benefit="Grew the waitlist to over 1 million signups before public launch, with more than 50,000 signups in the first week alone"
  timeframe="12 months of pre-launch waitlist building"
  date="2013-2015"
  source="https://waitlister.me/growth-hub/case-studies/robinhood"
/>
...
<InAction
  concept="Invite-only scarcity as a community-building mechanic"
  companyName="Clubhouse"
  where="iOS-only, invite-only beta"
  why="Wanted controlled, high-quality growth and built-in social proof before opening the audio-chat app to everyone"
  what="Kept the app invite-only through its beta phase, letting only existing members grant a limited number of invites to new users, so every new member arrived through someone already inside"
  benefit="Grew from roughly 1,500 beta testers to about 10 million users, a fivefold jump in a single month (February 2021) driven almost entirely by the insider-invite mechanic"
  timeframe="Invite-only beta ran May 2020 to July 2021"
  date="2021"
  source="https://waitlister.me/growth-hub/case-studies/club-house"
/>
