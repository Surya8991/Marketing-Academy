...
<InAction
  ...
  where="AI customer service agent packaging and outcome-based pricing rollout"
  why="Traditional customer support platforms sold seat licenses and listed chatbot features like NLP intents, which failed to demonstrate tangible operational ROI to support leaders"
  what="Repositioned Fin AI around business resolution outcomes with a $0.99-per-resolution pricing model, pivoting sales pitches from feature mechanics to automated resolution rates"
  benefit="Achieved an average 76% automated resolution rate across customer deployments and scaled Fin AI to over $100M in ARR by 2025"
  timeframe="2023-2025"
  date="2025"
  source="https://www.intercom.com/blog/fin-ai-agent-milestone/"
/>
...
<InAction
  concept="Market Category"
  companyName="Postman"
  where="Strategic enterprise positioning and point-of-view messaging evolution with April Dunford"
  why="Postman was perceived by buyers as an individual developer Chrome extension for debugging, capping enterprise contract sizes and executive deal sponsorship"
  what="Repositioned the market category from a developer testing tool to the 'API Platform' for the entire API lifecycle, shifting sales conversations to governance, security, and standardization"
  benefit="Scaled from desktop utility to 30M+ developers across 500,000 organizations, used by 98% of the Fortune 500 and reaching a $5.6B valuation"
  timeframe="2020-2024"
  date="2024"
  source="https://www.positioning.show/episodes/positioning-at-postman-with-abhinav-asthana"
/>
