...
<InAction
  concept="Expansion revenue compounding from account-specific usage evidence rather than blanket campaigns"
  companyName="Figma"
  companyId="figma"
  where="Design and collaboration SaaS, enterprise accounts with $10K+ ARR"
  why="Figma needed proof that expansion driven by usage-based seat and tier growth inside existing accounts outperforms new-logo acquisition alone"
  what="Its Q4 FY2025 results showed net dollar retention climbing to 136%, up 5 points quarter over quarter and the highest in ten quarters, driven by seat and tier expansion inside accounts that already trusted the product"
  benefit="136% net dollar retention, the highest in 10 quarters; net-new $100K+ ARR customers up 46% year over year"
  timeframe="Q4 fiscal year 2025, quarter ended January 2026"
  date="2026-02-18"
  source="https://www.sec.gov/Archives/edgar/data/1579878/000162828026009024/fy25pressrelease.htm"
/>
...
<InAction
  concept="Requesting a locked feature as one of the clearest usage-based upgrade triggers"
  companyName="Notion"
  companyId="notion"
  where="All-in-one workspace SaaS, free and Plus-tier teams using AI features"
  why="Notion needed a trigger-based way to convert free and Plus teams into its higher-priced tier without a blanket upgrade blast"
  what="In 2025 Notion folded full AI access, including its autonomous Notion Agent, exclusively into the $20/user/month Business tier, so any team whose workflow depended on AI hit the upgrade prompt at the exact moment they tried to use the locked feature, not on a fixed calendar date"
  benefit="AI-enabled customers grew to over 50% of ARR, up 2x year over year, on Notion's roughly $600M ARR base"
  timeframe="Through late 2025"
  date="2025-11"
  source="https://www.arr.club/notion/notion-ai-growing-3x-year-over-year-powers-60-of-revenue"
/>
