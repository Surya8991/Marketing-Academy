...
<InAction
  concept="Lead with the outcome: hide the AI"
  companyName="Grammarly"
  companyId="grammarly"
  where="Grammarly's core writing assistant product, consumer and enterprise tiers"
  why="Grammarly's buyers are writers and knowledge workers who care whether their writing lands, not which model architecture powers the suggestion, so leading with model detail would work against adoption."
  what="Grammarly built its entire positioning around the outcome of writing with confidence rather than the underlying NLP technology, while quietly expanding the AI's actual capability underneath that consistent outcome-first message."
  benefit="40 million daily active users and adoption at 96% of the Fortune 500, with 50,000+ organizations using Grammarly, reported in the company's 2025 Forbes Cloud 100 announcement"
  timeframe="Reported as of the company's sixth consecutive year on the Forbes Cloud 100 list"
  date="2025"
  source="https://www.grammarly.com/blog/company/forbes-cloud-100-list-2025/"
/>
...
<InAction
  concept="Specific accuracy claims with methodology"
  companyName="GitHub"
  companyId="github"
  where="GitHub Copilot enterprise positioning, developer productivity research"
  why="Developers are the most skeptical AI buyer segment, they'd been burned by overhyped 'AI pair programmer' claims before, so a vague 'makes you faster' promise wasn't going to move enterprise engineering leaders."
  what="Instead of a superlative claim, GitHub ran a controlled study with Accenture where developers completed an identical coding task with and without Copilot, then published the exact sample size, timing, and statistical confidence interval."
  benefit="Developers using Copilot completed the task in 1 hour 11 minutes versus 2 hours 41 minutes without it, a 55% speed gain (n=88 developers, statistically significant at P=.0017, 95% CI of 21%-89%), with 85% reporting more confidence in their code quality"
  timeframe="Controlled study published on GitHub's official research blog"
  date="2024"
