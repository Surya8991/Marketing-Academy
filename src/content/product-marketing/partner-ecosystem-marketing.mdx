...
<InAction
  concept="The Ecosystem Flywheel"
  companyName="HubSpot"
  companyId="hubspot"
  where="HubSpot App Marketplace, technology partner ecosystem"
  why="HubSpot's integration ecosystem needed to prove the flywheel was compounding, not just growing, to justify continued platform investment in partner tooling."
  what="HubSpot tracked and published marketplace growth as a flywheel metric: the App Marketplace crossed 1,000 integrations less than two years after crossing 500, with the average customer installing 7 apps and more than 25% installing over 10."
  benefit="Integrations doubled from 500 to 1,000+ in under 24 months, with 25%+ of customers installing 10 or more apps, evidence that each new integration was compounding adoption rather than just adding a listing"
  timeframe="Milestone reached within roughly 2 years of the 500-app mark"
  date="2022"
  source="https://www.hubspot.com/company-news/hubspots-app-ecosystem-surpasses-1000-integrations-demonstrating-investments-in-platform-growth"
/>
...
<InAction
  concept="Measuring Partner Performance"
  companyName="Salesforce"
  companyId="salesforce"
  where="Salesforce AppExchange and ISV partner ecosystem"
  why="Salesforce needed a way to show the board and prospective ISV partners that the partner ecosystem wasn't just a marketplace listing count, it was a real, measurable revenue driver worth continued investment."
  what="IDC's independently commissioned study measured the total partner ecosystem revenue Salesforce partners generate for every dollar of Salesforce's own revenue, tracking both partner-sourced deals and partner-influenced services and support revenue around the core platform."
  benefit="IDC's study found Salesforce partners generate $6.19 in revenue for every $1 Salesforce earns, evidence used industry-wide as the reference case for why partner-influenced revenue dwarfs direct-sourced revenue alone"
  timeframe="Based on 2022 revenue data, published as part of IDC's ongoing Salesforce Economy research series"
  date="2022"
  source="https://www.salesforce.com/news/stories/idc-salesforce-economy-ai/"
/>
