...
<InAction
  concept="The Four Tiers"
  companyName="Slack"
  companyId="slack"
  where="Global enterprise B2B collaboration market."
  why="Slack needed to break out of single-company internal messaging silos and establish a defensive moat against Microsoft Teams by making external cross-company collaboration a core product tier."
  what="Re-architected and rebranded internal shared channels as a Tier 3 flagship launch called 'Slack Connect' in June 2020, backed by CEO press briefings, customer co-marketing, and a 10-week multi-channel campaign."
  benefit="Reached 520,000+ connected endpoints (+240% YoY) in 4 months and scaled to 74,000+ paid enterprise customers using cross-organization channels within 7 months."
  timeframe="7 months"
  date="2020-06-24"
  source="https://techcrunch.com/2020/06/24/slack-connect-transforms-chat-app-into-a-business-to-business-network/"
/>
...
<InAction
  ...
  where="Indian merchant checkout and UPI payment infrastructure."
  why="E-commerce merchants suffered 15-20% drop-offs from 5-step UPI redirection to third-party apps, but engineering and marketing needed to evaluate if native 1-step checkout justified a Tier 2 campaign versus a routine API update."
  what="Scored all 5 tier questions positively (shifted competitive positioning against rival gateways, opened enterprise GMV deals, created new revenue pricing, and required merchant education) to justify a full Tier 2 multi-channel launch for Turbo UPI in May 2023."
  benefit="Delivered a 5x faster payment experience that boosted merchant transaction success rates by ~10% across enterprise launch partners."
  timeframe="3 months"
  date="2023-05-30"
  source="https://razorpay.com/newsroom/press-releases/razorpay-launches-turbo-upi/"
/>
...
According to Gartner, 80% of launches through 2025 required significant post-launch changes. The teams that recover fastest are the ones who plan for a 30-day, 60-day, and 90-day post-launch motion. Launch day is the start of the campaign, not the end.
...
<ResourceList resources={[
  ...
  { title: "Lenny's Newsletter - How to Successfully Launch on Product Hunt", url: "https://www.lennysnewsletter.com/p/how-to-successfully-launch-on-product", type: "article", free: false, note: "Practical launch playbook from a former Airbnb PM" },
  ...
  { title: "Product School - Product Launch Strategy", url: "https://www.youtube.com/channel/UC6hlQ0x6kPbAGjYkoz53cvA", type: "video", lang: "en", free: true, note: "English product launch walkthroughs from senior practitioners and CPOs" },
