...
<InAction
  ...
  where="Mailchimp's pricing and product team"
  why="Mailchimp priced on subscriber count, but customers with large inactive or duplicate subscriber lists paid more without seeing more value, capping willingness to upgrade."
  what="In May 2019 Mailchimp switched its core value metric from subscriber count to total contacts in the account, restructured into Essentials, Standard, and Premium tiers, and layered in monthly send limits per tier."
  benefit="Revenue reached roughly $800 million in 2020, up about 20% year over year, with half of that revenue coming from non-email services the new packaging made easier to attach"
  timeframe="12 months after the May 2019 repricing"
  date="2019-05"
  source="https://www.getmonetizely.com/blogs/5-in-depth-pricing-transformation-case-studies"
/>
...
<InAction
  concept="Choosing a flexible billing model over a single rigid metric"
  companyName="Splunk"
  where="Splunk's pricing and packaging team"
  why="Splunk's strict per-gigabyte ingestion pricing punished customers for sending more data, so security and IT teams under-ingested logs to control cost, undermining the product's own value proposition."
  what="In September 2019 Splunk replaced flat per-GB pricing with multiple billing options: predictive pricing tiers, infrastructure-based pricing, and unlimited-ingest cloud plans, letting customers pick the model that matched their usage pattern."
  benefit="ARR grew 41% year over year to $2.36 billion by Q4 FY2021, cloud ARR grew 72% YoY, and customers on unlimited-ingest plans ingested 2-3x more data than before"
  timeframe="18 months after the September 2019 pricing overhaul"
  date="2019-09"
  source="https://www.getmonetizely.com/blogs/5-in-depth-pricing-transformation-case-studies"
/>
...
<ResourceList resources={[
  ...
  { title: "How to Use the Van Westendorp Price Sensitivity Meter - SurveyMonkey", url: "https://www.surveymonkey.com/market-research/resources/van-westendorp-price-sensitivity-meter/", type: "docs", free: true, note: "How to run willingness-to-pay research" },
  { title: "The SaaS Pricing Page Playbook: Practices and Real Examples", url: "https://www.webstacks.com/blog/saas-pricing-page-design", type: "article", free: true, note: "Conversion-focused pricing page design patterns from 19 SaaS companies" },
