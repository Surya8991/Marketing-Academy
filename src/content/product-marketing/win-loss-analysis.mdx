...
<InAction
  concept="Closing the loop and distributing findings fast enough for sales to act on them"
  companyName="Riskalyze"
  where="Riskalyze's revenue organization, running an ongoing win-loss program with Clozd"
  why="CMO Craig Clark's team wanted to know whether win-loss findings, distributed to sales and used to close the loop on positioning and process fixes, actually moved the win rate rather than just producing a quarterly report."
  what="Built a continuous program feeding buyer-interview findings back into sales messaging and process changes, then tracked win rate before and after adopting the program."
  benefit="Win rate rose from the 30% range to more than 50%, over a 20-point improvement attributed to the program"
  timeframe="comparing the pre-Clozd period to the post-adoption period"
  date="2024"
  source="https://www.clozd.com/customer-stories"
/>
...
<InAction
  concept="Quantifying themes and acting on direct buyer feedback instead of CRM guesses"
  companyName="AuditBoard"
  where="AuditBoard's product marketing team, running a win-loss program with Clozd"
  why="Their CRM data showed deals were mostly lost to 'no decision,' but not why. A struggling product line needed a specific, evidence-based fix, not another guess."
  what="Ran buyer interviews and surveys, discovered a pattern of unclear value messaging, then spent a year rebuilding ROI-focused sales frameworks, training, and marketing materials around that specific finding."
  benefit="The struggling product line had its best quarter ever, with win rate up more than 5 percentage points"
  timeframe="over roughly a year of program execution"
  date="2024"
  source="https://www.clozd.com/blog/how-auditboard-uses-win-loss-data"
/>
...
<ResourceList resources={[
  { title: "Clozd 2025 State of Win-Loss Analysis Report", url: "https://www.clozd.com/state-of-win-loss", type: "article", free: true, note: "Primary source for win-rate improvement statistics across programs" },
  { title: "Corporate Visions - Buyer Insights and Win-Loss Analysis (TruVoice)", url: "https://corporatevisions.com/growth-programs/targeted-solutions/buyer-insights/", type: "article", free: true, note: "Research on winnable lost deals and impact of buyer feedback on rep performance" },
  { title: "Pragmatic Institute - The Ultimate Guide to Win/Loss Analysis", url: "https://www.pragmaticinstitute.com/product/framework/win-loss-analysis/", type: "article", free: true, note: "Framework for structuring interview programs at scale" },
  { title: "Klue - The Ultimate 7-Step Guide to Win-Loss Analysis", url: "https://klue.com/blog/win-loss-analysis-guide", type: "article", free: true, note: "Source for CRM inaccuracy findings and the Four Stages of Win-Loss Program Maturity" },
  { title: "Competitive Intelligence Alliance - Building a World-Class Win/Loss Program", url: "https://www.competitiveintelligencealliance.io/increase-your-competitive-advantage-by-building-a-world-class-win-loss-program/", type: "article", free: true, note: "Strategic framing of CI including win-loss as a core input" },
