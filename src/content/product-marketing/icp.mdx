...
<InAction
  ...
  where="Developer infrastructure qualification and account tiering across CI/CD environments"
  why="Individual developers were using free manual cross-browser testing tiers, but sales reps lacked a reliable filter to identify high-value enterprise testing pipeline"
  what="Integrated technographic signals detecting automated CI/CD pipelines (Jenkins, GitHub Actions, CircleCI) and enterprise SSO deployments to score accounts ready for enterprise device clouds"
  benefit="Expanded from developer-led freemium trials to enterprise contracts reaching over 90% of the Fortune 500, sustaining net revenue retention above 115%"
  timeframe="2022-2024"
  date="2024"
  source="https://www.browserstack.com/enterprise"
/>
...
<InAction
  ...
  companyName="Slack"
  companyId="slack"
  where="Product-led growth expansion triggers in workspace onboarding and activity monitoring"
  why="Sales and customer success needed an objective threshold to separate casual experimentation teams from high-intent accounts ready for enterprise licensing"
  what="Identified the '2,000 sent messages' behavioral threshold within a team's first 30 days as the primary activation and retention signal for automated sales outreach and expansion packaging"
  benefit="Teams crossing the 2,000-message milestone achieved a 93% conversion and retention rate to paid plans, powering Slack's 5% week-over-week viral expansion"
  timeframe="2014-2019"
  date="2019"
  source="https://slack.com/blog/news/how-slack-grew"
/>
...
<ResourceList resources={[
  { title: "Pipedrive: Craft an Ideal Customer Profile to Identify Your Best Customers", url: "https://www.pipedrive.com/en/blog/ideal-customer-profile", type: "article", free: true, note: "Primary research: 68% higher win rates with defined ICP" },
  { title: "LogRocket: What Is an Ideal Customer Profile (ICP)? Template and Examples", url: "https://blog.logrocket.com/product-management/ideal-customer-profile-template-examples/", type: "article", free: true, note: "Discovery process and ICP template for B2B and B2C" },
  ...
  { title: "HubSpot: Customer Profiling in 10 Easy Steps", url: "https://blog.hubspot.com/service/customer-profiling", type: "article", free: true },
  { title: "Lenny's Newsletter: How to Identify Your Ideal Customer Profile (ICP)", url: "https://www.lennysnewsletter.com/p/how-to-identify-your-ideal-customer", type: "article", free: false, note: "Interviews with Gusto, Gong, Snyk, and Databricks founders" },
  { title: "PostHog: Defining Our ICP Is the Most Important Thing We Ever Did", url: "https://posthog.com/newsletter/ideal-customer-profile-framework", type: "article", free: true },
  ...
  { title: "BlueConic: Creating an Ideal Customer Profile for Marketing", url: "https://www.blueconic.com/resources/ideal-customer-profile", type: "article", free: true, note: "How unified customer data enables accurate ICP orchestration" },
