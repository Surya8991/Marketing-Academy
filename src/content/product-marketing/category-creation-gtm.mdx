...
<InAction
  concept="Naming and Positioning the Space"
  companyName="Drift"
  companyId="drift"
  where="Drift's decade of positioning against the traditional lead-capture form"
  why="Wanted to stand out in a crowded marketing software space by naming a new method, not just another chat feature"
  what="Combined 'Conversational' and 'Marketing' into a category name that described both the method and the goal, then built books, podcasts, and certifications around it for years"
  benefit="The category authority Drift built culminated in its acquisition by Salesloft for a reported $500 million"
  timeframe="Category built from 2015 launch through the 2024 acquisition"
  date="2024-02-13"
  source="https://martech.org/drift-acquired-by-sales-engagement-platform-salesloft/"
/>
...
<InAction
  concept="Case Study: HubSpot's Customer Platform Expansion"
  companyName="HubSpot"
  where="HubSpot's repositioning from Inbound Marketing platform to Customer Platform"
  why="Needed a new frame to compete against fragmented enterprise CRMs and to keep growing beyond its original inbound-marketing category"
  what="Educated the market on the cost of disconnected marketing, sales, and service data, then positioned its unified database as the Customer Platform category"
  benefit="Full-year 2024 revenue grew 21% year-over-year as the repositioning took hold"
  timeframe="Fiscal year 2024"
  date="2024-02-12"
  source="https://www.sec.gov/Archives/edgar/data/1404655/000095017024015231/hubs-ex99_1.htm"
/>
