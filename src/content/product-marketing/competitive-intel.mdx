...
<InAction
  concept="Structured Competitive Intelligence Collection"
  companyName="Salsify"
  where="Salsify's competitive intelligence program, before and after building a structured collection system with Crayon"
  why="competitive analysis had been spread across team members with no dedicated home, producing one-off 'strike teams' that scrambled only after a deal was already lost"
  what="the CI team, led by Nathan Teplow, built continuous competitor tracking, organized intel collection and curation through Slack integration, and a field-intelligence feedback loop from reps instead of ad hoc research"
  benefit="competitive win rates rose 22% in the first year, with 78% of all competitive revenue traced back to the battlecard program the new collection system fed"
  timeframe="first year"
  date="2023"
  source="https://www.crayon.co/case-studies-list/salsify"
/>
...
<InAction
  concept="Sales Activation via Battlecards"
  companyName="Cognism"
  where="Cognism's sales team, after building a competitive-content program on Crayon"
  why="reps needed real-time competitive answers inside live deals rather than searching outdated documents scattered across shared drives"
  what="the CI team routed continuously updated battlecards on named competitors directly into the tools reps already used during calls, replacing a static, rarely-updated deck"
  benefit="the program influenced 33 deals a month on average and tracked more than $6 million in influenced revenue in less than a year"
  timeframe="under 1 year"
  date="2023"
  source="https://www.crayon.co/case-studies-list/cognism"
/>
