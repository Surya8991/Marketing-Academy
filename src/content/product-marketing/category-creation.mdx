...
<InAction
  concept="Crafting a Public Point of View"
  companyName="Drift"
  where="Drift published its category manifesto as a freely distributed book instead of a gated whitepaper"
  why="The founders wanted to be recognized as the originators of 'conversational marketing,' not just a vendor selling chat software"
  what="In 2019, co-founders David Cancel and Dave Gerhardt published 'Conversational Marketing,' laying out the point of view that chat, not lead-capture forms, was the future of B2B buying"
  benefit="Drift's customers generated $5 billion in sales pipeline value in 2021 alone, as the category vocabulary Drift had published two years earlier scaled across the market"
  timeframe="2019 to 2021"
  date="2021"
  source="https://www.prnewswire.com/news-releases/drift-announces-strategic-investment-from-vista-equity-partners-partnership-will-help-customers-accelerate-revenue-via-b2b-conversational-commerce-301367330.html"
/>
...
<InAction
  concept="Mobilizing the Ecosystem Through Analyst Placement"
  companyName="Gong"
  where="Gong briefed Gartner analysts on its self-defined category so the firm would rate the space Gong invented, not wait for a competitor to define it first"
  why="Third-party analyst validation turns a vendor's own category claim into a market category buyers and procurement teams treat as real"
  what="Gong was named a Leader in Gartner's 2025 Magic Quadrant for Revenue Action Orchestration, ranking highest on the Ability to Execute axis among 12 evaluated vendors"
  benefit="Gong's ARR surpassed $500 million with growth accelerating past 55% year-over-year, its tenth consecutive quarter of accelerating growth"
  timeframe="2025"
  date="2025"
  source="https://www.gong.io/press/gong-named-a-leader-in-2025-gartner-magic-quadrant-for-revenue-action-orchestration"
/>
