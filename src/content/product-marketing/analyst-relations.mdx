...
<InAction
  concept="Analyst evaluations directly gating which vendors get considered"
  companyName="Gong"
  where="Gong's revenue intelligence platform, evaluated in the 2025 Gartner Magic Quadrant for Revenue Action Orchestration"
  why="Enterprise buyers use Magic Quadrant placement to build vendor shortlists before running their own evaluations, so where a vendor lands directly affects which deals it even gets invited into."
  what="Gong was named one of only three Leaders among 12 evaluated vendors, ranking highest on Ability to Execute and placing furthest on Completeness of Vision, with the top score across all four evaluated use cases."
  benefit="Ranked as a Leader in all four evaluated use case categories, one of just 3 of 12 vendors named a Leader overall"
  timeframe="2025 evaluation cycle"
  date="2025"
...
<InAction
  concept="Submitting for a formal analyst evaluation once the relationship and eligibility case are built"
  companyName="Intentsify"
  where="Intentsify, a B2B intent-data vendor competing against well-funded incumbents"
  why="A crowded intent-data category made third-party validation the fastest way to prove differentiation to enterprise buyers who default to trusting Forrester's own scoring."
  what="Submitted for and was named a Leader in The Forrester Wave: Intent Data Providers For B2B, Q1 2025, evaluated across 21 categories against 15 total providers."
  benefit="Received the highest possible score in 12 of the 21 evaluated categories, the highest overall Current Offering score of any vendor in the report"
  timeframe="Q1 2025 Forrester Wave evaluation cycle"
  date="2025"
  source="https://www.businesswire.com/news/home/20250227840137/en/Intentsify-Named-a-Leader-in-B2B-Intent-Data-Analyst-Report"
/>
...
<ResourceList resources={[
  ...
  { title: "How to Build Analyst Relationships", url: "https://www.pragmaticinstitute.com/resources/articles/product/how-to-build-analyst-relationships/", type: "article", free: true, note: "Pragmatic Institute guide to AR fundamentals" },
  { title: "Tips for Crushing Your Analyst Briefings", url: "https://www.forrester.com/blogs/my-tips-for-crushing-your-analyst-briefings-and-wowing-the-analyst/", type: "article", free: true, note: "Forrester blog covering AR best practices" },
