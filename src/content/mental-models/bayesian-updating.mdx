...
<InAction
  concept="Weighing evidence strength before updating a belief, not shipping on intuition alone"
  companyName="Booking.com"
  where="Booking.com's global product experimentation program"
  why="With page and checkout changes proposed by everyone up to the CEO, Booking needed a rule that stopped strongly-held opinions from shipping without evidence"
  what="Booking.com requires every product change, including a CEO-championed logo and homepage redesign, to win a live A/B test before it ships, running roughly 1,000 concurrent experiments across 75 countries and 43 languages"
  benefit="About 9 of every 10 tested ideas fail to beat the existing page, so even the CEO's own redesign got rejected instead of shipped on confidence alone"
  timeframe="Ongoing experimentation program, scaled through the 2010s-2020s"
  date="2023"
  source="https://vwo.com/blog/cro-best-practices-booking/"
/>
...
<InAction
  concept="Strong evidence against a weak prior demands a big update"
  companyName="Microsoft Bing"
  where="Bing search ads, headline display format"
  why="A Microsoft employee proposed combining the ad's second text line into the headline; program managers judged it low priority on intuition alone and shelved it for over six months"
  what="An engineer eventually ran a cheap, quick A/B test on the shelved idea instead of trusting the team's dismissive prior"
  benefit="The test showed a 12% revenue increase, worth more than $100 million a year in the US alone, without hurting user-experience metrics, becoming the most valuable experiment in Bing's history"
  timeframe="Idea shelved roughly 6 months before an engineer tested it"
  date="2013"
