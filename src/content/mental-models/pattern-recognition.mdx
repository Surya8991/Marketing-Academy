...
<InAction
  concept="Behavioral Pattern Recognition"
  companyName="Netflix"
  where="Its recommendation and personalization system, including per-title artwork selection"
  why="Netflix's data scientists noticed a repeatable behavioral pattern: which thumbnail image a member responds to correlates with what they've watched before, not with the 'best' single piece of artwork for a title."
  what="Netflix built its recommender system to detect and act on that behavioral pattern at scale, personalizing artwork and rankings per member instead of running one static homepage for everyone."
  benefit="Netflix's own published research states the combined effect of personalization and recommendations saves the company more than $1 billion per year in retained subscriptions, with over 75% of what members watch coming from a recommendation."
  timeframe="Ongoing since the system's rollout, documented through 2015"
  date="2015"
  source="https://dl.acm.org/doi/10.1145/2843948"
/>
...
<InAction
  ...
  companyName="Notion"
  where="Its template gallery and community ambassador program, launched two years after the product itself"
  why="Notion's team recognized a structural pattern already working for other tools in its category: letting power users build and share their own templates compounds distribution in a way paid ads don't."
  what="Notion built a public template gallery and an ambassador program for community creators instead of scaling a traditional paid-acquisition team."
  benefit="The ambassador program drew 600+ applications in its first week, and community became Notion's largest acquisition channel on the way to 100 million users with the vast majority of that growth unpaid."
  timeframe="2019 template gallery launch through 2024's 100M-user milestone"
  date="2024"
  source="https://www.decibel.vc/articles/community-led-growth-how-notion-grew-a-global-community-of-advocates-and-influencers"
/>
