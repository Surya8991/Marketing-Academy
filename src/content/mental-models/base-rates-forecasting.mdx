...
<ResourceList resources={[
  ...
  { title: "Base Rate Fallacy Explained (Farnam Street)", url: "https://fs.blog/base-rate-fallacy/", type: "article", free: true, note: "Short primer with marketing-relevant examples" },
