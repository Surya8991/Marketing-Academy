...
<InAction
  ...
  where="Bing Experimentation Platform and digital feature rollouts"
  why="Calibrating team expectations on campaign and feature win rates against empirical historical baselines"
  what="Analyzed outcomes across tens of thousands of controlled experiments to establish the objective outside-view baseline for growth hypotheses"
  benefit="Established an empirical 10%–20% feature win rate base rate, preventing overconfident budget allocation on untested intuition"
  timeframe="2015 – 2020"
  date="2020"
  source="https://exp-platform.com/trustworthy-online-controlled-experiments/"
/>
...
<InAction
  ...
  where="Strategic enterprise planning and new business launch forecasting"
  why="Eliminating executive optimism bias in multi-million dollar product and campaign projections"
  what="Implemented Kahneman & Lovallo's 4-step reference-class forecasting model by identifying comparable past initiative classes, computing base-rate distributions, and constraining upward adjustments"
  benefit="30% to 50% reduction in forecasting error and budget overruns compared to traditional bottom-up inside-view models"
  timeframe="2003"
  date="2003"
  source="https://hbr.org/2003/07/delusions-of-success-how-optimism-undermines-executives-decisions"
/>
