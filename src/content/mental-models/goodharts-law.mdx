...
<ResourceList resources={[
  ...
  { title: "The Metric Society: On the Quantification of the Social (Steffen Mau)", url: "https://www.goodreads.com/book/show/44890301-the-metric-society", type: "article", free: false, note: "A broader treatment of what happens when we measure everything" },
  { title: "Amazon's Weekly Business Review Process (Colin Bryar)", url: "https://commoncog.com/blogs/working-backwards-jeff-bezos.html", type: "article", free: true, note: "How diagnostic vs. target metrics work in practice" },
