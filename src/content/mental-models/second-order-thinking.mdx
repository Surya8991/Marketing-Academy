...
<InAction
  ...
  companyName="Netflix"
  where="Global subscription video-on-demand monetization"
  why="Monetizing an estimated 100M non-paying password borrowers without triggering mass subscriber churn"
  what="Rolled out paid sharing globally in May 2023, asking whether the first-order churn fear would be outweighed by second-order conversion of unmonetized viewers into standalone subscribers or extra-member add-ons"
  benefit="22 million net new subscribers gained in 2023 (including 13.1M in Q4) and $33.7B annual revenue (+6.7% YoY) with record low churn"
  timeframe="May 2023 – Dec 2023"
  date="2023"
  source="https://time.com/6564619/netflix-subscribers-password-sharing/"
/>
...
<InAction
  ...
  companyName="Uber"
  where="Global mobile app user acquisition and attribution tracking"
  why="Evaluating whether $150M in annual digital ad spend was driving incremental rider growth or merely paying for organic app installs"
  what="Ran systematic blackouts across ad networks, asking 'and then what happens to organic downloads?' instead of accepting dashboard click-attribution reports"
  benefit="$100 million in annual ad spend cut (two-thirds of mobile budget) with zero decline in rider acquisition or app installs"
  timeframe="2017"
  date="2017"
  source="https://thehustle.co/01072021-uber-ad-fraud"
/>
