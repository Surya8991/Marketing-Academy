...
<InAction
  concept="The Pareto Principle"
  companyName="HubSpot"
  where="HubSpot's own company blog, roughly 6,000 published posts"
  why="Most blogs treat every post as equally worth maintaining; HubSpot's own attribution data showed lead generation was wildly concentrated, so refreshing the tiny high-performing slice was far higher-leverage than publishing more new posts."
  what="HubSpot's marketing analyst pulled Attribution Reports and found monthly leads were concentrated in a small share of old posts, then built a historical-optimization program to update and republish just that slice."
  benefit="46% of monthly blog leads came from just 30 individual posts out of roughly 6,000; optimizing that small share more than doubled the monthly leads those posts generated and lifted their organic views by an average of 106%"
  timeframe="ongoing program, findings first published 2015, updated 2025"
  date="2025"
...
<InAction
  ...
  companyName="Airbnb"
  where="Airbnb's New York City listings, 2009"
  why="The founders were pouring effort into acquisition tactics while bookings stayed flat; Paul Graham pushed them to look at why visitors weren't converting instead of how to get more of them, which surfaced the real constraint."
  what="Founders flew to New York, rented a camera, and personally re-shot listing photos door to door, replacing hosts' amateur photos with professional ones, because the bottleneck was trust in the listing, not top-of-funnel traffic."
  benefit="Airbnb's monthly revenue in New York City doubled within about a month of replacing the photos, without any increase in traffic or ad spend"
  timeframe="approximately one month, 2009"
  date="2009"
  source="https://www.snappr.com/blog/photography-that-launched-an-empire-how-airbnb-transformed-their-business-with-professional-photography"
/>
