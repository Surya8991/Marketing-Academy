...
<InAction
  concept="Traditional SEO rank explains very little of AI citation behavior"
  companyName="HubSpot"
  where="Global, organic search traffic, late 2024 through early 2025"
  why="A Google algorithm update in December 2024 that prioritized user-generated and forum content over traditional blog content hit HubSpot's blog-heavy SEO strategy directly."
  what="HubSpot's monthly organic search traffic fell from roughly 13.5 million visits in November 2024 to 8.6 million in December, and to an estimated 6 to 7 million by early 2025, even as its brand mentions and presence in AI assistant answers stayed strong."
  benefit="A traffic collapse of roughly 70 to 75% in traditional search rank did not erase HubSpot's AI-assistant visibility, direct evidence that Google ranking and AI citation are measured by different signals and can move in opposite directions."
  timeframe="Nov 2024 to early 2025"
  date="2025"
  source="https://athenahq.ai/blog/hubspot-lost-70-of-its-seo-trafficbut-that-doesnt-mean-its-losing"
/>
...
<InAction
  concept="Own distinctive language AI associates with you"
  companyName="HubSpot"
  where="Global, B2B marketing software category, 2005 onward"
  why="HubSpot needed a way to differentiate a young marketing platform from established competitors without an established brand or category to slot into."
  what="Co-founder Brian Halligan coined the term 'inbound marketing' in 2005 to name the company's content-and-search-led approach, then used the exact term consistently across a book, a named annual conference (INBOUND), and years of content, rather than describing the approach differently each time."
  benefit="HubSpot became the brand synonymous with the category it named, growing into a company valued at over $20 billion, with 'inbound marketing' still the term third parties reach for when describing the approach it pioneered."
  timeframe="2005 to present"
  date="2022"
  source="https://growthhackers.com/growth-studies/hubspot/"
/>
...
<ResourceList resources={[
  ...
  { title: "Audacious: How Humans Win in an AI Marketing World - Mark Schaefer", url: "https://businessesgrow.com/publication/audacious/", type: "article", free: false, note: "Book on out-humaning AI in brand and marketing strategy" },
