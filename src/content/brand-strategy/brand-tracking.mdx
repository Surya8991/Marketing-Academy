...
<InAction
  ...
  companyName="Edgard & Cooper"
  where="European premium pet food brand tracking brand health across seven markets"
  why="Wanted a cadence fast enough to catch perception shifts within a single quarter instead of waiting on annual studies."
  what="Ran a continuous brand tracking program on Dynata's panel, fielding new waves in as little as two business days and accumulating over 80,000 survey responses across seven markets by 2025."
  benefit="The rapid-cadence data directly informed a packaging and positioning refresh that went on to win a Pentawards Silver, a global design award."
  timeframe="Through 2025"
  date="2025"
  source="https://www.dynata.com/why-dynata/resources/blog/brand-health-tracking-the-competitive-edge-in-2025/"
/>
...
<InAction
  concept="Connecting brand metrics to business outcomes"
  companyName="Walmart"
  where="US retail category, tracked via YouGov BrandIndex"
  why="Wanted daily, continuous visibility into whether brand investment was shifting real consumer consideration, not just impressions."
  what="YouGov BrandIndex tracked Walmart's consideration score daily across 16 brand health metrics in 55+ markets, giving leadership week-over-week movement data instead of a quarterly snapshot."
  benefit="Walmart's consideration score reached 60.8 in 2024, the highest of any retailer YouGov tracked, meaning more than 6 in 10 US shoppers would actively consider buying there."
  timeframe="2024"
  date="2024"
  source="https://business.yougov.com/product/brandindex"
/>
