...
<InAction
  concept="Trademark clearance before you fall in love with a name"
  companyName="Meta Platforms"
  where="Facebook's October 2021 corporate rebrand to Meta"
  why="A South Dakota company, Meta Financial Group, already held registered trademarks on 'Meta' and 'MetaBank' for financial services, a direct clearance conflict with the new corporate name."
  what="Rather than risk litigation or a forced re-rebrand, Meta Platforms bought the trademark, trade name, and domain assets from Meta Financial Group outright through a shell entity, Beige Key LLC, giving Meta Financial one year to strip 'Meta' from its own branding."
  benefit="$60 million paid to clear a single name for use, on top of the rebrand's own production costs, illustrating this lesson's point that a clearance opinion costing $500-$2,000 is cheap insurance against a conflict that can cost eight figures to resolve after the fact"
  timeframe="Deal closed December 2021, one month after the Meta name launched publicly"
  date="2021-12-13"
  source="https://www.forbes.com/sites/dereksaul/2021/12/13/facebook-owner-pays-60-million-for-meta-name-rights/"
/>
...
<InAction
  concept="The scale test, does the name survive when the product outgrows its first idea"
  companyName="Airbnb"
  where="Rebrand from AirBed&Breakfast to Airbnb, March 2009"
  why="The founders' original name, Airbedandbreakfast.com, described the literal air-mattress-plus-breakfast service they launched in 2007, but it was hard to say, hard to spell, and implied the platform required an actual air mattress as the product expanded to full apartments and spare rooms."
  what="Brian Chesky and Joe Gebbia shortened the name to Airbnb, a compressed, still-legible form that dropped the literal air-mattress meaning while keeping the recognizable root, and paired it with a simpler, more brandable domain."
  benefit="The rename shipped the same month the platform crossed 10,000 users, removing a name that would have actively misdescribed the business within a year as it scaled into a hosting marketplace with no air mattress requirement at all"
  timeframe="March 2009"
  date="2009-03"
  source="https://www.airroi.com/resources/tips-guides/why-is-it-called-airbnb"
/>
