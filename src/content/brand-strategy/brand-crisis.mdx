...
<InAction
  concept="Assign one spokesperson per crisis"
  companyName="Johnson & Johnson"
  where="United States, 1982 Tylenol cyanide poisonings"
  why="Seven people died after cyanide-laced Tylenol capsules reached store shelves, an existential threat to the brand's 35% share of the US over-the-counter pain reliever market."
  what="CEO James Burke personally became the single voice of the company, proactively briefing television network heads directly instead of routing through lawyers or issuing 'no comment,' while J&J recalled 31 million bottles nationwide."
  benefit="Tylenol had recovered 70% of its lost market share within five months of the crisis, a recovery widely credited to consistent, single-source, transparent communication instead of a defensive multi-voice response."
  timeframe="5 months"
  date="1982"
  source="https://mallenbaker.net/article/clear-reflection/johnson-johnson-and-tylenol-crisis-management-case-study/"
/>
...
<InAction
  concept="Recovery requires tangible, concrete action, not just an apology"
  companyName="KFC"
  where="United Kingdom, 2018 chicken supply-chain shortage"
  why="A new delivery partner's logistics failure forced KFC to close roughly 750 of 900 UK restaurants for days, with no chicken to serve."
  what="KFC ran a full-page apology ad rearranging its own bucket logo to spell 'FCK,' paired with a plain-English explanation and a public switch of delivery partners, sustained with ongoing brand messaging rather than a single statement."
  benefit="KFC's YouGov brand impression score, which had dropped from -2 to -12 during the crisis, recovered to -1, and positive brand attention rose to 29% from a pre-crisis 7%, with the campaign reaching roughly 1 billion people across press and social within three months."
  timeframe="3 months"
  date="2018"
  source="https://www.aboutresilience.com/humor-and-humility-saved-the-chicken-the-kfc-logistics-blunder/"
/>
