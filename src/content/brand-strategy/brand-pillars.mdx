...
<InAction
  ...
  where="US retail and direct-to-consumer, Black Friday 2011"
  why="Patagonia's environmental-responsibility pillar was tested against the single highest-pressure moment in retail: the year's biggest shopping day. A weaker pillar would have been quietly dropped for the occasion."
  what="Ran a full-page ad in the New York Times' 2011 Black Friday edition headlined 'Don't Buy This Jacket,' explicitly telling customers to buy less and repair more, detailing the jacket's real environmental cost."
  benefit="Revenue grew 30% to $543 million in 2012, the year following the campaign, as customers who shared the pillar trusted the brand more after seeing it upheld at a direct cost to short-term sales."
  timeframe="12 months post-campaign"
  date="2011"
  source="https://thebrandhopper.com/case-studies/a-case-study-on-patagonias-dont-buy-this-jacket-campaign/"
/>
...
<InAction
  concept="Embed pillars everywhere"
  companyName="Nike"
  where="Global, corporate strategy and marketing spend allocation"
  why="After years of over-indexing on digital-only direct-to-consumer sales at the expense of brand-building, Nike's performance and community pillars had drifted out of the day-to-day spend decisions that were supposed to embed them."
  what="Publicly redirected marketing spend back toward brand building with sports as the core North Star, extending long-term partnerships with the NBA, WNBA, and NFL, and citing the return to brand fundamentals on its Q2 2025 earnings call."
  benefit="Nike explicitly named the re-anchoring to brand-building fundamentals, rather than short-term performance-marketing efficiency, as its recovery strategy in its Q2 2025 earnings report."
  timeframe="FY2025 Q2 earnings cycle"
  date="2025"
  source="https://www.marketingdive.com/news/nike-Q2-2025-earnings-report-performance-marketing-brand-building/736146/"
/>
