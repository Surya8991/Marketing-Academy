...
<InAction
  concept="Signals feed a price prediction engine, at scale"
  companyName="Amazon"
  where="Amazon's retail pricing engine"
  why="At Amazon's catalog size, no team could manually reprice fast enough to match competitor moves and shifting demand, so the repricing decision was handed to an automated model."
  what="Amazon's pricing algorithm continuously tracks competitor prices and demand signals across its catalog, repricing products roughly 2.5 million times a day as conditions change."
  benefit="Industry trackers estimate the automated repricing program has boosted Amazon's revenue by around 25% compared to static, manually-set pricing."
  timeframe="Ongoing program, most recently measured 2025"
  date="2025"
  source="https://www.nimbleway.com/blog/amazon-dynamic-pricing"
/>
...
<InAction
  concept="Backlash risk when dynamic pricing surprises the buyer"
  companyName="Ticketmaster"
  where="Ticketmaster's August 2024 on-sale for Oasis's reunion tour in the UK"
  why="Ticketmaster used a tiered 'dynamic pricing' system during the on-sale, so ticket prices rose as demand spiked while fans were still waiting in the queue."
  what="Fans who expected to pay roughly £150 for standing tickets found prices had jumped to as much as £350 by checkout, with no advance warning that a tiered pricing system was active."
  benefit="The backlash triggered investigations by the UK Competition and Markets Authority and Ireland's Competition and Consumer Protection Commission; the CMA's resulting ruling now requires Ticketmaster to disclose tiered pricing to fans 24 hours before an on-sale begins."
  timeframe="On-sale August 2024, CMA disclosure ruling followed"
  date="2024-08"
  source="https://www.ticketnews.com/2024/09/consumer-watchdog-urges-oasis-ticketmaster-refund-dynamic-ticket-prices/"
/>
