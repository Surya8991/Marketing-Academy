export const lessonMeta = {
  ...
  relatedConcepts: ["internal-gpt-knowledge-bases", "ai-search-ranking", "llm-fine-tuning-brand-voice", "prompt-engineering-marketers"],
};
...
- The global RAG market was valued at roughly $1.94 billion in 2025 ([MarketsandMarkets, 2025](https://www.marketsandmarkets.com/PressReleases/retrieval-augmented-generation-rag.asp)), and a separate analysis puts the 2026 figure at $3.33 billion on the way to $81.51 billion by 2035 at a 42.7% CAGR ([Next Move Strategy Consulting, 2026](https://www.nextmsc.com/report/retrieval-augmented-generation-rag-market-ic3918)).
...
<InAction
  concept="Grounding retrieval in real documents reduces hallucination"
  companyName="Uber"
  where="Uber's internal engineering on-call support copilot, Genie, deployed across Slack"
  why="Genie's early RAG-based answers to security and privacy policy questions were often incomplete or subtly wrong, the exact confident-but-mistaken failure mode this lesson warns about"
  what="Uber's team rebuilt the retrieval layer into an enhanced agentic RAG architecture, adding a query-optimizer agent and a source-identifier agent, plus better document processing (structured table extraction, metadata tagging) before the model generated an answer"
  benefit="A 27% relative increase in answers rated acceptable and a 60% relative reduction in incorrect advice, compared to the prior standard RAG setup"
  timeframe="Reported in Uber's engineering blog"
  date="2025-05-29"
  source="https://www.uber.com/en-CA/blog/enhanced-agentic-rag/"
/>
...
- **70% of companies using generative AI** now augment base models with retrieval systems and vector databases rather than relying on off-the-shelf LLMs alone, per [2026 enterprise adoption data](https://coderslab.io/blog/47-ai-adoption-statistics-that-define-enterprise-technology-in-2026/).
...
<InAction
  concept="Document hygiene and quality controls preventing compliance failures"
  companyName="DoorDash"
  where="DoorDash's Dasher support automation system"
  why="Dashers need accurate, compliant answers about delivery issues in the middle of an active order, where a wrong or non-compliant answer creates real operational and legal risk, not just an annoyed reader"
  what="DoorDash paired a RAG pipeline, grounded in support knowledge-base articles and resolved historical cases, with an LLM Guardrail for real-time response validation and an LLM Judge for ongoing quality monitoring"
  benefit="A 90% reduction in hallucinated responses and a 99% reduction in compliance issues compared to the prior flow-based automation, while serving thousands of Dashers daily"
  timeframe="Documented in DoorDash's engineering blog on LLM-based Dasher support automation"
  date="2024"
  source="https://careersatdoordash.com/blog/large-language-modules-based-dasher-support-automation/"
/>
...
<ResourceList resources={[
  { title: "What Is Retrieval-Augmented Generation (RAG)? - AWS", url: "https://aws.amazon.com/what-is/retrieval-augmented-generation/", type: "article", free: true },
