...
<InAction
  ...
  companyName="Klarna"
  where="Global marketing operations across 30+ regional campaign rollouts"
  why="External agencies took 6 weeks to deliver localized campaign images and copy, inflating operational overhead"
  what="Deployed autonomous generative AI image and copy agents connected to brand voice guidelines and creative assets, running an internal Copy Assistant and Midjourney/Firefly pipeline"
  benefit="Shortened the creative development cycle from 6 weeks to 7 days, generated 1,000+ campaign images in Q1 2024, and cut external agency spend by 25% ($4M annualized savings)"
  timeframe="Q1 2024"
  date="2024"
  source="https://www.marketingdive.com/news/klarna-ai-marketing-campaigns-cut-costs-agencies-q1-2024/717462/"
/>
...
<InAction
  ...
  companyName="Siemens"
  where="Global corporate communications and multi-channel content operations across dozens of business units"
  why="Communications teams faced rising demand for platform-specific, localized social content without compromising strict enterprise brand safety and messaging compliance"
  what="Built the internal NEO.CM platform hosting over 300 governed, role-specific AI bots (including Social Media Copy Assistants and Analytics Assistants) grounded in centralized performance data with mandatory human review workflows"
  benefit="Scaled localized, multi-platform social media and technical storytelling across hundreds of business units while maintaining 100% brand voice consistency and zero compliance breaches"
  timeframe="2024-2025"
  date="2024"
  source="https://instituteforpr.org/how-siemens-uses-generative-ai-in-communications-and-public-relations/"
/>
