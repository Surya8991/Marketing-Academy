...
<InAction
  concept="AI-Assisted Content Ideation and Drafting"
  companyName="Instacart"
  companyId="instacart"
  where="Instacart's advertiser-facing Ads Manager, AI-Powered Landing Pages feature"
  why="CPG advertisers needed shoppable landing pages and product copy at a volume too high for a manual design and copy team to produce per SKU"
  what="Instacart's AI automatically generates the product showcase and custom landing-page copy for every CPG advertiser; early adopter Celsius used it instead of manually briefing copy for each campaign"
  benefit="Celsius saw a 20% increase in campaign-attributed sales using the AI-generated landing pages, one of the first quantified results from the March 2025 rollout"
  timeframe="Rolled out March 2025, results reported within the same launch cycle"
  date="2025-03"
  source="https://www.instacart.com/company/pressreleases/ai-powered-universal-campaigns-for-advertisers"
/>
...
<InAction
  concept="AI-Assisted Workflow Automation and Reporting"
  companyName="Snowflake"
  companyId="snowflake"
  where="Snowflake's internal roughly 600-person marketing organization, using Snowflake's own AI tooling including an internal agent called CoCo"
  why="A competitive-intelligence manager's candidate research and deck-building process was taking three hours plus a full week per cycle, too slow to keep pace with weekly reporting needs"
  what="The team automated candidate identification and deck creation with AI, and separately deployed an inbound automation engine that handles thousands of daily email replies without human intervention"
  benefit="The competitive-intelligence workflow became about 90% automated, and 92% of surveyed marketers said AI enabled work that would otherwise have been delayed or impossible"
  timeframe="AI adoption scaled through 2025 into a June 2026 internal survey"
  date="2026-06"
