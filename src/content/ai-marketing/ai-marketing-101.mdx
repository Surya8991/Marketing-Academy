export const lessonMeta = {
  ...
  level: "Beginner",
  summary: "What AI can and cannot do for marketers in 2026, real stats, real examples, no hype.",
};
...
<InAction
  concept="AI Customer Service Automation & Efficiency Scaling"
  companyName="Klarna"
  where="Global customer service infrastructure powering 2.3 million chat conversations across 45+ markets"
  why="Klarna needed to scale customer service resolution speed and reduce operating expenses without degrading customer satisfaction scores"
  what="Deployed an OpenAI-powered customer service assistant handling routine errands, refunds, cancellations, and disputes in 35 languages"
  benefit="Reduced average resolution time from 11 minutes to under 2 minutes, handled 67% of total chat volume, and generated $40M in annualized profit improvement"
  timeframe="First month of deployment"
  date="2024"
...
- [87% of marketers use generative AI in at least one recurring workflow as of Q1 2026](https://www.digitalapplied.com/blog/ai-marketing-statistics-2026-adoption-data-points), up from 51% in 2024, the fastest sustained adoption of any major marketing technology on record (Salesforce State of Marketing 2026).
- Marketers recover an average of 6.1 hours per week with AI; senior practitioners save 8 to 10 hours (HubSpot AI Trends 2026).
- AI content drafting delivers the highest ROI of any application at 3.2x, followed by personalization engines at 2.7x (McKinsey Global AI Survey 2026).
...
- 34% of enterprise marketing teams now run autonomous AI agents in production, up from 14% in late 2025.
...
<InAction
  concept="AI Copy Testing & Emotional Language Optimization"
  companyName="Vanguard"
  where="Institutional division's LinkedIn advertising campaigns targeting retirement plan sponsors"
  why="Vanguard needed to improve low engagement on LinkedIn ads while adhering to strict financial services compliance and brand tone constraints"
  what="Used Persado's Motivation AI platform to generate and test hundreds of compliant ad copy permutations with varied emotional drivers"
  benefit="Achieved a 15.76% lift in conversion rates while maintaining 100% regulatory compliance on institutional social ads"
  timeframe="Campaign testing cycle"
  date="2024"
  source="https://www.persado.com/case-studies/vanguard/"
/>
...
<ResourceList resources={[
  ...
  { title: "State of AI in Marketing Report (CoSchedule)", url: "https://coschedule.com/ai-marketing-statistics", type: "article", free: true },
