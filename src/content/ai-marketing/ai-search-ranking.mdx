export const lessonMeta = {
  ...
  relatedConcepts: ["ai-seo", "rag-for-marketers", "prompt-engineering-marketers"],
};
...
<InAction
  concept="AI recommendations driving real, measurable site visits"
  companyName="Sephora"
  where="Similarweb's cross-industry clickstream study of Finance, Travel, and Beauty brand pairs"
  why="Marketers could see AI citations happening but had no proof they translated into actual visits rather than just a mention on a screen"
  what="Similarweb tracked real panel clickstream data from July to December 2025 (with a supplemental January 2026 survey), following what users did after ChatGPT named a brand in a response, comparing Sephora against Ulta in the Beauty vertical"
  benefit="7.9% of surveyed users visited Sephora within days of an AI recommendation naming Sephora, versus only 3.3% who visited competitor Ulta in that same window, a direct, brand-specific lift tied to the citation"
  timeframe="6-month clickstream window (Jul-Dec 2025), survey follow-up Jan 2026"
  date="2026-01"
  source="https://www.searchenginejournal.com/ai-recommended-brands-saw-2-5x-more-site-visits-similarweb/580241/"
/>
...
<InAction
  concept="Monitoring citation share as a continuous discipline, not a quarterly check"
  companyName="HubSpot"
  where="HubSpot's own marketing analytics and product team"
  why="HubSpot's customers saw organic traffic fall 27% year-over-year by April 2026 as AI Overviews and chatbots reshaped search, and citation sets were shifting 40-60% within a single month, far too fast for a quarterly SEO review to catch"
  what="HubSpot built and publicly launched the AEO Sensor, a free dashboard tracking daily citation volatility scores, weekly AI-referred traffic trends, and visibility benchmarks across ChatGPT, Gemini, and Perplexity"
  benefit="Documented that its own AI-referred sessions had grown 527% year-over-year even while staying under 2% of total traffic, the exact kind of swing that justifies weekly tracking instead of an annual audit"
  timeframe="Tool launched May 14, 2026, after a year of internally tracked organic decline"
  date="2026-05-14"
  source="https://ppc.land/hubspot-aeo-sensor-goes-live-as-chatgpt-traffic-hits-12-month-low/"
/>
