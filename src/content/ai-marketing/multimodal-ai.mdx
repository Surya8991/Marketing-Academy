...
<InAction
  concept="Cross-modal brand-compliance guardrails at scale"
  companyName="Coca-Cola"
  where="Coca-Cola's 'Create Real Magic' generative AI platform, March 2023"
  why="Thousands of user-submitted AI remixes needed brand-safe guardrails without a human reviewing every submission individually"
  what="The platform enforced pre-approved brand colors, compositions, and asset combinations across every generated piece before the best submissions ran on digital billboards in Times Square and Piccadilly Circus"
  benefit="Thousands of AI-generated brand variations produced in weeks at roughly one-tenth typical production cost, in the same quarter net revenue rose 5%"
  timeframe="March-April 2023"
  date="2023-03"
  source="https://almcorp.com/blog/how-coca-cola-uses-ai-in-marketing-and-product-development/"
/>
...
<InAction
  concept="Reasoning across image, behavioral, and text data at once"
  companyName="Sephora"
  where="Sephora's Virtual Artist AR try-on tool inside the Sephora app"
  why="Customers wanted personalized product recommendations without waiting on a human beauty advisor"
  what="Virtual Artist combines the live camera face image, structured skin-tone data, and past purchase and browsing history in one recommendation pass"
  benefit="11% increase in conversion rate and a 30% reduction in product returns"
  timeframe="Ongoing since the tool's 2024 relaunch"
  date="2024"
  source="https://cut-the-saas.com/ai/beauty-and-the-bot-how-sephora-reimagined-customer-experience-with-ai"
/>
