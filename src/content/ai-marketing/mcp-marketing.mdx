...
<InAction
  concept="Read-only MCP workflows surfacing an issue earlier than the old manual reporting cycle"
  companyName="Wix"
  where="Wix's SEO team, HubSpot plus LinkedIn Ads MCP connections"
  why="Cross-referencing contact lifecycle stage with lead source for MQL-to-SQL rates by channel used to take two hours of manual, error-prone pivot-table work"
  what="A read-only MCP-connected AI agent answered the same MQL-to-SQL-by-channel question on demand for any team member, not just the analyst who knew the pivot table"
  benefit="Caught a LinkedIn Ads audience-quality issue two weeks earlier than their prior manual reporting cycle would have surfaced it"
  timeframe="2025"
  date="2025"
  source="https://www.wix.com/seo/learn/resource/how-to-use-mcp-in-marketing"
/>
...
<InAction
  concept="An official vendor-maintained MCP server removing the community-server reliability risk"
  companyName="HubSpot"
  where="HubSpot's official MCP server, public beta January 2026, general availability April 2026"
  why="Community-built connectors for major CRMs varied wildly in auth handling and action coverage, exactly the risk this section's Mistake 4 warns about"
  what="HubSpot became the first major CRM to ship an official, vendor-maintained MCP server, giving AI assistants read and write access to CRM records inside each user's existing permissions"
  benefit="Removed the single biggest adoption blocker for HubSpot's 38%-share marketing automation customer base connecting AI assistants to live CRM data"
  timeframe="January 2026 public beta to April 2026 general availability"
  date="2026-04"
