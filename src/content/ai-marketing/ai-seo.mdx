...
<InAction
  concept="SERP Overlap Keyword Clustering"
  companyName="Databox"
  where="Core B2B SaaS product analytics content hub and knowledge base"
  why="Hundreds of overlapping business dashboard keywords were cannibalizing rankings across competing blog URLs"
  what="Clustered thousands of search queries by Google SERP co-ranking overlap using Keyword Insights to map pillar pages and distinct cluster articles"
  benefit="Grew organic search traffic by 118% by eliminating keyword cannibalization and concentrating topical authority"
  timeframe="6 months"
  date="2024"
  source="https://www.keywordinsights.ai/case-studies/databox/"
/>
...
<InAction
  concept="Embeddings-Based Internal Linking"
  companyName="Kiteworks"
  where="Cybersecurity and compliance enterprise content architecture across thousands of URLs"
  why="Static manual internal links left deep educational glossary pages orphaned and under-indexed by AI search systems"
  what="Replaced 53,000 static links with an autonomous embeddings-based semantic link graph using Quattr and GSC search intent data"
  benefit="Drove a 79% increase in AI Overview citations and 300% growth in non-brand organic search traffic"
  timeframe="19 months"
  date="2024"
  source="https://www.quattr.com/customers/kiteworks"
/>
