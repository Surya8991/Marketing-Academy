...
<InAction
  concept="Combining collaborative and content-based filtering with human review"
  companyName="Stitch Fix"
  where="Stage 2: Model."
  why="Stitch Fix pairs its AI matching engine, which blends collaborative filtering ('clients like you liked these items') with content-based filtering on garment attributes, with a human stylist who reviews every algorithmically generated box before it ships."
  what="By 2024, AI-driven recommendations accounted for 75% of the clothing selections sent to customers, with stylists curating and adjusting the AI's shortlist rather than building boxes from scratch."
  benefit="Average order value rose 40% and annual revenue roughly doubled, from $1.7 billion to $3.2 billion, over four years of AI-personalization investment."
  timeframe="2020-2024"
  date="2024"
  source="https://chiefaiofficer.com/how-stitch-fixs-ai-personalization-strategy-increased-average-order-value-by-40-and-doubled-revenue/"
/>
...
<InAction
  concept="Delivering personalization through an in-app dynamic tool"
  companyName="Sephora"
  where="Stage 3: Deliver."
  why="Sephora built its AI-powered Virtual Artist AR try-on tool directly into the Sephora app and site so shoppers see personalized, face-mapped shade and product matches at the exact moment they're deciding what to buy, not in a follow-up email."
  what="The tool analyzes a shopper's uploaded selfie and product-browsing history to render real-time try-on results and recommend complementary products."
  benefit="Sephora reported an 11% increase in conversion rate and a 30% reduction in product returns among shoppers who used Virtual Artist before purchasing."
  timeframe="ongoing since 2016 launch"
  date="2025"
  source="https://www.brandxr.io/research-report-how-beauty-brands-are-using-ar-mirrors-to-increase-sales"
/>
