...
<InAction
  concept="Structured Prompt Iteration for AI Video"
  companyName="Kalshi"
  where="Kalshi's in-house creative team, using Google's Veo 3 text-to-video model"
  why="A 30-second national-broadcast-quality commercial for the 2025 NBA Finals would normally cost seven figures and take months through traditional production"
  what="The team wrote a script, broke it into a shot list, and iterated structured prompts through roughly 300 to 400 generations to land 15 usable clips, then edited them into a single ad"
  benefit="The finished commercial aired during the 2025 NBA Finals for approximately $2,000 in production cost, completed in about 48 hours"
  timeframe="Produced and aired within a 48-hour window during the June 2025 NBA Finals"
  date="2025-06"
  source="https://www.eweek.com/news/ai-ad-kalshi-nba-finals/"
/>
...
<InAction
  concept="Brand-Layered AI Visuals at Scale"
  companyName="Snowflake"
  companyId="snowflake"
  where="Snowflake's internal marketing design team, using an internal AI agent called CoCo"
  why="Producing on-brand visual assets for fast-moving campaigns was bottlenecked on a small design team's manual turnaround time"
  what="A designer used CoCo to take a task through ideation, generation, and brand-template application in a single AI-assisted pass instead of the usual multi-day manual process"
  benefit="A task the designer described as a full week of work was compressed into about 20 minutes"
  timeframe="Reported as part of Snowflake's 2025-2026 internal AI-native marketing rollout"
  date="2026-06"
  source="https://www.snowflake.com/en/blog/snowflake-marketing-ai-council-ai-native-team/"
/>
...
<ResourceList resources={[
  ...
  { title: "Midjourney Documentation - Prompt Guide", url: "https://docs.midjourney.com/hc/en-us/articles/32023408776205-Prompt-Basics", type: "docs", free: true, note: "Official guide to writing effective Midjourney prompts with syntax examples" },
