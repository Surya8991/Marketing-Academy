...
<InAction
  concept="Data-grounding synthetic personas"
  companyName="Colgate-Palmolive"
  where="A 2025 validation study run with PyMC Labs"
  why="Colgate-Palmolive wanted to know whether AI-simulated consumer panels could substitute for repeat human survey waves without losing reliability."
  what="Researchers ran 57 consumer surveys against both real respondents (9,300 total) and data-grounded synthetic panels built to match the same population, then compared results."
  benefit="Synthetic panels reproduced 90% of human test-retest reliability and kept distributional similarity above 85% across the 57 surveys."
  timeframe="2025 validation study"
  date="2025"
...
<InAction
  concept="Pre-testing ad creative against a synthetic audience before spend"
  companyName="FULLBEAUTY"
  where="Ad creative validation ahead of a Meta Advantage+ campaign launch"
  why="FULLBEAUTY wanted to catch weak creative and messaging before committing real media spend to a retail campaign."
  what="The retailer ran candidate ad creative through AI synthetic-audience pre-testing to flag comprehension and appeal issues, then only launched the pre-validated versions through Meta's Advantage+ platform."
  benefit="Pre-tested creative delivered a 45% lift in ROAS, a 22% rise in conversion rate, and a 36% lift in click-through rate against the prior baseline."
  timeframe="2026 retail benchmark report"
  date="2026"
  source="https://neuroflash.com/blog/testing/case-studies-synthetic-audiences-ad-performance/"
/>
