...
<InAction
  concept="The AI Monitoring Stack: Crayon, Klue, Kompyte, Brandwatch"
  companyName="Blackbaud"
  companyId="blackbaud"
  where="global sales organization, competitive intelligence program run by a single analyst"
  why="One CI analyst was spending roughly 10 hours a week manually fielding seller questions and updating battlecards across outdated systems."
  what="Rolled out Klue's Compete Agent to synthesize competitor signals and answer seller questions automatically instead of routing every request through the analyst."
  benefit="Increased win rate against top competitors by 28% and freed up the equivalent of two full workdays per week for the CI analyst."
...
<InAction
  concept="Win/Loss Pattern Detection from CRM Notes"
  companyName="User Intuition"
  companyId="user-intuition"
  where="B2B SaaS win-loss research practice"
  why="Sales reps' closed-lost notes usually just say 'price', which hides the real decision driver and sends the wrong fix to the roadmap."
  what="Ran structured, AI-moderated probing interviews across 10,247 post-decision buyer conversations instead of taking the first reason a buyer volunteers at face value."
  benefit="Found price was the true primary driver in only 18.1% of losses, versus the 62.3% of buyers who initially blamed price, a 44-point gap between the stated and structurally-verified reason."
  timeframe="2026 win-loss benchmark"
  date="2026"
  source="https://www.userintuition.ai/reference-guides/winloss-consumer-insights-why-customers-choose-youor-dont/"
/>
