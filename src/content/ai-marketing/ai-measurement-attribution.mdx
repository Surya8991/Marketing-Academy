...
<InAction
  concept="Fixing attribution accuracy by correcting broken channel grouping"
  companyName="AAA Club Alliance"
  where="AAA Club Alliance's Google Analytics setup and Google Tag Manager configuration across its member acquisition and services marketing"
  why="Out-of-the-box channel grouping settings and default UTM parameters didn't match ACA's actual marketing channels, leaving leadership unable to see where traffic and conversions really came from"
  what="Audited the analytics and tag manager setup, reconfigured goal tracking and customized channel groupings to reflect ACA's real marketing mix, then verified tag firing"
  benefit="Cut unattributed traffic from 76.7% to 34.5%, a 55% improvement in attribution accuracy, restoring visibility into which channels actually drove results"
  timeframe="4-week audit with ongoing optimization"
  date="2024"
  source="https://www.trustinsights.ai/expertise/case-studies/google-analytics-audit-and-attribution/"
/>
...
<InAction
  concept="Incrementality testing to validate and optimize channel spend"
  companyName="Mondelez"
  where="Mondelez's retail media campaigns on Walmart Connect"
  why="Standard attribution and platform-reported ROAS made it hard to tell how much of Walmart Connect's reported performance was truly incremental versus sales that would have happened anyway"
  what="Used Walmart Connect's Search Incrementality feature alongside ad frequency optimization and seasonal creative rotation to measure true incremental lift from the campaigns"
  benefit="Increased engagement and conversions by 53% year-over-year and improved incremental ROI by 29%"
  timeframe="Year-over-year campaign review"
  date="2025"
  source="https://www.dataslayer.ai/blog/incrementality-becomes-the-primary-kpi-for-retail-media-advertisers"
/>
