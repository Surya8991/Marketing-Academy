...
<InAction
  concept="Email sequence generation from CRM triggers"
  companyName="Vendasta"
  where="Its sales and marketing operations team"
  why="Sales development reps were losing 282 working days a year to manual CRM admin, which was costing the company over $1 million in missed pipeline every year."
  what="Automated the CRM-triggered follow-up and pipeline-tracking workflows end-to-end with Zapier, replacing the manual, event-by-event process reps had been running by hand."
  benefit="Recovered $1 million in pipeline and saved 282+ workdays per year"
  timeframe="Within one year of building the automation"
  date="2025"
  source="https://zapier.com/customer-stories/vendasta"
/>
...
<InAction
  concept="Zapier AI agent workflow automation"
  companyName="Superhuman"
  where="Its marketing and support operations teams"
  why="Lead data was flowing unreliably between marketing tools and the CRM, causing sync errors that slowed campaign launches and left sales working from incomplete lead records."
  what="Built agentic Zapier automations to sync lead data, launch campaigns, and route support work without manual handoffs between marketing and support teams."
  benefit="Cut lead sync errors by 87% and improved plan efficiency by 31%, while each support agent reclaimed about an hour a day"
  timeframe="After rolling out the automation"
  date="2025"
  source="https://zapier.com/customer-stories/superhuman"
/>
