...
<InAction
  concept="Natural Language Generation for Subject Lines"
  companyName="Virgin Holidays"
  where="Virgin Holidays' direct-to-consumer email marketing campaigns across seasonal leisure travel packages"
  why="The marketing team needed to scale multivariate subject line testing without expanding headcount or manually drafting dozens of variants per blast"
  what="Integrated Phrasee's deep-learning natural language generation (NLG) engine to generate, test, and rank brand-voice-compliant subject lines and header copy"
  benefit="Achieved a 2 percentage point increase in email open rates, unlocking millions of pounds in incremental booking revenue"
  timeframe="Production deployment"
  date="2024"
  source="https://www.thedrum.com/news/2017/04/10/how-virgin-holidays-used-ai-unlock-millions-email-revenue"
/>
...
<InAction
  ...
  companyName="Every Man Jack"
  companyId="klaviyo"
  where="Every Man Jack's direct-to-consumer grooming product replenishment and lifecycle email automations"
  why="Traditional fixed-schedule email blasts landed in congested inboxes during off-hours, missing individual subscriber usage rhythms"
  what="Deployed Klaviyo's machine learning Smart Send Time and predictive analytics to automatically time delivery based on individual customer open and repeat-purchase patterns"
  benefit="Predictive-driven email flows generated 12.4% of total Klaviyo-attributed revenue, maintaining higher open rates across automated product reorder cycles"
  timeframe="Full-year lifecycle review"
  date="2024"
  source="https://www.klaviyo.com/customers/every-man-jack"
/>
...
<ResourceList resources={[
  ...
  { title: "Mailchimp - AI Marketing Tools", url: "https://mailchimp.com/solutions/ai-tools/", type: "tool", free: false, note: "Industry-standard platform with built-in subject line AI and send-time optimization" },
