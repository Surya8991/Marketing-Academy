...
<InAction
  concept="Anchoring against category price norms"
  companyName="MVMT"
  companyId="mvmt-watches"
  where="MVMT's direct-to-consumer pricing page, watches priced $100-$250"
  why="Traditional watch retail runs on markups the industry itself doesn't advertise, so any DTC watch feels expensive or cheap only relative to that hidden anchor."
  what="MVMT skipped the traditional retail markup entirely and sold direct at $100-$250, positioning against the industry's high-markup norm as the implicit anchor rather than competing on features alone."
...
<InAction
  concept="Multi-tier structuring for comparison"
  companyName="Casper Sleep"
  companyId="casper-sleep"
  where="Casper's mattress lineup, expanded from one model to a structured tier set (Original, Nova Hybrid, Wave Hybrid)"
  why="Casper launched with a single mattress and one price, then added hybrid tiers above it once buyers needed a comparison point, not just a single yes/no purchase decision."
  what="Casper introduced the Wave Hybrid as a premium tier above the Original, giving buyers a structured comparison instead of one take-it-or-leave-it price."
  benefit="Net revenue grew 17.7%, from $373M in 2018 to $439M in 2019, as the expanded tiered lineup rolled out."
  timeframe="2018-2019"
  date="2019"
  source="https://www.sec.gov/Archives/edgar/data/1598674/000104746920000166/a2240404zs-1.htm"
/>
