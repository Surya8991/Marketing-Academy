...
<InAction
  concept="1:Few (Cluster ABM)"
  companyName="Adyen"
  companyId="adyen"
  where="Adyen's account-based marketing program targeting fashion retailers in Australia and New Zealand, run with agency Mahlab"
  why="24 target accounts in the fashion retail vertical had stalled or gone quiet, some unresponsive for over two years, and generic outbound wasn't reopening the conversations"
  what="Ran a coordinated 1:Few cluster campaign across LinkedIn, Google Display, email, and direct outreach from Adyen leadership, tailored to fashion retail's specific payment pain points"
  benefit="Re-engaged 83% of the 24 target accounts, with half of engaged accounts progressing to commercial conversations and 3+ entering product testing"
  timeframe="2023-2024 campaign"
  date="2024"
  source="https://www.mahlab.co/case-studies/how-can-deep-curiosity-drive-sales-acceleration"
/>
...
<InAction
  concept="Pipeline Influenced"
  companyName="Auth0"
  where="Auth0's account-based marketing program targeting enterprise identity-and-access-management buyers"
  why="Auth0 needed to prove ABM was driving pipeline, not just engagement, to justify continued investment to leadership"
  what="Coordinated marketing and sales around a named target account list, tracking pipeline influenced rather than raw lead volume as the headline metric"
  benefit="Grew pipeline by $3 million in six weeks, lifted average selling price 25%, and generated 80% of new opportunities from ABM-touched accounts, an 8x return on ABM spend"
  timeframe="six-week program"
  date="2025"
  source="https://www.tripledart.com/abm/abm-examples"
/>
