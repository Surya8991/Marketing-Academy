...
<InAction
  ...
  companyId="snowflake"
  where="IPO, New York Stock Exchange"
  why="Snowflake refused to compete as 'a faster data warehouse' and instead framed itself as the inventor of an entirely new category, the Data Cloud, arguing that data trapped in silos across clouds was the real problem, not query speed."
  what="The company built its entire IPO narrative around owning the Data Cloud category rather than comparing feature-for-feature against Teradata, Redshift, or BigQuery."
  benefit="Private valuation jumped from $12.4 billion in February 2020 to $70.4 billion by the close of its first trading day on September 16, 2020, a 111% first-day pop that made it the largest software IPO in history."
...
<InAction
  concept="Name the Category, Then the Company"
  companyName="Klaviyo"
  companyId="klaviyo"
  where="S-1 filing and IPO positioning"
  why="Klaviyo needed a name a CFO could repeat, one that separated it from generic 'email service provider' tools and gave the company a category it could plausibly own outright."
  what="It built its IPO narrative and go-to-market language around 'revenue marketing' and 'owned marketing,' unifying email, SMS, and first-party customer data instead of pitching itself as a better newsletter tool."
  benefit="Priced its IPO above the increased range at $30 a share, then closed its first trading day up 9.2% at roughly $9.2 billion fully diluted."
  timeframe="IPO, September 2023"
  date="2023-09-19"
  source="https://www.cnbc.com/2023/09/20/klaviyo-shares-open-at-36point75-in-nyse-debut.html"
/>
