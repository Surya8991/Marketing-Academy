...
<InAction
  concept="Technology integration unifying marketing and sales data"
  companyName="Motorola Solutions"
  where="Public safety and enterprise security technology company"
  why="Customer data was scattered across disconnected marketing and sales systems, so the marketing team couldn't see which accounts were actually engaging before a rep called them."
  what="Consolidated records into a single unified data platform (HubSpot's Data Hub and Data Studio), giving marketing and sales a shared, real-time view of every account instead of siloed exports."
  benefit="Unified 123,000+ customer records and surfaced one cross-sell opportunity from that shared data that alone generated millions of dollars in revenue."
  timeframe="Ongoing rollout"
  date="2026"
...
<InAction
  concept="Revenue intelligence surfacing where deals stall in the waterfall"
  companyName="Experian Employer Services"
  where="Data and analytics division of Experian, financial services"
  why="Forecasting relied on manual spreadsheets and siloed platforms, so leaders reacted to deals stalling in the pipeline instead of catching risk early."
  what="Adopted a revenue intelligence layer (Gong's AI Deal Predictor and Deal Monitor) that scores deal health and flags at-risk opportunities in real time, replacing static, backward-looking forecasts."
  benefit="Win rates rose 25% and sales volume grew 10% after shifting to dynamic, data-driven pipeline prioritization."
  timeframe="Following rollout"
  date="2026"
  source="https://www.gong.io/customers/case-studies/how-experian-boosted-win-rates-by-25-and-achieved-sustainable-growth-with-gong-s-ai-insights"
/>
