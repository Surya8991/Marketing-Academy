...
<InAction
  concept="Price as a signal, not just a number"
  companyName="Flipkart"
  companyId="flipkart"
  where="Flipkart's 2023 Big Billion Days festive sale"
  why="With quick-commerce apps and Amazon undercutting on speed, Flipkart needed a pricing event that signaled deep value without permanently discounting its everyday catalog."
  what="An 8-day event combining tax-driven price cuts, bank-card discounts, no-cost EMI plans, and a new 'Trust Shield' buyer-protection layer, all timed to the festive shopping season."
  benefit="Roughly Rs 50,000 crore (about $6 billion) in gross sales over 8 days, a 16% jump over the prior year, with 1.4 billion customer visits and the event alone estimated at around 10% of India's total e-commerce volume for that window."
  timeframe="8 days"
  date="2023-10"
  source="https://readon.substack.com/p/how-big-is-flipkarts-big-billion"
/>
...
<InAction
  concept="Redesigning discovery as a distribution channel"
  companyName="Airbnb"
  companyId="airbnb"
  where="Airbnb's 2022 Summer Release, the Categories redesign"
  why="Search-only discovery only worked when travelers already knew a destination by name, which kept demand concentrated in the same handful of cities."
  what="Replaced destination-search-first browsing with 56 tag-driven categories (Treehouses, Domes, Amazing Views, and more) covering over 4 million unique homes, letting guests discover a place without typing a location."
  benefit="Wishlisting of listings in the newly surfaced categories jumped sharply, treehouses up 51%, boats up 160%, domes up 355%, spreading demand toward inventory travelers never used to search for by name."
  timeframe="Ongoing since the 2022 Summer Release"
  date="2022-05"
  source="https://news.airbnb.com/airbnb-2022-summer-release-highlights"
/>
