...
<InAction
  concept="Retention Stage"
  companyName="Slack"
  companyId="slack"
  where="During its early hypergrowth phase, Slack identified that top-of-funnel team signups suffered high churn if teams never crossed past casual experimentation."
  why="Data analysis revealed that exchanging 2,000 team messages was the tipping point where teams fully embedded Slack into daily workflow."
  what="Slack re-engineered its Day 1-7 onboarding sequence, Slackbot prompts, and invite nudges to guide new teams directly to the 2,000-message milestone."
  benefit="Achieved a 93% long-term retention rate for teams crossing the 2,000-message threshold, driving industry-leading ~140% net revenue retention"
  timeframe="2014-2019"
  date="2015"
...
<InAction
  ...
  companyName="Google Consumer Insights"
  where="Google analyzed 310,000 simulated purchase journeys across 31 product categories to understand why linear funnels fail."
  why="Traditional linear models assumed straight-line conversion, ignoring the reality that buyers loop continuously between exploration and evaluation."
  what="Google mapped how six behavioral biases (category heuristics, social proof, authority) trigger purchase decisions inside the messy middle."
  benefit="Showed that deploying targeted behavioral cues during the evaluation loop swung up to 28% of customer preference away from an established market leader to a challenger"
  timeframe="2020"
  date="2020"
  source="https://www.thinkwithgoogle.com/consumer-insights/consumer-journey/navigating-purchase-behavior-and-decision-making/"
/>
