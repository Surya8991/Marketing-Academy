...
<InAction
  concept="What Is Brand Marketing?"
  companyName="Duolingo"
  where="TikTok, Instagram, YouTube Shorts"
  why="Duolingo had a functional, low-emotion product, a language-learning app, competing for attention against entertainment apps, not just other education apps, so a features-and-benefits ad strategy wasn't going to win mental availability."
  what="Duolingo turned its owl mascot 'Duo' into a chaotic, self-aware internet personality across organic TikTok content, with no direct calls-to-action or discount codes in most posts, pure brand personality building instead of a performance funnel."
  benefit="Revenue grew from roughly $200 million (2022) to more than $400 million (2024) as the user base more than doubled, with the TikTok content driving an average click-through rate 39% above the education-industry benchmark"
  timeframe="2022 to 2024"
  date="2024"
  source="https://chantellemarcelle.com/duolingo-growth-marketing-case-study/"
/>
...
<InAction
  concept="Why the 60/40 Rule Exists"
  companyName="Liquid Death"
  where="TikTok, Instagram, retail canned water category"
  why="Liquid Death entered a category, canned water, with near-zero emotional differentiation between competitors, so the founders bet that a loud brand identity would compound into distribution and revenue faster than performance ads for a near-commodity product could."
  what="Instead of funding paid search or retargeting for a product nobody searches for by name, Liquid Death built its entire go-to-market around shock-value branding and organic social content across TikTok and Instagram."
  benefit="Revenue doubled from roughly $130 million (2022) to $260 million (2023), with the company reaching a $1.4 billion valuation within five years of launch"
  timeframe="2022 to 2023, five years post-launch"
  date="2023"
  source="https://houseofmarketers.com/liquid-death-marketing-strategy/"
/>
