...
<InAction
  ...
  companyId="robinhood"
  where="Robinhood's pre-launch waitlist and referral program for its commission-free trading app"
  why="As an unknown startup entering a market dominated by established brokers, Robinhood had no brand trust or paid-media budget to compete on"
  what="Built a referral-gated waitlist where signing up moved a user's position forward for every friend referred, with real-time waitlist rank displayed"
  benefit="Grew from a few thousand signups on day one to 50,000 in the first week and 1,000,000 before public launch, with the landing page converting over 50% of visitors, entirely without paid advertising"
  timeframe="pre-launch year, 2013"
  date="2013"
...
<InAction
  concept="Proving one market before scaling to the next"
  companyName="Coinbase"
  companyId="coinbase"
  where="Coinbase's phased international expansion strategy beyond its core US market"
  why="Expanding into every global market simultaneously would have spread compliance, regulatory, and marketing resources too thin to win any single region"
  what="Sequenced international expansion in phases, prioritizing a small set of high-potential, regulation-ready markets (Europe, UK, Canada, Brazil, Singapore, Australia) for Phase 2 only after proving the model in Phase 1 markets"
  benefit="Entered Phase 2 with 83% of its targeted major hubs already providing increasing regulatory clarity on crypto, expanding into markets it had already de-risked instead of guessing blind"
  timeframe="multi-phase rollout, 2024-2025"
  date="2024"
  source="https://www.coinbase.com/blog/announcing-phase-ii-of-our-international-expansion-strategy-83-of-major-hubs"
/>
