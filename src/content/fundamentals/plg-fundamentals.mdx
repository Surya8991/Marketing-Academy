...
<InAction
  concept="The Rise of the Self-Serve Buyer"
  companyName="Netlify"
  where="ProductLed Podcast interview"
  why="Netlify's co-founder Chris Bach observed that the self-serve buyer trend has moved past humans entirely: developer tools are now signed up for, configured, and evaluated by autonomous coding agents before a human ever sees the product."
  what="Chris Bach described the majority of new signups on Netlify's development platform as AI agents rather than people, a step beyond even the fastest human self-serve flow."
  benefit="The majority of new signups on Netlify's platform are now AI agents, not humans, meaning the onboarding flow has to work for an agent's evaluation, not just a person's."
  timeframe="Reported March 2026"
  date="2026-03-17"
  source="https://productled.com/blog/the-evolution-of-product-led-growth-plg-x-ai"
/>
...
<InAction
  concept="The Product-Led Growth Engine"
  companyName="Klaviyo"
  companyId="klaviyo"
  where="Shopify App Store, then IPO"
  why="Klaviyo grew almost entirely through the self-serve loop this section describes: install, experience value inside an existing e-commerce workflow, hit a usage ceiling, upgrade, and expand, with no salesperson touching the account until usage justified it."
  what="Merchants installed Klaviyo as a free Shopify app, connected their store data, and immediately saw email/SMS revenue attribution before any paid conversation began, the product itself did the convincing."
  benefit="That self-serve engine scaled the company to a $30-a-share IPO priced above range and a roughly $9.2 billion fully diluted valuation on its first day of trading."
