...
<InAction
  ...
  companyName="Slack"
  companyId="slack"
  where="When launching Slack in 2013, Stewart Butterfield recognized that positioning the product as 'group chat' would relegate it to an IT-controlled niche alongside IRC."
  why="He published the internal manifesto 'We Don't Sell Saddles Here', mandating that Slack sell organizational transformation rather than software specs."
  what="Slack framed its product directly against internal email overload ('fewer meetings, less email'), enabling viral bottom-up adoption by everyday team members."
  benefit="Reached 500,000 daily active users in year one with a 93% team retention rate after 2,000 messages, culminating in a $27.7B acquisition by Salesforce in 2021"
  timeframe="2013-2021"
  date="2013"
  source="https://review.firstround.com/from-0-to-1B-slacks-founder-shares-their-golden-rules"
/>
...
<InAction
  concept="Point of Difference"
  companyName="Watcom / Sybase"
  where="Watcom's database was facing cancellation after failing in the crowded 'desktop productivity database' category against Microsoft Access."
  why="April Dunford analyzed power users and discovered their unique attribute—tiny memory footprint and fault recovery—mattered immensely for mobile servers."
  what="Watcom stripped away the generic desktop claims, isolated that single point of difference, and repositioned as an 'embeddable database for mobile devices'."
  benefit="Rebounded from near-zero sales to over $1 billion in lifetime revenue and was acquired by Sybase and later SAP"
  timeframe="1990s-2000s"
  date="2019"
  source="https://www.aprildunford.com/post/an-introduction-to-positioning"
/>
...
<ResourceList resources={[
  ...
  {
    title: "HubSpot: 16 Examples of Positioning Statements & How to Craft Your Own",
