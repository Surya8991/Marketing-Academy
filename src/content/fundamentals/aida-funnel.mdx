...
<InAction
  concept="Attention: interrupting the scroll"
  companyName="e.l.f. Cosmetics"
  where="TikTok, the #eyeslipsface hashtag challenge"
  why="Traditional beauty ads get scrolled past in under 2 seconds; e.l.f. needed a hook built for TikTok's native format instead of a repurposed ad"
  what="e.l.f. commissioned an original 15-second song and challenge format designed specifically for TikTok, rather than running a standard product ad"
  benefit="The hashtag accumulated nearly 1.2 billion views and drove a measurable lift in website traffic and sales"
  timeframe="Launched October 2019"
  date="2019"
  source="https://houseofmarketers.com/elf-cosmetics-beauty-brand-tiktok-case-study/"
/>
...
<InAction
  concept="Trust gap: reducing purchase anxiety before Action"
  companyName="Warby Parker"
  companyId="warby-parker"
  where="Warby Parker's Home Try-On program, glasses shipped free for a 5-day at-home trial before purchase"
  why="Buying glasses sight-unseen online creates the exact 'what if it does not work for me' hesitation this lesson describes at the Desire-to-Action gap"
  what="Warby Parker let customers try 5 frames at home for free before committing, removing the risk of an online purchase instead of adding a discount"
  benefit="Shoppers who shared their try-on experience on social media were 50% more likely to complete the purchase"
  timeframe="Program ran from Warby Parker's 2010 launch through 2025"
  date="2010"
  source="https://www.markhub24.com/post/warby-parker-s-home-try-on-how-a-logistical-experiment-became-a-brand-building-engine"
/>
