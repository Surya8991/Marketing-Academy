...
<InAction
  concept="Prioritizing brand-building spend over performance ads"
  companyName="Liquid Death"
  where="Canned water and beverage brand"
  why="A commodity product (water) has no functional differentiation to advertise, so competing on performance-ad efficiency alone would mean competing on price."
  what="Put the marketing budget almost entirely behind brand-building content (a pre-launch video, a death-metal album made from hate comments, a Super Bowl ad) instead of conversion-focused performance ads."
  benefit="Revenue grew from $45 million (2021) to $263 million in retail sales (2023), with the company valued at $1.4 billion in its March 2024 funding round."
  timeframe="2021 to 2024"
  date="2024"
  source="https://en.wikipedia.org/wiki/Liquid_Death"
/>
...
<InAction
  concept="Funding proven, existing-traffic conversion before new acquisition spend"
  companyName="RealVNC"
  where="Remote-access software company"
  why="More paid traffic to a site that already converts poorly just wastes the new spend, so acquisition budget needed a proven conversion base to land on first."
  what="Used behavioral intent analysis and lead scoring to improve how well existing high-intent website visitors converted, funding that Tier 1 fix before allocating fresh budget to new traffic acquisition."
  benefit="Chat conversions rose 71% and sales efficiency increased 216% before any new acquisition budget was added."
  timeframe="Following implementation"
  date="2026"
  source="https://blog.hubspot.com/marketing/marketing-budget-percentage"
/>
