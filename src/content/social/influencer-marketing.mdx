...
<InAction
  concept="Weighting the creator portfolio toward micro and nano tiers"
  companyName="Glossier"
  where="Glossier's Generation Glossier ambassador program, built from its most engaged customers rather than recruited celebrities"
  why="A portfolio weighted toward micro and nano creators converts existing fans into a distributed sales force at a fraction of macro-influencer cost"
  what="Roughly 500 brand ambassadors, mostly micro and nano-tier customers rather than macro influencers, were formalized into a commission-based referral program"
  benefit="70% of Glossier's online sales came through peer referrals, with 8% of sales directly attributed to ambassador activity"
  timeframe="Program built over several years of Glossier's early growth"
  date="2025"
  source="https://www.enrichlabs.ai/case-study/glossier-marketing-strategy"
/>
...
<InAction
  concept="Whitelisting a top-performing organic post as a paid ad"
  companyName="ULTA Beauty"
  where="A whitelisted Instagram post from a ~200k-follower beauty creator, run as a paid ad from the creator's own handle"
  why="A whitelisted post already carries real social proof (real likes, real comments) before a single paid dollar is spent behind it, which is why it consistently beats brand-handle creative"
  what="ULTA ran the creator's organic post as a boosted ad from her handle instead of reposting it from the brand account"
  benefit="The post drew 9,000 likes versus the creator's typical organic high of 150-300, reached over 2 million unique users, and generated 7 million impressions"
  timeframe="Single campaign flight"
  date="2025"
  source="https://influencermarketinghub.com/whitelisting-and-spark-ads/"
/>
...
<ResourceList resources={[
  ...
  { title: "Aspire - State of Influencer Marketing 2026", url: "https://www.aspire.io/guides/the-state-of-influencer-marketing-2026", type: "docs", free: true },
