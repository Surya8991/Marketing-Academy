...
<InAction
  ...
  companyName="Samsung"
  where="Samsung's European marketing team, monitoring 43 markets via social listening dashboards"
  why="A washing machine jingle was going viral organically on TikTok, and Samsung needed to know before it peaked whether to amplify it"
  what="Detected the trend early through cross-market social listening, then rapidly built a campaign response that amplified the organic trend instead of missing the window"
  benefit="Rode existing user enthusiasm into a campaign that extended the trend's reach rather than relying on paid media alone"
  timeframe="2024"
  date="2024"
  source="https://influencermarketinghub.com/social-media-listening-report/"
/>
...
<InAction
  concept="Enrichment"
  companyName="Crayola"
  where="Crayola's social team, after implementing an Emplifi social listening solution for enrichment and trend tagging"
  why="Seasonal childhood-culture trends move fast, and manually tagging and prioritizing mentions was too slow to catch color and format trends early"
  what="Automated sentiment and topic enrichment on incoming mentions so the team could process and act on volume without manual triage"
  benefit="Processed content 80% faster and detected emerging trends 90% faster than before the platform was in place"
  timeframe="2024"
  date="2024"
  source="https://syncly.app/blog/social-listening-roi-metrics"
/>
