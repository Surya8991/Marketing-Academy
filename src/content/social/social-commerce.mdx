...
<InAction
  concept="Live shopping driving the majority of social commerce revenue"
  companyName="Sea Limited (Shopee)"
  companyId="sea-limited"
  where="Shopee's livestream and short-form video commerce across Southeast Asia"
  why="Shopee leaned into live shopping and short-form video as a dedicated commerce surface rather than treating it as a side feature of the main feed"
  what="Scaled livestream and short-video commerce so it now accounts for the majority of physical-goods order growth in the region"
  benefit="Orders from live streaming and short-form video grew more than 50% year-on-year, outpacing Shopee's overall 27% full-year 2025 GMV growth, and now make up over 35% of physical-goods orders in Southeast Asia"
  timeframe="Full-year 2025 results"
  date="2026-03"
  source="https://cdn.sea.com/investor/4Q2025/JcKns4LaJC8bxcQdJwXz/2026.03.03%20Sea%20Fourth%20Quarter%20and%20Full%20Year%202025%20Results.pdf"
/>
...
<InAction
  ...
  where="HelloFresh's always-on TikTok creator affiliate program"
  why="Instead of committing budget to flat-fee paid collaborations first, HelloFresh runs an ongoing affiliate program that lets it test which creators actually convert before spending more on them"
  what="Manages 200-300 affiliate creators a month on TikTok, tracking sales through unique promo codes rather than guessing at attribution"
  benefit="500-plus monthly tracked sales via promo codes and roughly 5 million monthly video views from the affiliate creator pool alone"
  timeframe="Ongoing always-on program, reported 2025"
  date="2025-01"
  source="https://www.thisisafk.com/partnerships/hello-fresh/"
/>
...
<ResourceList resources={[
  ...
  { title: "YouTube Shopping Affiliate Program - Overview and Eligibility", url: "https://support.google.com/youtube/answer/13376398", type: "docs", free: true },
