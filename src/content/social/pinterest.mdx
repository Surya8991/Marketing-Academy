...
<InAction
  concept="Collections Ads and Shopping-driven Pinterest campaigns"
  companyName="Dorko"
  where="Pinterest Ads, Collections and dynamic shopping campaigns"
  why="As a regional streetwear brand competing for attention on crowded lifestyle feeds, Dorko needed a channel where purchase intent was already built into the discovery moment, exactly the gap Pinterest Shopping features close."
  what="Dorko ran dynamic ad testing and strategic product bundling through Pinterest's shopping-enabled ad formats over a 5-month window."
  benefit="25x return on ad spend and a 35% increase in average order value through product bundling"
  timeframe="September 2023 to January 2024"
  date="2024-04-14"
  source="https://evolutagency.com/pinterest-case-study/"
/>
...
<InAction
  concept="Conversions API (CAPI)"
  companyName="Stradivarius"
  where="Pinterest advertising account, implemented with partner Adsmurai"
  why="Relying only on the Pinterest Tag was under-counting conversions lost to browser-level tracking restrictions, the exact gap the lesson's CAPI section describes."
  what="Stradivarius implemented the Pinterest Conversions API (API4C) alongside its existing Pinterest Tag to restore server-side conversion signal."
  benefit="+82% increase in matched conversions and a 28% reduction in cost per acquisition after implementation"
  timeframe="Reported 2024"
  date="2024-06-07"
  source="https://business.pinterest.com/en-gb/success-stories/stradivarius/"
/>
...
<ResourceList resources={[
  { title: "Pinterest Business Help Center - Get Started", url: "https://help.pinterest.com/en/business/topics/get-started", type: "docs", free: true, note: "Official documentation for all Pinterest business features" },
