...
<InAction
  concept="TikTok's engagement-signal-driven full-funnel targeting"
  companyName="e.l.f. Cosmetics"
  where="TikTok, working with agency Tinuiti on an always-engaged, full-funnel paid program layered on top of the #eyeslipsface organic campaign"
  why="e.l.f. needed to convert TikTok's massive organic reach (nearly 5 million user videos, 7 billion views on #eyeslipsface) into efficient paid acquisition instead of relying on virality alone"
  what="Ran In-Feed Ads for reach and engagement plus Dynamic Showcase Ads for conversion, doubling spend month-over-month so the algorithm had more engagement data to optimize delivery against"
  benefit="56% reduction in add-to-cart cost-per-acquisition, conversion click-through rate 1.9x benchmark, and conversion cost-per-click 49% below benchmark"
  timeframe="Ongoing paid program layered on the multi-year #eyeslipsface organic strategy"
  date="2023"
  source="https://tinuiti.com/work/ims-case-study-elf/"
/>
...
<InAction
  concept="LinkedIn's comment-weighted ranking"
  companyName="Gong"
  companyId="gong"
  where="Gong's company LinkedIn Page, using a daily video series designed to spike comment volume"
  why="Gong wanted to grow its built-in organic audience on LinkedIn quickly, knowing the platform's algorithm weights comment threads far more heavily than likes"
  what="Released 10 short, casual videos over two weeks and explicitly asked viewers to leave simple comments, turning comment velocity into a deliberate growth lever rather than a side effect"
  benefit="LinkedIn Page following grew 85% in 30 days, with likes up 194%, shares up 108%, and comments up 6,893% versus the prior period"
  timeframe="2 weeks for the video series, effects measured over the following 30 days"
  date="2023"
  source="https://business.linkedin.com/content/dam/me/business/en-us/marketing-solutions/case-studies/pdfs/lms_casestudy_gong.io_final.pdf"
/>
