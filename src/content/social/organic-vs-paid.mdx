...
<InAction
  concept="Amplifying organic winners with paid budget"
  companyName="DoorDash"
  companyId="doordash"
  where="A Father's Day 2024 campaign with agency Digital Voices, run on Instagram and TikTok"
  why="Nine creators (77% from underrepresented communities) produced organic gifting content first; the team then boosted only the posts that were already performing instead of briefing separate paid-only assets"
  what="Ran each creator's best-performing organic post as a boosted ad on TikTok and Instagram, using platform auto-optimization instead of the plain Boost button"
  benefit="9,984,542 paid impressions (7% above forecast), 52,859 landing page views (68% above forecast), and a 48.86% landing page view rate (24% above forecast), on top of 17M+ combined impressions and 95% positive comment sentiment"
  timeframe="Campaign ran June 2024, ahead of Father's Day"
  date="2024-06"
  source="https://shortyawards.com/17th/redefining-fathers-day-gifting-digital-voices-x-doordash"
/>
...
<InAction
  concept="Creator distribution outperforming brand-page organic reach"
  companyName="Airbnb"
  companyId="airbnb"
  where="Airbnb's Summer 2025 launch of expanded Experiences and Airbnb Services"
  why="Rather than lean on its own brand-page organic reach, Airbnb activated a wave of micro-creators and travel vloggers across lifestyle, travel, and wellness verticals in their home cities, plus celebrity-led activations and an in-person LA event"
  what="Built distribution through creator partnerships instead of brand-page posting, spanning micro-creators to macro travel vloggers"
  benefit="172 million media impressions and 2 million-plus views from the creator-led campaign, part of a broader 36% lift in influencer-attributed bookings versus traditional PPC ads that year"
  timeframe="Announced and launched May 13, 2025"
  date="2025-05-13"
  source="https://www.crowepr.com/blog/inside-airbnbs-summer-2025-launch-how-influencer-strategy-is-redefining-hospitality-marketingnbsp"
/>
