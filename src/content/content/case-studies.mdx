...
<InAction
  concept="Selecting customers with quantifiable time-to-value speed"
  companyName="Hamleys"
  where="Hamleys retail customer support team in partnership with Freshworks."
  why="Traditional enterprise support platforms required months of bespoke deployment and steep technical onboarding, causing retail leaders to delay software modernization."
  what="Freshworks documented Hamleys rapid transition to Freshdesk, highlighting operational simplicity and immediate rollout speed rather than complex feature sets."
  benefit="Hamleys achieved full onboarding in less than 48 hours and reduced support operational costs by 50%."
  timeframe="48 hours to launch"
  date="2023"
  source="https://www.freshworks.com/customers/hamleys/"
/>
...
<InAction
  concept="Structuring the Snapshot Box for rapid time-to-value comprehension"
  companyName="Casio UK"
  where="Casio UK e-commerce and marketing operations team with HubSpot."
  why="Siloed legacy databases and disconnected marketing automation tools prevented sales reps from seeing buyer engagement, causing high lead drop-off."
  what="HubSpot and Casio UK structured case study pages around prominent Snapshot Boxes highlighting quantifiable time-to-value and implementation timelines before narrative prose."
  benefit="Generated over £1 million in net revenue from email campaigns, increased sales opportunities by 496%, and lifted web traffic by 54%."
  timeframe="12 months"
  date="2023"
  source="https://www.hubspot.com/case-studies/casio-uk"
/>
...
<ResourceList resources={[
  ...
  { title: "Amra & Elma - Case Study Marketing Statistics 2026", url: "https://www.amraandelma.com/case-study-marketing-statistics/", type: "article", free: true, note: "Source for case study buyer research and conversion stats" },
