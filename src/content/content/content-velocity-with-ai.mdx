...
<InAction
  concept="AI Drafts, Human Edits, Editor Reviews"
  companyName="Ahrefs"
  where="Ahrefs' content marketing team, publishing SEO research and how-to articles"
  why="Director of Content Marketing Ryan Law needed to keep publishing rigorously researched, first-person SEO content without expanding headcount"
  what="Built a human-AI workflow using Claude Code and a chained set of custom prompt 'skills' to draft and structure articles, with a human writer still supplying original testing, opinions, and the final edit before publish"
  benefit="Condensed a process that used to take several days of research, writing, and revision into about two hours per article, without changing how the finished articles read or perform"
  timeframe="Documented August 2025"
  date="2025-08"
...
<InAction
  concept="Fact Verification Quality Gate"
  companyName="CNET"
  where="CNET Money, financial explainer articles"
  why="CNET quietly published 77 AI-written financial explainer articles under a 'CNET Money Staff' byline with no fact-verification gate before publish"
  what="After Futurism reported errors in the articles, CNET's editors audited every one of the 77 published AI articles for accuracy"
  benefit="Found incorrect information in 41 of the 77 AI-written articles, forcing CNET to pause AI publishing, issue corrections, and add human fact-checking before any AI draft could go live again"
  timeframe="November 2022 to January 2023"
  date="2023-01"
  source="https://www.cnn.com/2023/01/25/tech/cnet-ai-tool-news-stories"
/>
...
<ResourceList resources={[
  ...
  { title: "Working with AI in Your Content Workflow? Here Are 3 Things That Help", url: "https://www.thinklikeapublisher.com/working-with-ai-in-your-content-workflow-here-are-3-things-that-help/", type: "article", free: true },
