...
<InAction
  concept="Human-in-the-loop (HITL) model"
  companyName="Content Marketing Institute"
  where="Content Marketing Institute's annual AI writing trends research"
  why="To measure how enterprises actually govern AI-generated content once it moves past experimentation and into production"
  what="Surveyed enterprise marketing teams already using AI in their content workflows"
  benefit="Found that 73% of these enterprises now enforce a mandatory human review step before any AI-assisted draft is published, confirming HITL as the industry-standard safeguard rather than an optional best practice"
  timeframe="One annual research cycle"
  date="2025"
  source="https://contentmarketinginstitute.com/articles/ai-writing-trends-research"
/>
...
<InAction
  concept="AI Governance Council"
  companyName="Mastercard"
  where="Mastercard's centralized AI governance function"
  why="The volume of AI use cases needing review was outpacing what a single governance owner could safely assess"
  what="Scaled its AI governance team from one employee to a five-person specialist group reviewing every marketing and enterprise AI use case before deployment"
  benefit="Absorbed a 60% single-year jump in AI systems requiring assessment in 2024 without slowing deployments or creating a review bottleneck"
  timeframe="Governance team scaled over roughly two years, absorbing a 60% case-volume increase in 2024 alone"
  date="2024"
  source="https://www.dataversity.net/case-studies/case-study-operationalizing-ai-governance-at-mastercard/"
/>
...
<ResourceList resources={[
  ...
  { title: "EU AI Act, High-Level Summary", url: "https://artificialintelligenceact.eu/high-level-summary/", type: "docs", free: true },
