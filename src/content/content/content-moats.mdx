...
<InAction
  concept="Manual datasets"
  companyName="Backlinko"
  where="Backlinko's SEO research team, in partnership with Ahrefs"
  why="To identify which factors actually correlate with first-page Google rankings, since most SEO advice at the time was anecdotal"
  what="Manually assembled and analyzed a dataset of 11.8 million Google search results, publishing the findings with full methodology"
  benefit="The number-one ranking result was found to have 3.8x more backlinks than positions #2-10 on average, a stat still cited across thousands of SEO articles and tools today"
  timeframe="One research cycle covering roughly 11.8 million search results"
  date="2020"
...
<InAction
  concept="Product telemetry"
  companyName="Wistia"
  where="Wistia's annual State of Video report, built on its own video-hosting platform"
  why="To turn the platform's own usage data into a citable industry benchmark instead of paying for link building"
  what="Aggregated engagement data from over 90 million hosted videos alongside a survey of 2,000 marketing professionals"
  benefit="HubSpot's own video marketing statistics article links back to Wistia's report using the anchor text '82% watch rate,' one of hundreds of inbound citations the report earns each year"
  timeframe="Annual report cycle"
  date="2024"
