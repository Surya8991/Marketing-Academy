export const lessonMeta = {
  ...
  level: "Intermediate",
  summary: "How gated long-form assets generate qualified B2B leads, what makes them convert and how to build one that earns the email.",
};
...
- **Demand keeps rising, not falling.** [NetLine's 2025 State of B2B Content Report](https://www.netline.com/content-consumption-report/) found ebooks account for 48.8% of all gated content registrations, and total demand for gated content has grown 83.8% since 2020. Ebooks generate roughly 983 registrations per asset uploaded, far outpacing whitepapers at 59.5-60.
...
<ResourceList resources={[
  ...
  { title: "HubSpot - How to Create an Ebook From Start to Finish", url: "https://blog.hubspot.com/marketing/how-to-create-an-ebook-free-templates", type: "article", free: true, note: "Step-by-step guide with templates from one of the most prolific ebook publishers in marketing" },
