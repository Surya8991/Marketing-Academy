...
<InAction
  ...
  where="Headspace's lifecycle marketing team, running behavior-triggered push and in-app campaigns via Braze"
  why="New users who installed but never built a meditation habit were churning inside their first week, and generic time-based reminders weren't reversing it"
  what="Personalized push notifications and deep-linked in-app messages tied to each user's meditation history and content preferences, sent to new (0-1 activation phase) and dormant users, rather than a single generic reminder"
  benefit="Users who received the campaigns showed 109% higher retention in Week 1 versus a control group, plus a 26% uplift in new-user activation"
  timeframe="Measured across a multi-quarter lifecycle marketing engagement"
  date="2023"
  source="https://phiture.com/success-stories/headspace-retention/"
/>
...
<InAction
  concept="Referral"
  companyName="Airbnb"
  where="Airbnb's growth team, redesigning their existing but under-used referral program"
  why="A first referral program launched in 2011 sat almost unused for three years, hurt by poor UX, no mobile support, and manual sharing"
  what="A full redesign, Referrals 2.0, with mobile-first frictionless sharing (WhatsApp, Messenger), personalized invites, a double-sided reward ($25 for the guest, $75 for the host), and fraud controls"
  benefit="Daily bookings and signups increased 300%, and first-time bookings grew 900% year-on-year"
  timeframe="Following the Referrals 2.0 relaunch"
  date="2014"
  source="https://growsurf.com/blog/airbnb-referral-program/"
/>
...
<ResourceList resources={[
  ...
  {
    title: "Growth Series Course, Reforge",
    url: "https://www.reforge.com/courses/growth-series",
    type: "course",
    note: "Deep-dive course covering AARRR-style funnels, experimentation frameworks, and growth strategy taught by practitioners.",
    free: false,
  },
  {
