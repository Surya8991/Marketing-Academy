...
<InAction
  concept="Champion Programs"
  companyName="Notion"
  where="Notion's community team"
  why="Free-tier virality was slowing as the product matured past early adopters, so Notion needed unpaid power users to keep driving organic acquisition into new market segments"
  what="Recruited its most active template creators and local meetup organizers into formal Ambassador and Champion programs, split across enterprise-focused Champions and community-facing Ambassadors, each running local events, templates, and tutorials"
  benefit="Grew from 1M to over 30M users largely through word-of-mouth, with more than 1,000 ambassadors driving organic acquisition and brand exposure at near-zero paid CAC"
  timeframe="2018-2023"
  date="2023"
  source="https://www.digitalnative.tech/p/how-notion-used-community-to-scale"
/>
...
<InAction
  concept="Community-Qualified Leads (CQLs)"
  companyName="CelerData"
  where="CelerData's GTM team, tagging Slack community members by intent inside Common Room"
  why="Slack community engagement was generating real buying signals that never reached the sales pipeline because there was no formal way to separate a lurker from a ready-to-buy account"
  what="Tagged individuals as community-qualified leads based on intent and customer-fit signals inside their Slack community, then routed only the qualifying tier into their CRM pipeline"
  benefit="Drove a 75% year-over-year increase in signal-sourced pipeline, with Slack-sourced signals responsible for nearly 25% of total pipeline and a 30% engagement response rate"
  timeframe="year-over-year, reported 2025"
  date="2025"
  source="https://www.commonroom.io/customers/celerdata-optimized-go-to-market/"
/>
