...
<InAction
  concept="Compounding growth once liquidity tips past critical mass"
  companyName="GoTo (Gojek + Tokopedia)"
  companyId="goto-gojek-tokopedia"
  where="GoTo's ride-hailing, delivery, and payments ecosystem across Indonesia"
  why="To show that once a super-app ecosystem passes its density threshold, transaction volume and active users compound together rather than growing separately"
  what="GoTo's full-year 2024 core Gross Transaction Value grew 58% year-over-year to Rp268.2 trillion, while Monthly Transacting Users across the ecosystem grew 16% over the same full year"
  benefit="GTV growth (58%) outpaced user growth (16%) by more than 3x, meaning each additional active user was transacting more, the signature signal of a network past its tipping point"
  timeframe="Full year 2024, reported Q4 2024 earnings"
  date="2024"
  source="https://www.gotocompany.com/en/news/press/goto-group-beats-guidance-with-record-results-as-it-reports-2024-fourth-quarter-and-full-year-earnings"
/>
...
<InAction
  concept="Indirect network effects: the consumer side creates value businesses will pay for"
  companyName="Yelp"
  companyId="yelp"
  where="Yelp's local business marketplace, connecting consumers who write reviews with the businesses those reviews describe"
  why="Yelp needed proof that consumer-side review growth actually moved the metric business owners care about, not just review counts on a dashboard"
  what="Yelp's platform crossed 330 million cumulative reviews with roughly 22 million added per year, and Yelp's own revenue research found a 1-star increase in a business's average rating is linked to a 5-9% increase in that business's revenue"
  benefit="A 1-star rating increase mapped to 5-9% more revenue per business, converting review growth on the consumer side into a demand signal the business side would pay to be part of"
  timeframe="Cumulative review base as of 2025, roughly 60,000 new reviews added per day"
  date="2025"
  source="https://wisernotify.com/blog/yelp-statistics/"
/>
