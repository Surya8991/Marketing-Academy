...
<InAction
  concept="Loss aversion drives reverse-trial conversion"
  companyName="Toggl"
  companyId="toggl"
  where="Toggl's new-signup flow, rolled out 2022"
  why="Toggl's standard freemium model was being exploited by teams spinning up multiple free accounts instead of upgrading, so feature curiosity alone wasn't converting anyone."
  what="Toggl switched new signups to a 30-day reverse trial with full premium access, then let the downgrade to the free tier create the loss-aversion pressure freemium couldn't."
  benefit="Premium plan revenue doubled within months of the reverse trial rollout, per a 2023 case study documenting the change."
  timeframe="2022 rollout, results reported 2023"
  date="2023"
  source="https://www.inflection.io/post/complete-guide-to-reverse-trials"
/>
...
<InAction
  concept="Trial-to-paid conversion economics beat standard freemium"
  companyName="Airtable"
  companyId="airtable"
  where="Airtable's Pro-tier 14-day reverse trial for new teams"
  why="Airtable needed new teams to experience automation runs and higher record limits before deciding whether the Pro tier was worth paying for, not just read a pricing page."
  what="New teams land on Pro-tier limits and automation runs for 14 days, then limits tighten gradually over two weeks instead of a hard cutoff, softening the downgrade while still creating upgrade pressure."
  benefit="Early reverse-trial benchmark data places Airtable's cohort in the 15-30% trial-to-paid conversion range, roughly 3-6x the 2-5% conversion typical of standard freemium."
  timeframe="Ongoing"
  date="2025"
  source="https://kylepoyar.substack.com/p/your-guide-to-reverse-trials"
/>
...
<ResourceList resources={[
  { title: "Elena Verna: Reverse Trials, Examples", url: "https://www.elenaverna.com/p/reverse-trials-examples", type: "article", free: true, note: "Original framework from the growth advisor who popularized the term" },
  { title: "Reforge: Growth Series", url: "https://www.reforge.com/courses/growth-series", type: "course", free: false, note: "Covers reverse trials in depth within PLG strategy" },
  { title: "Lenny's Newsletter - Freemium vs. Trial", url: "https://www.lennysnewsletter.com/p/freemium-trials-free", type: "article", free: true, note: "Practical comparison with real conversion benchmarks" },
  { title: "OpenView Partners: Your Guide to PLG Benchmarks", url: "https://openviewpartners.com/blog/your-guide-to-product-led-growth-benchmarks/", type: "article", free: true, note: "Industry data on freemium and trial conversion rates" },
  ...
  { title: "A Complete Guide to Reverse Trials (Inflection)", url: "https://www.inflection.io/post/complete-guide-to-reverse-trials", type: "article", free: true, note: "Documents Toggl doubling premium revenue with reverse trial" },
