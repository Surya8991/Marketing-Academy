...
<InAction
  concept="Two-sided rewards outperforming one-sided rewards"
  companyName="Airbnb"
  companyId="airbnb"
  where="Airbnb's Referrals 2.0 program, rolled out across web, iOS, and Android"
  why="The original one-sided referral flow was under-performing and the company wanted both the referrer and the new guest to have a reason to act"
  what="Rebuilt the program as a two-sided model with travel credit for both the referrer and the referred friend, rather than rewarding only the person sharing"
  benefit="Daily signups and bookings increased by more than 300% following the two-sided relaunch"
  timeframe="following the January 2014 Referrals 2.0 launch"
  date="2014"
...
<InAction
  concept="Tiered rewards driving pre-launch virality"
  companyName="Harry's"
  where="Harry's pre-launch landing page, before the razor product existed or shipped a single unit"
  why="The founders needed an email list and an initial customer base with zero brand awareness and no advertising budget"
  what="Built a tiered referral waitlist where visitors who signed up were immediately asked to refer others, unlocking better rewards at 5, 10, 25, and 50 referrals"
  benefit="100,000 email signups in 7 days, with 77% of those signups originating from referrals rather than the original traffic source"
  timeframe="one week, pre-launch"
  date="2013"
  source="https://referralrock.com/blog/harrys-referral-program/"
/>
...
<ResourceList resources={[
  { title: "ReferralCandy - The Complete Referral Marketing Guide", url: "https://www.referralcandy.com/blog/the-complete-referral-marketing-guide-for-2025", type: "article", free: true, note: "Comprehensive tactical guide with industry benchmarks" },
  ...
  { title: "Andrew Chen - How to Design a Referral Program", url: "https://andrewchen.com/how-to-design-a-referral-program/", type: "article", free: true, note: "Analytical breakdown of the mechanics behind successful referral programs" },
