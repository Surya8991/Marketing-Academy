...
<InAction
  concept="Freemium builds distribution and shortens the path to a sales-qualified buyer"
  companyName="HubSpot"
  companyId="hubspot"
  why="Sales-led demos and gated content were expensive to run and slow to convert prospects who hadn't yet felt the product's value"
  where="HubSpot's go-to-market team, launching a genuinely complete free CRM instead of a crippled trial version"
  what="Let prospects self-educate and self-qualify inside the real product for free, then let usage limits (contacts, seats, automation) create the natural upgrade trigger"
  benefit="User base grew from roughly 15,000 customers in 2014 to over 128,000 by 2021, about 25% of new premium customers now start as freemium users, and free-first customers convert to paid 60% faster than customers who enter through traditional sales channels"
  timeframe="2014 to 2021, free CRM launch through scaled growth"
  date="2021"
  source="https://www.getmonetizely.com/articles/hubspots-pricing-journey-how-bundling-and-freemium-fueled-growth"
/>
...
<InAction
  concept="Reverse trials (premium-first, then downgrade to free) convert far higher than pure freemium"
  companyName="Loom"
  companyId="loom"
  where="Loom's onboarding funnel, giving new signups full access before dropping them to the free tier's recording limits"
  why="Pure freemium signup pools were large but converted at typical low-single-digit freemium rates"
  what="New users experience every premium feature first, then get downgraded to the free plan's caps once the trial window closes, so the upgrade decision is made against a real, already-felt loss instead of an abstract feature list"
  benefit="Early reported reverse-trial conversion rates of 15-30%, versus the 2-5% typical for pure freemium"
  timeframe="Ongoing onboarding model as of 2026"
  date="2026"
  source="https://www.ideaplan.io/compare/freemium-vs-free-trial"
/>
