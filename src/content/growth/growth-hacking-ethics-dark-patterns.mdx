...
<InAction
  concept="Dark-pattern signup and cancellation flows trigger regulatory action"
  companyName="Epic Games"
  companyId="epic-games"
  where="Epic Games, maker of Fortnite"
  why="The FTC alleged Fortnite's purchase-button layout was counterintuitive, inconsistent, and confusing, letting players (including children, without parental consent) rack up unwanted charges from a single misplaced button press."
  what="Settled FTC charges under Section 5 for using dark patterns to trigger unwanted in-game purchases, and was ordered to stop the practice and change its purchase-flow design."
  benefit="Paid $245 million in FTC-ordered consumer refunds, the largest gaming-related FTC settlement at the time, as part of a combined $520 million in total relief with a related COPPA settlement."
  timeframe="Settlement announced December 2022; order finalized March 2023"
  date="2022"
...
<InAction
  concept="Asymmetric signup and cancellation effort"
  companyName="Vonage"
  companyId="vonage"
  where="Vonage, the internet phone service provider"
  why="Customers could enroll online in minutes, but canceling required calling a hard-to-find retention line during limited hours, and Vonage kept billing some customers even after they had directly requested cancellation."
  what="Settled FTC charges under ROSCA and Section 5 for using dark patterns and undisclosed junk fees to make cancellation far harder than signup, and was ordered to build a cancellation path as easy as signup."
  benefit="Paid $100 million in consumer refunds, with the FTC distributing payments to 389,106 affected customers."
  timeframe="Settlement announced November 2022; refunds distributed by the FTC in October 2023"
  date="2022"
  source="https://www.ftc.gov/news-events/news/press-releases/2022/11/ftc-action-against-vonage-results-100-million-customers-trapped-illegal-dark-patterns-junk-fees-when-trying-cancel-service"
/>
