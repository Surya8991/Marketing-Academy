...
<InAction
  concept="Define one activation event"
  companyName="Slack"
  companyId="slack"
  where="Slack's growth team, 2014-2018"
  why="Chat products have dozens of possible 'engaged' signals, most of them noisy. Slack needed one number that reliably predicted which teams would still be paying a year later."
  what="Slack discovered that teams which exchanged 2,000 cumulative messages had integrated the tool into daily workflows, standups, decisions, file sharing, not just tried it. That single threshold became the activation goal every onboarding and growth decision was optimized against."
  benefit="Teams that crossed 2,000 messages converted to long-term paid customers at a 93% rate, turning one metric into the organizing principle for Slack's entire onboarding redesign."
  timeframe="2014-2018 growth era"
  date="2021"
  source="https://www.ideaplan.io/case-studies/slack-product-led-growth"
/>
...
<InAction
  concept="Compress time-to-first-value"
  companyName="Calendly"
  companyId="calendly"
  where="Calendly's self-serve signup flow"
  why="A scheduling tool's value only exists once someone else actually books a meeting through it, so every step between signup and a shareable link is pure delay with no payoff yet."
  what="Calendly's flow connects a calendar, sets availability, and generates a ready-made shareable booking link with no feature tour, no blank canvas, and no required fields beyond what the link itself needs."
  benefit="New users go from signup to a live, shareable booking link in under 90 seconds, compressing time-to-value from the SaaS-wide average of 1 day 12 hours to a near-zero window."
  timeframe="Ongoing, current signup flow"
  date="2026"
  source="https://userpilot.com/blog/onboarding-ux-examples/"
/>
