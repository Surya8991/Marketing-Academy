...
<InAction
  ...
  companyName="Slack"
  companyId="slack"
  where="Slack's quarterly SEC filings ahead of its 2021 Salesforce acquisition"
  why="Slack's board and investors needed to know whether the existing customer base was growing revenue on its own, separate from new-logo sales, to judge whether the business would keep compounding"
  what="Slack reported net dollar retention (the SaaS-industry name for NRR) each quarter, calculated from starting MRR plus expansion minus contraction and churn, with zero credit given for new customers"
  benefit="Slack posted a 132% net dollar retention rate in Q1 FY2021 and 125% in Q2 FY2021, meaning its existing customer base alone grew revenue 25-32% year over year with no new logos counted"
  timeframe="Fiscal Q1 and Q2 2021 (calendar year 2020)"
  date="2020"
  source="https://slack.com/intl/en-in/blog/news/slack-announces-second-quarter-fiscal-year-2021-results"
/>
...
<InAction
  ...
  companyId="coinbase"
  where="Coinbase's Subscription and Services revenue line, reported quarterly to investors"
  why="Coinbase wanted to reduce its dependence on volatile trading-fee revenue by getting existing customers to adopt more products (staking, custody, Coinbase One membership, stablecoin balances) rather than relying purely on new-customer trading volume"
  what="Coinbase tracked Subscription and Services revenue, driven almost entirely by existing customers adopting and expanding usage of non-trading products, as a distinct, growing share of total revenue"
  benefit="Subscription and Services revenue reached 48% of Coinbase's total net revenue in Q2 2026, up from 29% roughly two years earlier, a direct measure of existing-customer expansion displacing new-trade-dependent revenue"
  timeframe="Q2 2026, compared against Q4 2024"
  date="2026"
  source="https://www.sec.gov/Archives/edgar/data/0001679788/000167978826000087/q226earningsdeck_sec.htm"
/>
