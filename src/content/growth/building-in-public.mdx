...
<InAction
  concept="Sharing real, verifiable revenue numbers publicly"
  companyName="Buffer"
  where="Buffer's public 'Open' metrics dashboard and monthly transparency reports"
  why="Buffer wanted transparency to build trust with customers, hold the team accountable, and push the industry toward more openness"
  what="Starting in 2013, Buffer began publishing its real MRR, individual salaries, and monthly shareholder updates on a public dashboard instead of vague growth claims"
  benefit="Buffer's publicly-tracked MRR grew from $12,000/month at the start of the practice to $2.2M MRR ($26M ARR) today, with the transparency dashboard itself becoming a recurring source of press coverage and community trust"
  timeframe="2013 to present, over a decade of continuous publishing"
  date="2013"
  source="https://buffer.com/open"
/>
...
<InAction
  concept="Committing to a consistent public-update cadence"
  companyName="Base44"
  where="LinkedIn and X, during founder Maor Shlomo's solo build of the AI app-builder Base44"
  why="As a bootstrapped solo founder with no marketing budget, Shlomo needed a distribution channel that did not require ad spend"
  what="He posted regular, specific milestone and financial updates through the build, including reporting a $189,000 monthly profit figure in public, rather than occasional vague progress posts"
  benefit="Base44 grew to over 400,000 users with zero paid marketing spend and was acquired by Wix for roughly $80 million within about six months of launch"
  timeframe="roughly six months, early 2025 to the June 2025 acquisition"
  date="2025"
  source="https://www.lennysnewsletter.com/p/the-base44-bootstrapped-startup-success-story-maor-shlomo"
/>
