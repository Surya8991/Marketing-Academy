...
<InAction
  concept="Measuring the aha moment quantitatively and iterating on it"
  companyName="Superhuman"
  companyId="superhuman"
  where="Superhuman's founding team, running quarterly product-market-fit surveys against its email client"
  why="In summer 2017 only 22% of users said they'd be 'very disappointed' without Superhuman, well below the 40% threshold correlated with sustainable growth"
  what="The team segmented users by expectation level, then ran a 4-step engine each quarter, prioritizing roadmap work by how much it would move the 'very disappointed' score, and re-measuring every cycle instead of guessing"
  benefit="The 'very disappointed' PMF score climbed from 22% to 33% to 47% to 56% to 58% across three quarters of iteration"
  timeframe="Summer 2017 to early 2018, three consecutive quarters"
  date="2018"
...
<InAction
  concept="Interactive, gamified engagement loops drive activation-like habit behavior"
  companyName="HelloFresh"
  companyId="hellofresh"
  where="HelloFresh's lifecycle marketing team, running an in-app 'catch the ingredients' game to re-engage subscribers"
  why="Static win-back emails were not pulling lapsed and at-risk subscribers back into a weekly ordering habit"
  what="Replaced passive messaging with a gamified loop: subscribers collected weekly plates over four weeks to qualify for a prize draw, mirroring the same interactive-over-static pattern that drives first-time activation"
  benefit="50% game registration rate, 46.8% game completion rate, and 96% of finishers went on to enter the prize draw, with 73.5% of players continuing to engage afterward"
  timeframe="Four-week campaign cycle"
  date="2024"
  source="https://www.reflectdigital.co.uk/case-studies/hellofresh"
/>
