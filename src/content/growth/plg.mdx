...
In 2026, 91% of B2B SaaS companies with over $50M in ARR have adopted product-led growth, and 91% plan to increase their PLG investment further (Segment8, 2025). The shift is no longer experimental. PLG has crossed from a go-to-market strategy into the default operating model for scaled B2B software companies.
...
<InAction
  ...
  companyName="Slack"
  companyId="slack"
  where="Slack's freemium-to-paid motion, ahead of its 2021 acquisition by Salesforce"
  why="Slack needed a signal that a free team was actually running its daily work through the product, not just poking around, before routing any sales attention at it"
  what="Slack tracked usage depth (messages sent, days active, teammates invited) inside free workspaces and let that usage itself, not a form fill, qualify a team for upgrade prompts and outreach"
  benefit="Paid customers represented over 37% of Slack's daily active users, a direct-usage-driven conversion rate several times higher than typical marketing-qualified-lead benchmarks"
  timeframe="Measured across Slack's freemium base in the years leading up to its 2021 acquisition"
  date="2021"
  source="https://www.getmonetizely.com/articles/slacks-freemium-trap-how-do-they-convert-free-users-to-paying-customers"
/>
...
<InAction
  ...
  companyName="Adyen"
  companyId="adyen"
  where="Adyen's merchant platform, H2 2023 financial results"
  why="Adyen's self-serve and platform merchants naturally grow their processed payment volume as their own businesses grow, without Adyen running a fresh acquisition motion on them"
  what="Adyen tracked and reported processed-volume growth attributable to existing merchant relationships expanding usage, separately from volume added by newly signed merchants"
  benefit="Over 80% of Adyen's processed-volume growth in H2 2023 came from existing customer relationships expanding, with volume churn held under 1%"
  timeframe="H2 2023 financial results"
  date="2023"
  source="https://www.thewolfofharcourtstreet.com/p/adyen-volume-acceleration-validates"
/>
...
<ResourceList resources={[
  ...
  { title: "Lenny's Newsletter - The Ultimate Guide to Adding a PLG Motion", url: "https://www.lennysnewsletter.com/p/the-ultimate-guide-to-adding-a-plg", type: "article", free: true },
