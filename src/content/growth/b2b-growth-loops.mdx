...
<InAction
  concept="Collaboration/sharing loop driving organic signups"
  companyName="Calendly"
  where="Meeting-scheduling SaaS, booking-link sharing loop"
  why="Every scheduling link a Calendly user sends doubles as a live product demo for the recipient, since the recipient has to view (and often use) a working Calendly page to book the meeting"
  what="Recipients who spot a Calendly booking badge on someone else's calendar link go on to create their own account at meaningful scale, with the loop closing in about 24 hours from invite to the recipient's own first booking"
  benefit="25% of new users sign up after encountering a Calendly badge in someone else's booking link"
  timeframe="Ongoing organic acquisition channel"
  date="2026"
  source="https://www.flowjam.com/blog/viral-loop-examples-saas-the-definitive-playbook-for-engineering-self-sustaining-growth"
/>
...
<InAction
  concept="Integration depth correlating with net revenue retention"
  companyName="monday.com"
  where="Work-OS SaaS, integration ecosystem loop measured against net revenue retention (NRR)"
  why="A team that wires monday.com into Slack, Salesforce, or its other daily tools shifts the switching cost from monday.com itself onto every workflow now routed through it, the same mechanic the lesson describes for Slack's own integrations"
  what="monday.com's overall NRR was 107%, pulled down by high-churn small accounts; among customers with more than 10 employees, NRR was 121%, evidence that integration-driven stickiness scales with account size and usage depth"
  benefit="121% net revenue retention among customers with 10+ employees, versus 107% blended across all accounts"
  timeframe="LTM data as of monday.com's May 2021 S-1 filing"
  date="2021"
  source="https://cloudedjudgement.substack.com/p/mondaycom-benchmarking-the-s-1-data"
/>
