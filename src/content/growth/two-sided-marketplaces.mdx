...
<InAction
  concept="Aggregating existing supply to seed a two-sided market without recruiting it one listing at a time"
  companyName="Zillow"
  companyId="zillow"
  where="Zillow's real estate marketplace connecting home buyers with listing agents"
  why="Zillow needed enough supply-side inventory and agent presence to make the site useful to buyers before it could earn agents' advertising dollars"
  what="Zillow's Premier Agent network now facilitates more than 1.4 million buyer connections a year and roughly 400,000 completed transactions, about 10% of all U.S. home sales"
  benefit="Aggregated listing supply converted into 1.4 million buyer connections annually, enough demand-side volume that agents pay Zillow for a share of it rather than the reverse"
  timeframe="Trailing 12 months, as reported in early 2026"
  date="2026"
  source="https://www.realestatenews.com/2026/02/24/could-referral-fees-be-real-estates-next-legal-flashpoint"
/>
...
<InAction
  concept="Single-side value pulling in the second side once the first side is genuinely served"
  companyName="ThredUp"
  companyId="thredup"
  where="ThredUp's secondhand-apparel resale marketplace connecting sellers (via mailed 'Clean Out Kits') with buyers"
  why="ThredUp needed to prove that making the seller side genuinely easy would eventually convert into buyer-side demand, not just seller-side volume with no one to buy it"
  what="ThredUp reported 1.37 million active buyers in Q1 2025, up 6% year-over-year, with new buyer growth of 95% year-over-year, its best quarter for new buyer acquisition in company history"
  benefit="New buyer acquisition accelerated to 95% YoY growth in a single quarter, evidence that a mature supply pipeline (Clean Out Kits) was finally pulling fresh demand rather than the platform having to buy it with discounts alone"
  timeframe="Q1 2025 (quarter ended March 31, 2025)"
  date="2025"
  source="https://www.barchart.com/story/news/32220312/thredup-announces-first-quarter-2025-results"
/>
...
<ResourceList resources={[
  { title: "a16z: Hidden Networks, Network Effects That Don't Look Like Network Effects", url: "https://a16z.com/hidden-networks-network-effects-that-dont-look-like-network-effects/", type: "article", free: true, note: "The definitive framework for understanding network effects and marketplace moats" },
  { title: "The Cold Start Problem (Andrew Chen)", url: "https://www.coldstart.com/", type: "article", free: true, note: "Andrew Chen's thesis on how to launch networked products" },
  ...
  { title: "Lenny's Newsletter: How to Kickstart and Scale a Marketplace", url: "https://www.lennysnewsletter.com/p/how-to-kickstart-and-scale-a-marketplace", type: "article", free: true, note: "Data-driven breakdown of cold-start tactics used by top marketplaces" },
