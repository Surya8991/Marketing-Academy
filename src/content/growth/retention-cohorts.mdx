...
<InAction
  concept="Net Revenue Retention as a benchmark"
  companyName="Snowflake"
  companyId="snowflake"
  where="Snowflake's quarterly earnings reports to public-market investors"
  why="Investors needed a single number showing whether expansion inside existing enterprise data-cloud accounts was outpacing any churn, without waiting for new-logo growth to prove it"
  what="Reported net revenue retention in the 124-127% range across FY2025 and FY2026 quarters, driven by usage-based consumption growth among accounts that were already customers"
  benefit="127% net revenue retention in Q2 FY2025, meaning existing customers alone grew revenue by roughly a quarter year over year before counting a single new logo"
  timeframe="Q2 FY2025 (reported August 2024)"
  date="2024"
  source="https://www.snowflake.com/en/news/press-releases/snowflake-reports-financial-results-for-the-second-quarter-of-fiscal-2025/"
/>
...
<InAction
  concept="Feature adoption in Week 1 as a leading indicator"
  companyName="Slack"
  companyId="slack"
  where="Slack's growth team, analyzing why some newly signed-up teams stuck around and others churned within weeks"
  why="Aggregate signup and DAU counts didn't explain which teams would convert to paying, long-term accounts"
  what="Identified that teams crossing 2,000 cumulative messages sent had passed a real activation threshold, and used that count as the leading indicator onboarding was redesigned around"
  benefit="93% of teams that crossed the 2,000-message threshold were still active Slack customers, turning a single leading indicator into the entire early-growth playbook"
  timeframe="measured during Slack's early team-based growth phase"
  date="2014"
  source="https://growthhackers.com/growth-studies/slack/"
/>
...
<ResourceList resources={[
  ...
  { title: "Lenny Rachitsky: What is good retention?", url: "https://www.lennysnewsletter.com/p/what-is-good-retention-issue-29", type: "article", free: true, note: "Benchmark data across consumer and B2B SaaS products" },
  ...
  { title: "Pendo Product Benchmarks Report", url: "https://www.pendo.io/product-benchmarks/", type: "article", free: true, note: "Feature adoption and retention correlation data" },
