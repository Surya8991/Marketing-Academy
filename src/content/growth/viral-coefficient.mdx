...
<InAction
  concept="Viral Coefficient (K-Factor) in a Pre-Launch Waitlist"
  companyName="Robinhood"
  companyId="robinhood"
  where="Robinhood's pre-launch email waitlist, before the trading app existed"
  why="A regulatory approval process meant Robinhood couldn't launch for nearly two years, so the team needed a way to keep demand compounding with zero product and zero ad budget"
  what="Every signup got a real-time queue position and a referral link; moving up the line required getting friends to join, turning each new signup into an active recruiter for more signups"
  benefit="The waitlist grew from roughly 340,000 signups in 2014 to 700,000 by March 2015, then past 1 million by launch, almost entirely through referral sharing with no paid advertising"
  timeframe="2013 to March 2015 launch"
  date="2015"
...
<InAction
  concept="Increasing i via Zero-Friction Sharing"
  companyName="Loom"
  where="Loom's core screen-recording and video-sharing workflow"
  why="Every recorded video needs to reach a colleague to be useful at all, so the sending action and the sharing action are the same action, removing the extra step that kills invite volume in most products"
  what="Recording and sharing a Loom video takes two clicks and requires no separate 'invite a friend' flow; the shared video itself carries Loom's branding and a sign-up prompt for the recipient"
  benefit="Loom scaled to roughly 25 million users largely on the back of these branded, shared videos acting as zero-friction invites rather than a bolted-on referral program"
  timeframe="Ongoing since Loom's 2016 launch"
  date="2024"
  source="https://startupshortcut.com/knowledge-base/how-loom-s-product-led-growth-and-viral-sharing-won-video-messaging"
/>
...
<ResourceList resources={[
  ...
  { title: "Lenny's Newsletter - Behind the Founder: Drew Houston (Dropbox)", url: "https://www.lennysnewsletter.com/p/behind-the-founder-drew-houston-dropbox", type: "article", free: true, note: "Drew Houston on Dropbox's viral referral loop and growth numbers" },
  ...
  { title: "Lenny Rachitsky - How to Increase Virality", url: "https://www.lennysnewsletter.com/p/increasing-virality", type: "article", free: false, note: "Practical breakdown of viral cycle time vs K-factor interaction" },
