...
<InAction
  concept="Conversion KPIs"
  companyName="Policybazaar"
  companyId="policybazaar"
  where="Policybazaar's lifecycle marketing team, running personalized push and drip journeys across more than 30 customer paths on its insurance comparison platform"
  why="Generic, one-size-fits-all push notifications produced weak click-through and conversion numbers, giving the team no clear signal about which journeys were actually driving policy purchases"
  what="Tracked conversion rate and click-through rate as the core KPIs for each of 18-19 personalized drip flows built with MoEngage, instead of just watching delivery volume"
  benefit="Reached a 21% conversion rate and 3.4% click-through rate across personalized journeys, contributing to a 100% year-over-year increase in Annual Premium Equivalent driven through push"
  timeframe="across active campaigns reported in its MoEngage customer case study"
  date="2023"
  source="https://www.moengage.com/casestudy/policybazaar-adopted-a-proactive-approach-to-engagement-via-moengage/"
/>
...
<InAction
  concept="Retention KPIs"
  companyName="Duolingo"
  companyId="duolingo"
  where="Duolingo's growth and product team, deciding which single metric should anchor company-wide priorities"
  why="The team had been optimizing around Daily Active Users, but DAU is a downstream number that does not tell you which lever to pull when growth stalls"
  what="Re-anchored the company's North Star KPI on Current User Retention Rate (CURR), a retention metric, and built a dedicated team to run experiments that moved it"
  benefit="Grew DAU 4.5x over four years, with CURR-focused work becoming, in ex-CPO Jorge Mazal's account, the highest-leverage driver of that growth"
  timeframe="over roughly four years of sustained retention-focused work"
  date="2023"
