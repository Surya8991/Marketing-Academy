...
<InAction
  concept="Pick a shared vocabulary and stick to it"
  companyName="Altior & Co."
  where="A $5M ARR B2B SaaS client's marketing attribution stack"
  why="The client's CMO had been scaling ad spend for two quarters based on channel reports that were quietly wrong, because campaign naming, UTM structure, and CRM field mapping were never standardized across the team."
  what="Altior & Co. standardized the client's campaign naming convention, UTM parameter structure, and CRM field mapping into one shared, enforced system."
  benefit="Attribution accuracy improved by 38% within 30 days, and marketing ROI visibility improved by 85%"
  timeframe="30 days after the standardized system went live"
  date="2025"
  source="https://altiorco.com/resources/blog/attribution-model-case-study"
/>
...
<InAction
  concept="Auto-Tagging for Paid Ads"
  companyName="Omnilux"
  where="Omnilux's Pinterest ad campaigns during the 2025 holiday season"
  why="The brand needed reliable, granular attribution across every Pinterest ad without manually tagging each one, ahead of a competitive holiday push targeting 3x ROAS."
  what="Northbeam automatically applied UTM parameters to every newly created Pinterest ad in the connected ad account, paired with a deterministic Clicks + Views attribution model instead of manual, ad-by-ad tagging."
  benefit="659% lift in ROAS, a 728% increase in transactions, and a 671% lift in revenue versus a traditional clicks-only model"
  timeframe="2025 holiday shopping season"
  date="2025"
  source="https://www.northbeam.io/blog/how-omnilux-drove-a-659-roas-lift-on-pinterest-with-northbeams-clicks-deterministic-views"
/>
