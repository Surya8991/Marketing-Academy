...
<Callout type="info">
By 2025, Gartner projected that 75% of all data stories would be generated automatically by augmented analytics tools (tools that use AI to surface insights). Even so, a human still has to decide which story matters and what action it calls for. Automation handles the "what", you handle the "so what."
</Callout>
