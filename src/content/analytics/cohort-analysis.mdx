...
Average retention numbers lie. They blend last year's loyal users with this week's new signups, smooth out the cracks, and hide the fact that your product may be silently deteriorating. Cohort analysis is the antidote: it groups users by when they joined (or what they did), then tracks each group separately over time. That separation is what reveals whether the changes you ship are actually working.
