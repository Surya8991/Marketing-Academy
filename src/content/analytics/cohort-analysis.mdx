...
<InAction
  concept="Behavioral cohorts"
  companyName="Calm"
  where="Product analytics, using Amplitude's behavioral cohorting"
  why="Calm wanted to find which early user behaviors predicted long-term subscribers, not just which acquisition channel brought them in."
  what="They built a behavioral cohort of users who set a Daily Reminder in the app and compared its retention curve against users who never set one, then validated the pattern was causal with a follow-up experiment on new users."
  benefit="Nearly 3x higher retention for the Daily-Reminder cohort versus users without one"
  timeframe="Ongoing product analytics program"
  date="2023"
  source="https://amplitude.com/case-studies/calm"
/>
...
<InAction
  concept="Day 1 / Day 7 / Day 30 retention"
  companyName="Duolingo"
  companyId="duolingo"
  where="Product growth team, streak and gamification feature testing"
  why="Duolingo needed to know whether a specific onboarding mechanic, the 'Investment Wager' step where new users stake in-app gems on a 7-day streak, actually improved retention or just felt clever."
  what="They shipped the Investment Wager step to a cohort of new signups and tracked Day 1, Day 7, and Day 14 retention against a control cohort that didn't see it."
  benefit="Day-7 retention rose 14% for the cohort that saw the Investment Wager step"
  timeframe="A/B test across new-signup cohorts"
  date="2023"
