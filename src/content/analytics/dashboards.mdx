...
<InAction
  concept="The Executive Scorecard"
  companyName="Russell Marketing"
  where="A marketing agency's weekly leadership sync, where the team used to walk in with raw exports and spend the meeting arguing about what the numbers meant"
  why="Manual Google Sheets updates and ad-hoc digging meant the team spent over an hour combing through data before every client and leadership meeting just to agree on what happened that week"
  what="Replaced the manual spreadsheet refresh cycle with a single always-on Databox dashboard the team could glance at right before a sync, instead of rebuilding the numbers from scratch"
  benefit="Cut meeting prep from over an hour of manual data-combing to an immediate 'temperature check,' and moved reporting cadence from updating every three days to a lighter weekly rhythm"
  timeframe="within weeks of switching from spreadsheets to a live dashboard"
  date="2022"
  source="https://databox.com/databox-case-study-russell-marketing"
/>
...
<InAction
  concept="Connect Your Data Sources"
  companyName="FIFCO"
  where="FIFCO's in-house marketing agency, unifying campaign and spend data across 50+ brands and multiple countries into one reporting layer"
  why="Before automating the data layer, analysts spent weeks each month manually pulling exports from dozens of separate country- and brand-level ad accounts just to assemble one report"
  what="Connected every regional ad platform into Looker Studio via Supermetrics so campaign data across all brands flowed into a single automatically refreshed dashboard instead of manual CSV pulls"
  benefit="Saved over 160 hours of data-ingestion work a month and eliminated roughly $70,000 a year in compensation and tax costs tied to manual reporting"
  timeframe="ongoing, reported in a 2024-2025 customer case study"
  date="2024"
  source="https://supermetrics.com/case-studies/fifco"
/>
