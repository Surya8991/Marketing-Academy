...
<InAction
  concept="iROAS from retail media search incrementality"
  companyName="Mondelez International"
  where="Mondelez's retail media team, using Walmart Connect's Search Incrementality measurement"
  why="Mondelez wanted to know whether its Sponsored Search spend on Walmart was reaching shoppers who would have bought anyway, not just which searches its ads happened to appear next to."
  what="Mondelez used Walmart Connect's Search Incrementality solution to measure true incremental sales from Sponsored Search, then used those reads to optimize ad frequency caps and rotate seasonal creative."
  benefit="Ad-attributed sales grew 53% year-over-year and incremental ROI grew 29% year-over-year across calendar year 2024."
  timeframe="January 2024 - December 2024"
  date="2024"
  source="https://www.walmartconnect.com/resources/articles/2025/full-funnel-retail-media-real-results"
/>
...
<InAction
  concept="Geo holdout (geographic split test)"
  companyName="Shinola"
  where="Shinola's performance marketing team, using Measured's geo-testing platform"
  why="After Apple's App Tracking Transparency rollout degraded user-level tracking, Shinola's Facebook dashboard reporting looked suspiciously weak and the team suspected the platform was under-crediting the channel, not over-crediting it."
  what="Shinola ran a zip-code-level geo-matched market test on its Facebook prospecting and awareness campaigns, comparing matched zip codes that saw ads against zip codes that did not over a multi-week window."
  benefit="The test measured a genuine 14.3% incremental lift in conversions from Facebook, while Facebook's own platform reporting had been under-reporting that true impact by 413%."
  timeframe="Post-iOS 14 ATT rollout, circa 2022"
  date="2022"
  source="https://info.measured.com/hubfs/Case%20studies/Measured%20Case%20Study_Shinola%20.pdf"
/>
