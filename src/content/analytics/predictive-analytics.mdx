...
<InAction
  concept="Predictive Product Recommendations (Collaborative Filtering)"
  companyName="Amazon"
  companyId="amazon"
  where="Amazon's product pages, homepage, and 'customers who bought this also bought' modules across its retail marketplace"
  why="Manually curated merchandising cannot scale to hundreds of millions of SKUs and customers with individually different intent"
  what="Applied collaborative filtering, a predictive model that finds customers with similar purchase and browsing patterns and forecasts what each customer is likely to buy next"
  benefit="Algorithmic recommendations were found to drive 35% of what consumers purchase on Amazon"
  timeframe="Ongoing, cited as of Amazon's retail scale in the early 2010s and still referenced as the industry benchmark"
  date="2013"
...
<InAction
  concept="Predictive Personalization for Retention"
  companyName="Netflix"
  where="Netflix's homepage and per-title recommendation rows, personalized per subscriber using viewing history, device, and time-of-day signals"
  why="Reducing subscriber churn is far cheaper than paid re-acquisition once a customer cancels"
  what="Built a predictive recommendation engine that forecasts what each subscriber is likely to want to watch next, keeping engagement high enough to prevent cancellation"
  benefit="Netflix executives reported the recommendation engine saves the company over $1 billion per year in avoided churn and re-acquisition costs, with over 80% of viewing driven by recommendations rather than search"
  timeframe="Ongoing savings estimate reported by Netflix leadership"
  date="2016"
  source="https://www.tubefilter.com/2016/06/20/netflix-recommendation-engine-algorithm/"
/>
