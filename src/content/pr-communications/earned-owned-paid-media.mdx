...
<InAction
  concept="Earned media outperforming paid reach"
  companyName="Duolingo"
  companyId="duolingo"
  where="TikTok, via its unscripted owl mascot 'Duo' account, with zero paid promotion behind the content"
  why="Duolingo needed daily active engagement from a Gen Z audience that actively filters out ads, a segment where a language-learning app's own paid creative had limited pull"
  what="It let its social team post absurdist, unscripted mascot content instead of branded ad campaigns, treating the account like an entertainment channel a viewer follows voluntarily, not a marketing feed"
  benefit="The strategy reached over 38 million unique TikTok users and 90 million video views organically, at an 11% engagement rate versus TikTok's 2-3% brand average, without a paid media budget behind it"
  timeframe="Ongoing since 2021, cited results through 2025"
  date="2025"
  source="https://www.contentgrip.com/duolingo-viral-strategy/"
/>
...
<InAction
  concept="Sequencing earned, owned, and paid media"
  companyName="Chewy"
  companyId="chewy"
  where="The United States, Chewy's annual holiday 'Chewy Claus' wish-fulfillment program"
  why="Chewy wanted holiday share of voice against much bigger-budget pet retailers without outspending them on paid holiday ads"
  what="It fulfilled real pet owners' holiday wish-list letters (earned story), pushed the resulting stories and user-generated content through its own social and email channels (owned), then layered paid social and influencer partnerships on top to extend reach"
  benefit="The campaign earned 143 media placements reaching 10 million readers and viewers, 23.7 million total impressions, and lifted aided brand awareness by 40% and unaided awareness by 37%"
  timeframe="Holiday season campaign, results reported the following year"
  date="2023"
  source="https://shortyawards.com/15th/chewy-claus"
/>
