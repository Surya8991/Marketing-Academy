...
<InAction
  concept="Earning trust through third-party credibility"
  companyName="Warby Parker"
  companyId="warby-parker"
  where="Warby Parker's February 2010 online launch, before it had any advertising budget"
  why="The DTC eyewear startup had no brand recognition and a home try-on model nobody had tried before, so it needed third-party validation, not a paid claim, to convince skeptical first buyers"
  what="Instead of buying ads, its PR team pitched the story directly to Vogue and GQ, which ran features the same day the site launched, GQ called it 'the Netflix of eyewear'"
  benefit="Sold out its top 15 styles in 4 weeks, hit its first-year sales target in 3 weeks, and built a 20,000-person waitlist, entirely from earned press coverage"
  timeframe="February to March 2010"
  date="2010"
...
<InAction
  ...
  companyName="KFC UK"
  where="The United Kingdom, February 2018"
  why="A delivery-contractor switch left hundreds of KFC restaurants without chicken, triggering national news coverage and a viral #ChickenCrisis hashtag that its net brand sentiment had dropped to -17%"
  what="Instead of staying silent, KFC ran a full-page apology ad rearranging its logo to spell 'FCK' on an empty bucket, publicly owning the failure with self-deprecating honesty instead of corporate deflection"
  benefit="YouGov BrandIndex tracked positive brand attention rising from 7% pre-crisis to 29%, and net sentiment recovered from -17% during the outage to +31% by the end of 2018"
  timeframe="February to December 2018"
  date="2018"
  source="https://www.campaignlive.co.uk/article/kfc-fcking-clever-campaign/1498912"
/>
