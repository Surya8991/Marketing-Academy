...
<InAction
  concept="AI referral traffic is now measurable, and it compounds for early movers"
  companyName="Vercel"
  where="Vercel's own signup-attribution dashboard, shared publicly by CEO Guillermo Rauch"
  why="Developers increasingly ask ChatGPT how to deploy a website instead of typing a query into Google, and Vercel wanted to know how much of its signup funnel that shift was already touching"
  what="Vercel tracked the share of new signups arriving via ChatGPT referral month over month, rather than treating AI referral traffic as unmeasurable"
  benefit="ChatGPT referrals grew from under 1% of new Vercel signups in October 2024 to 4.8% in March 2025 to 10% in April 2025, a roughly 10x increase in six months"
  timeframe="October 2024 to April 2025"
  date="2025"
  source="https://x.com/rauchg/status/1910093634445422639"
/>

Search behavior shifted fast, and by 2026 it has not slowed down. Here is what the data shows:
...
<InAction
  concept="Build multi-channel authority beyond your own domain"
  companyName="Reddit"
  where="Aggregate citation-tracking studies across ChatGPT, Perplexity, Google AI Overviews, and Gemini"
  why="AI answer engines were trained on and continue to crawl community discussion, not just brand-owned websites, so a domain doesn't need its own page to become the cited source"
  what="Reddit built no dedicated AEO content strategy; its citation dominance comes entirely from the volume and specificity of unstructured community threads that answer engines already trust"
  benefit="Reddit became the single most-cited domain across major AI answer engines, accounting for roughly 21% of Google AI Overview citations and 46.5% of Perplexity citations at its 2025 peak"
  timeframe="August 2024 to early 2026"
  date="2026"
  source="https://ziptie.dev/blog/why-reddit-dominates-chatgpt-perplexity-and-google-ai-overviews/"
/>

A citation you do not own is still a citation. If your brand is not being discussed on the channels answer engines already trust, no amount of on-page structure closes that gap alone.
