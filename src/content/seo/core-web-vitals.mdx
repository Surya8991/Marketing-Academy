...
Vodafone Italy improved their Largest Contentful Paint score by 31%. The business result: 8% more sales.

This was not a small experimental test - it was a company-wide performance push across their commercial pages. The lesson: a faster-loading product page converts at a higher rate, even when the product, price, and copy stay exactly the same.

### Redbus - 80-100% mobile conversion increase

Redbus, the Indian online bus ticketing platform, fixed their CLS and reduced their Total Blocking Time (the amount of time JavaScript blocks the browser from responding). Their mobile conversion rate doubled.

They also saw a 192% improvement in domain ranking in Colombia. One technical change, two business outcomes.
