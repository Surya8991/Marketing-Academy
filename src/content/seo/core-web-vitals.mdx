...
<InAction
  ...
  companyName="Telegraph Media Group"
  where="a UK news publisher whose article pages were shifting more than desired as embedded tweets, videos, and widgets loaded in"
  why="layout shifts from embedded content and ads were degrading the reading experience and dragging down real-user CLS scores"
  what="using CrUX dashboards to measure real-user CLS, the team identified and fixed layout shifts caused by embedded code and custom widgets across article pages"
  benefit="75th-percentile CLS improved from 0.25 to 0.1, and the share of pages passing the 'Good' CLS threshold grew from 57% to 72%"
  timeframe="within a couple of months"
  date="2021"
  source="https://web.dev/case-studies/telegraph"
/>
...
<InAction
  concept="Why This Matters for Marketers"
  companyName="Vodafone"
  where="a global telecom running paid landing-page traffic across display, search, and social"
  why="the marketing team wanted to know whether Web Vitals optimization actually moved business metrics, not just lab scores"
  what="Vodafone A/B tested a landing page optimized for Web Vitals (31% better LCP) against an unoptimized version, both receiving roughly 100K clicks and 34K visits a day"
  benefit="the Web-Vitals-optimized version drove 8% more sales, a 15% lift in lead-to-visit rate, and an 11% improvement in cart-to-visit rate"
  timeframe="over the course of the A/B test"
  date="Mar 2021"
