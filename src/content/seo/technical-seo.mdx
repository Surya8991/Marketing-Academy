...
<InAction
  ...
  where="the official destination marketing organization for Seattle, recovering from a Google core-update traffic drop"
  why="a site health audit found 58,785 technical errors, including thousands of orphaned and broken-linked pages, choking off crawl access to important content"
  what="the team pruned 70% of low-value pages, fixed broken internal links and redirect chains, and properly linked previously orphaned content"
  benefit="technical errors fell from 58,785 to 13,609, a 76.9% reduction, and the site's health score rose from 8 to 76"
  timeframe="over an 8-week project"
  date="Sept-Nov 2024"
...
<InAction
  concept="Schema Markup"
  companyName="ZipRecruiter"
  where="a job-search marketplace adding structured data ahead of Google's new 'Google for Jobs' search experience"
  why="job listings had no way to appear in Google's enhanced job-search results without machine-readable markup"
  what="ZipRecruiter implemented JobPosting structured data across its job listing pages"
  benefit="a 4.5x higher Google organic conversion rate, a 35% increase in monthly organic non-branded traffic, and a 10% reduction in bounce rate from Google visitors"
  timeframe="in the months following the Google for Jobs launch"
  date="2018"
  source="https://developers.google.com/search/case-studies/ziprecruiter-case-study"
/>
