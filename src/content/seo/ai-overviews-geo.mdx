...
- AI Overviews now appear on a large share of Google searches, especially for how-to and informational questions - and 58% of searches result in zero clicks because the answer is right there on the page.
...
- AI-referred traffic has grown 600% since January 2025 - brands that get cited in AI answers are seeing massive new traffic sources.

## What Changed in Search

<Callout type="info">
**The zero-click shift is real.** As of 2025, 58% of all Google searches end without a single click - the user got their answer directly from the AI Overview. For informational queries (how-to, what-is, why-does), that number is even higher. This does not mean SEO is dead - it means the game changed. Getting cited inside the AI answer is now the new "ranking number one."
</Callout>
...
- **AI-referred traffic grew 600%** between January 2025 and mid-2025 (HubSpot, 2025). Brands getting cited in AI answers are gaining a powerful new traffic channel.
- **ChatGPT has 800 million weekly active users** as of October 2025, doubled from 400 million in February 2025. These are not bots - these are your potential customers asking questions.
- **Perplexity processes 780 million queries per month**, up from 230 million in August 2024. AI-native search is exploding.
...
- **Reddit saw a 450% increase in AI citations** from March to June 2025, now accounting for 21% of Google AI Overview citations - proving that community-format content gets cited heavily.
- **Brand mentions now outperform backlinks 3:1** for AI Overview presence, according to Ahrefs research (2025). The metric that matters most has shifted.
