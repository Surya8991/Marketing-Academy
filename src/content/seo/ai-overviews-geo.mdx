...
<InAction
  concept="Brand mentions over backlinks"
  companyName="HubSpot"
  where="Localized Reddit community campaigns in the French and German markets"
  why="HubSpot's AEO team found off-site brand mentions correlate with AI citation far more than backlinks, so it recruited community advocates to discuss the product naturally on Reddit instead of building more links."
  what="Launched market-specific Reddit engagement in France and Germany, tracking HubSpot's mention rate inside relevant threads."
  benefit="French Reddit mentions of HubSpot went from 0% to 33.5% of relevant threads within one month; German mentions went from 0% to 17.1%. Platform-wide, Reddit citations of HubSpot grew from 178 to 146,000 between May and December 2025."
...
<InAction
  ...
  companyName="HubSpot"
  where="A dedicated FAQ glossary answering awareness-stage definitional queries like 'what is marketing automation?'"
  why="Long, narrative glossary pages buried the actual definition; AI retrieval systems need the answer in the first sentence to extract and cite it."
  what="Rebuilt glossary entries as direct-answer blocks, each opening with a one-sentence definition before any elaboration."
  benefit="Citation share for the glossary content rose 60%, and brand visibility for awareness-stage AI prompts increased by 35 percentage points."
  timeframe="2025-2026"
  date="2026"
  source="https://blog.hubspot.com/marketing/hubspot-aeo-case-study"
/>
