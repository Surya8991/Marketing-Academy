...
<InAction
  ...
  companyName="CNET"
  where="across its news and reviews archive"
  why="thousands of old, thin, and low-value articles were dragging on how Google judged the site's overall quality"
  what="pruned thousands of underperforming articles instead of leaving them indexed indefinitely"
  benefit="organic traffic rose 29%, from about 19 million to about 24.5 million estimated monthly visits"
  timeframe="within about two months"
  date="Jun-Aug 2023"
  source="https://seo.ai/blog/content-pruning-case-study-cnet"
/>
...
<InAction
  concept="Why This Is an Ongoing Job in 2026"
  companyName="HouseFresh"
  where="on its independent product review site"
  why="95% of its search traffic vanished overnight when Google's Helpful Content system flagged its thin, unoriginal review pages in the September 2023 update"
  what="removed hundreds of thin review pages, added first-hand product testing with original photos and videos, and built out author expertise pages"
  benefit="search traffic fully recovered to pre-update levels"
  timeframe="2 years and 1 month after the drop"
  date="Oct 2025"
  source="https://ppc.land/housefresh-achieves-notable-traffic-recovery-after-google-algorithm-impacts-2/"
/>
