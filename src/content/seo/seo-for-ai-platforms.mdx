export const lessonMeta = {
  ...
  category: "seo",
  slug: "seo-for-ai-platforms",
  relatedConcepts: ["llmo", "eeat", "ai-search-visibility-metrics"],
};
...
<InAction
  ...
  companyName="HubSpot"
  where="A batch of existing product pages across HubSpot's site"
  why="Product pages ranked fine on Google but read like marketing copy, not like something an AI engine could extract a clean answer from."
  what="Added FAQ sections answering real buyer questions, rewrote headlines into question form, improved table and list formatting, and added structured data."
  benefit="Citations on those pages rose 56%, and average AI-answer position improved from 1.5 to 1"
...
<InAction
  concept="Add an FAQ section to every major article"
  companyName="HubSpot"
  where="A new set of software comparison articles for target industries, e.g. 'best CRMs for construction businesses'"
  why="Buyers researching category comparisons ask AI engines direct comparative questions, and generic listicle formatting wasn't answering them cleanly."
  what="Published comparison articles built specifically around real buyer questions, with breadcrumb and FAQ schema layered on top of properly structured Q&A prose."
  benefit="Citations on this content type rose 642%, with a 58% increase in overall brand mentions"
  timeframe="June-December 2025"
  date="2026-04-14"
  source="https://blog.hubspot.com/marketing/hubspot-aeo-case-study"
/>
...
<ResourceList resources={[
  ...
  { title: "Perplexity and AI SEO: How to Rank in Perplexity Answers", url: "https://www.seo.com/ai/perplexity/", type: "article", free: true },
  { title: "How HubSpot Became the #1 CRM in AI Search - HubSpot AEO Case Study (2026)", url: "https://blog.hubspot.com/marketing/hubspot-aeo-case-study", type: "article", free: true, note: "The tactics behind a 433% AI-citation increase, broken down by content type and market" },
  { title: "Study Says Adding Schema Did Not Improve AI Citations - Search Engine Roundtable", url: "https://www.seroundtable.com/study-schema-citations-study-41311.html", type: "article", free: true, note: "Covers the 2026 Ahrefs finding that FAQ schema markup alone does not move AI citations" },
