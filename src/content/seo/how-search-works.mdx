...
<InAction
  concept="Crawl Budget"
  companyName="Recurrent Ventures"
  where="a 15+ brand digital media company (Popular Science, Field & Stream, The Drive) auditing crawl efficiency across all its sites"
  why="Googlebot was spending crawl budget on 404s, redirect chains, and low-value pages instead of new articles"
  what="the SEO team used crawl-log and Search Console data to find and eliminate 404 errors, 3xx errors, and redirect chains draining crawl budget across 15+ sites"
  benefit="a 102% decrease in click depth, a 91% reduction in 404 errors, and a 20% increase in search goal attainment across 4 brands"
  timeframe="within a few months of the audit"
  date="Oct 2023"
  source="https://www.botify.com/customers/recurrent-ventures-success-story"
/>
...
<InAction
  concept="AI Overviews Reducing Click-Through"
  companyName="Chegg"
  where="an online homework-help and textbook subscription company reporting Q4 2024 earnings"
  why="Google's AI Overviews began answering the same study questions that used to send searchers to Chegg's own pages"
  what="Chegg publicly attributed a sharp traffic decline to AI Overviews absorbing homework-help searches directly on the results page, and later filed a formal complaint against Google over the impact"
  benefit="non-subscriber traffic fell 49% year-over-year and total revenue dropped 24% in Q4 2024"
  timeframe="in the quarter following AI Overviews' mid-2024 rollout"
  date="Feb 2025"
  source="https://investor.chegg.com/Press-Releases/press-release-details/2025/Chegg-Reports-2024-Fourth-Quarter-and-Full-Year-Financial-Results/default.aspx"
/>
