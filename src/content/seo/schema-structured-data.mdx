...
<InAction
  ...
  companyName="Jobrapido"
  where="on its job-listing pages ahead of Google's dedicated jobs search experience"
  why="wanted its listings to actually appear in Google's new job-search results instead of standard blue links"
  what="implemented JobPosting structured data (title, location, salary, date posted) across its job listing pages"
  benefit="organic traffic rose 182% and new user registrations from organic search rose 395%, with a 35% lower bounce rate on those pages"
  timeframe="in the months following launch"
  date="2018"
  source="https://developers.google.com/search/case-studies/jobrapido-case-study"
/>
...
<InAction
  concept="Why Structured Data Feeds AI Systems"
  companyName="Schema App"
  where="on its own entity-SEO resource pages"
  why="wanted its content to be surfaced and cited more often inside Google's AI Overviews for entity-SEO search terms"
  what="implemented Entity Linking through its Entity Hub product across priority entity pages like 'Entity Linking' and 'Entity SEO'"
  benefit="AI Overview visibility for entity-related keywords rose 19.72%"
  timeframe="over about two months"
  date="Oct-Dec 2025"
  source="https://www.schemaapp.com/schema-markup/case-study-entity-linking-increases-aio-visibility/"
/>
