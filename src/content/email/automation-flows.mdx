...
<InAction
  concept="Post-Purchase Educational Onboarding"
  companyName="Freshly Cosmetics"
  where="Freshly Cosmetics' direct-to-consumer email automation stack across European markets"
  why="Generic post-purchase order confirmations missed the window to educate first-time buyers on routines, leading to lower repeat purchase rates"
  what="Built segmented post-purchase flows in Klaviyo separating first-time from repeat buyers, delivering customized application tips before introducing cross-sell recommendations"
  benefit="Increased post-purchase flow revenue by 136% and won Best Post-Purchase Flow at Klaviyo's Klicks Awards"
  timeframe="Annual deployment"
  date="2024"
  source="https://www.klaviyo.com/blog/best-email-automations-klicks-awards"
/>
...
<InAction
  concept="Upper-Funnel Browse Abandonment Flows"
  companyName="Tecovas"
  where="Tecovas' direct-to-consumer Western goods ecommerce store"
  why="High product-page traffic was bouncing without adding boots or apparel to cart, leaving high-intent interest uncaptured"
  what="Deployed behavior-triggered browse abandonment email flows with dynamic product viewing blocks and exit conditions excluding cart abandoners"
  benefit="Achieved 2.43x the median revenue per recipient on browse abandonment flows and grew flow-attributed revenue by 138.8% year-over-year"
  timeframe="BFCM cycle"
  date="2023"
  source="https://www.klaviyo.com/customers/case-studies/tecovas"
/>
