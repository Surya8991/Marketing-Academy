...
<Quiz
  questions={[
    {
      q: "What is the primary difference between merge-tag personalization and AI-driven 1:1 email?",
      options: [
    ...
    {
      q: "Which data signal is described as most powerful for forward-looking personalization?",
      options: [
        "Purchase history",
        "Survey responses",
    ...
    {
      q: "What is the recommended first tier in the AI email personalization implementation roadmap?",
      options: [
