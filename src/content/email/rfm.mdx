...
<InAction
  concept="Segment-Specific Campaign Targeting"
  companyName="New West KnifeWorks"
  where="New West KnifeWorks' Klaviyo-managed customer database, segmented into 6 RFM groups including a dedicated 'Inactive' segment of customers who had not purchased in a long time, some for 3+ years"
  why="The team wanted to know whether infrequent, long-lapsed customers were worth continuing to email, or whether that send volume was better spent elsewhere"
  what="On a National Knife Day sale campaign, the team sent to all 6 RFM segments including the Inactive group instead of excluding it, then tracked revenue by segment"
  benefit="The Inactive segment generated 15% of total campaign revenue on that sale, and the approach contributed to 31% year-over-year growth in converted customers and 21% year-over-year growth in Klaviyo-attributed revenue over the following 6 months"
  timeframe="6-month period following the National Knife Day campaign"
  date="2024"
  source="https://www.klaviyo.com/customers/case-studies/new-west-knifeworks"
/>
...
<InAction
  concept="Automated RFM-Triggered Retention Flows"
  companyName="Ruffwear"
  where="Ruffwear's Klaviyo account, where customers entering the 'Needs attention' and 'At risk' RFM segments automatically triggered a dedicated retention flow personalized with purchase-history product recommendations"
  why="Ruffwear was applying the same blanket discount to re-engage every lapsed customer, which protected no margin and did not account for what each customer had already bought"
  what="The team built automated flows keyed to RFM segment entry, matching offer depth and messaging to each segment instead of sending the same coupon to everyone, per digital marketing manager Ernie Kucera"
  benefit="Campaign click rate rose 49% within 90 days, RFM-triggered retention flows generated $6.5K in incremental revenue in their first month, and the team cut its year-over-year discount rate by 10% while revenue grew 9% over the same 6 months"
  timeframe="First 90 days after launch, with the discount-rate figure measured over the following 6 months"
  date="2024"
  source="https://www.klaviyo.com/uk/customers/case-studies/ruffwear-cdp"
/>
