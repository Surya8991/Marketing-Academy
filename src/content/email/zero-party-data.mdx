...
<InAction
  ...
  where="On its email signup and preference center forms, across 12 customer segments"
  why="The existing single opt-out link gave subscribers no way to adjust frequency or topics, so people who wanted less mail simply unsubscribed entirely"
  what="Redesigned the preference center into two connected forms, removed default-selected checkboxes that were skewing data, personalized the call-to-action wording, and added industry-specific customization options"
  benefit="120% year-over-year increase in form submissions and a 117% increase in preference center site visits"
  timeframe="Year-over-year"
  date="2019"
  source="https://marketingsherpa.com/article/case-study/wholesale-distributor-increases-form-submissions-120-percent"
/>
...
<InAction
  ...
  companyName="Curlsmith"
  where="A 'Curl ID Quiz' embedded on the product pages, identifying hair type and recommending a personalized curl-care routine"
  why="Needed to capture zero-party hair-type and routine data to power segmentation and personalized product recommendations at scale"
  what="Built a quiz collecting structured preference data on every completion, synced to Klaviyo to trigger personalized flows and segments"
  benefit="100,000+ new email subscribers, 5.5 million zero-party data points collected, and a 10% increase in email revenue"
  timeframe="7 months after launch"
  date="2024"
  source="https://www.octaneai.com/case-studies/curlsmith"
/>
