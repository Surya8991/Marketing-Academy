...
<InAction
  concept="How CAN-SPAM Works"
  companyName="Verkada"
  where="Marketing emails sent to prospective customers with no working unsubscribe mechanism and no physical postal address"
  why="The FTC and DOJ alleged Verkada failed to include a valid opt-out method and did not honor opt-out requests within 10 business days, on top of separate data security failures"
  what="Verkada agreed to a stipulated order requiring CAN-SPAM compliance going forward, including honoring opt-out requests"
  benefit="$2.95 million civil penalty, the largest CAN-SPAM penalty on record at the time"
  timeframe="Settlement announced"
  date="2024-08"
  source="https://www.ftc.gov/news-events/news/press-releases/2024/08/ftc-takes-action-against-security-camera-firm-verkada-over-charges-it-failed-secure-videos-other"
/>
...
<InAction
  concept="How GDPR Works"
  companyName="LinkedIn"
  where="Behavioral analysis and targeted advertising using both first-party and third-party member data"
  why="Ireland's Data Protection Commission found LinkedIn's consent for sending user data to third parties for targeted advertising was not freely given, sufficiently informed, specific, or unambiguous, and that it unlawfully relied on legitimate interests and contractual necessity for first-party data processing"
  what="The DPC issued a reprimand and ordered LinkedIn to bring its data processing into compliance with GDPR's legal-basis requirements"
  benefit="310 million euro fine, following a six-year inquiry opened from an August 2018 complaint"
  timeframe="Decision issued"
  date="2024-10-24"
