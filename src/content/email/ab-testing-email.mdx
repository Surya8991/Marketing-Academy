...
<ResourceList resources={[
  { title: "A/B Testing Emails - Mailchimp Official Guide", url: "https://mailchimp.com/resources/ab-testing-emails/", type: "docs", free: true, note: "Step-by-step platform guide to setting up split tests in Mailchimp with screenshots" },
