...
<InAction
  concept="Engagement-based segmentation"
  companyName="Huda Beauty"
  where="Huda Beauty's Klaviyo-powered email program"
  why="Sending the same frequency to every subscriber regardless of engagement was dragging down deliverability and wasting sends on people who never opened anything"
  what="Restructured the entire program around recency-of-engagement segments (recently active subscribers got more frequent emails, less active ones got fewer) and added category-specific post-purchase automations for lips, skin, and eyes"
  benefit="Doubled year-over-year Klaviyo-attributed email revenue, plus a 50% bump in placed order rate"
  timeframe="2024"
  date="2024"
  source="https://www.klaviyo.com/customers/case-studies/huda-beauty"
/>
...
<InAction
  concept="Behavioral list segmentation"
  companyName="Jenni Kayne"
  where="Jenni Kayne's Klaviyo email program"
  why="Sending three broadcast emails a day to the entire list did not feel like the luxury brand experience the company wanted, and the retention team suspected volume alone was not driving revenue"
  what="Cut total email volume by 43.8% year-over-year and replaced daily blasts with segments built on purchase and browsing history, splitting apparel shoppers from home-goods shoppers, plus location-based in-store discount codes for online shoppers near physical stores"
  benefit="Grew total email revenue 14.5% year-over-year while sending 43.8% fewer emails"
  timeframe="Q1 2023"
  date="2023"
  source="https://www.klaviyo.com/customers/case-studies/jenni-kayne-email-efficiency"
/>
