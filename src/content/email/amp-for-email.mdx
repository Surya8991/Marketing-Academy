...
<ResourceList resources={[
  ...
  { title: "AMP for Email Overview", url: "https://amp.dev/about/email/", type: "tool", free: true, note: "Official overview of AMP for Email with supported clients and dev tools" },
