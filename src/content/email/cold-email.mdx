...
<InAction
  concept="Outbound Pipeline Acceleration"
  companyName="ElevenLabs"
  where="ElevenLabs' enterprise B2B sales development motion targeting mid-market and enterprise accounts"
  why="The team was 95% reliant on inbound signups and needed a scalable, predictable outbound engine to move upmarket without burning sender reputation"
  what="Deployed hyper-personalized multichannel cold email sequences with customized voice notes and tight ICP segmentation"
  benefit="Grew outbound share of sales pipeline from 5% to 30% while maintaining interaction rates up to 71% and reply rates of 25%"
  timeframe="Quarterly rollout"
  date="2024"
  source="https://www.lemlist.com/blog/elevenlabs-case-study"
/>
...
<InAction
  concept="Deliverability and Domain Warmup Architecture"
  companyName="Mindee"
  where="Mindee's document parsing API sales development outreach"
  why="Deliverability issues and generic email sequences across their legacy sales stack had depressed reply rates and inflated SDR tooling costs"
  what="Rebuilt outbound infrastructure with automated mailbox warmup, domain rotation, and AI-assisted custom opening lines"
  benefit="Doubled cold email open rates and reply rates while slashing sales stack software expenses by 70%"
  timeframe="Production migration"
  date="2024"
  source="https://www.lemlist.com/customers/mindee"
/>
