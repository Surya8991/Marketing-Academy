...
| `/projects` | Practice projects hub: search, tier/archetype/mode/category filters (196 projects across the library: Phase 1 pilot + the Technical SEO Mastery, AI Search Optimization, On-Page SEO Mastery, AI-First Marketer, Off-Page SEO Mastery, B2B Marketing, and Paid Ads Mastery tracks). "View details" opens the project's own dedicated page in a new tab (Session 78, replaces the old slide-over drawer) |
