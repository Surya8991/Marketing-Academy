...
| `/projects` | Practice projects hub: search, tier/archetype/mode/category filters (258 projects across the library: Phase 1 pilot + the Technical SEO Mastery, AI Search Optimization, On-Page SEO Mastery, AI-First Marketer, Off-Page SEO Mastery, B2B Marketing, Paid Ads Mastery, Data-Driven Marketer, CRO & Conversion Mastery, and Analytics & Measurement Mastery tracks). "View details" opens the project's own dedicated page in a new tab (Session 78, replaces the old slide-over drawer) |
