...
**Discovery**
- **Command Palette**, Cmd/Ctrl+K fuzzy search across all 642 lessons, 24 learning tracks, 158 glossary terms, 146 tools, and nav pages
...
- **Tools directory**, 146 marketing tools across 11 categories with search, category, and pricing filters at `/tools`
...
| `src/lib/tools-directory.ts` | 146 marketing tools with category/pricing data |
...
| `/tools` | 146 marketing tools with search + category + pricing filters |
...
| `/projects` | Practice projects hub: search, tier/archetype/mode/category filters (529 projects across the library — Stage 8.3a is fully complete, all 24 tracks, plus 8/28 `events-experiential` lessons and the full `paid-ads` category, 33/33 lessons, from Stage 9.3's non-track backlog). "View details" opens the project's own dedicated page in a new tab (Session 78, replaces the old slide-over drawer) |
