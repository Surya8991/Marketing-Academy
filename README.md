...
| `/projects` | Practice projects hub: search, tier/archetype/mode/category filters (433 projects across the library: Phase 1 pilot + the Technical SEO Mastery, AI Search Optimization, On-Page SEO Mastery, AI-First Marketer, Off-Page SEO Mastery, B2B Marketing, Paid Ads Mastery, Data-Driven Marketer, CRO & Conversion Mastery, Analytics & Measurement Mastery, Email & Lifecycle Mastery, Solo Founder, Freelancer & Agency, Content Creator, Marketing Mental Models, Copywriting Mastery, Content Strategy Mastery, Growth Marketing Mastery, E-commerce Growth, Social Media Manager, Product Marketing Mastery, and Brand Strategy Mastery tracks). "View details" opens the project's own dedicated page in a new tab (Session 78, replaces the old slide-over drawer) |
